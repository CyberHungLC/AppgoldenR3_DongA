...
#End Region
    ...
    Private Sub V_LoadRo(ByVal _Load As String, ByVal _Load1 As String)
        ...
        Dim DsTmpRO As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_RoXuatPick1", _Load + "#" + _Load1 + "#" + M_Ma_Dvcs.Trim + "#" + M_User_Name)
    ...
    Private Sub V_Loaddatatabse(ByVal _Status As String, ByVal _So_Ro As String)
        ...
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_RoXuatPick", _Status + "#" + _So_Ro + "#" + _Ma_VT + "#" + _Pick + "#" + M_Ma_Dvcs.Trim + "#" + M_User_Name)
    ...
    Private Sub DetailGRV_PopupMenuShowing(ByVal sender As System.Object, ByVal e As DevExpress.XtraGrid.Views.Grid.PopupMenuShowingEventArgs)
        ...
        PopupMenuChoGRV.ItemLinks.Add(New CyberMenuPopup(sender, rowHandle, "Gỡ xuất pick (Một vật tư)", AddressOf V_Go_Pick_One, Nothing, Nothing, True, True)).BeginGroup = False
        PopupMenuChoGRV.ItemLinks.Add(New CyberMenuPopup(sender, 0, "Gỡ xuất pick (Tất cả vật tư)", AddressOf V_Go_Pick_All, Nothing, Nothing, True, True)).BeginGroup = False
...
#Region "Tạo phiếu xuất"
    ...
    Private Function Tao_Px(ByVal _Loai As String, ByVal iRow As Integer) As String
        ...
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GoXuatPick", _Loai + "#" + _StrSave & "#" & TxtOng_ba.Text & "#" & "" & "#" & TxtDien_giai.Text & "#" & M_Ma_Dvcs & "#" & M_User_Name)
        Dim _Stt_Rec As String = ""
...
#End Region
#Region "Gỡ xuất pick"
    Private Sub V_Go_Pick_One(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Dim iRow As Integer = DetailGRV.FocusedRowHandle
        If iRow < 0 Then Exit Sub
        Dim _Stt_Rec As String = Tao_Px("2", iRow)
        If _Stt_Rec.Trim = "" Then Exit Sub
    ...
    End Sub
    Private Sub V_Go_Pick_All(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Dim _Stt_Rec As String = Tao_Px("2", -1)
        If _Stt_Rec.Trim = "" Then Exit Sub
        V_ReFresh(New System.Object, New System.EventArgs)
        V_Print_pick(_Stt_Rec)
