...
#Region "Columns Edit"
    ...
    Dim EditMa_kx, EditTen_kx, EditMa_mau, EditTen_mau, EditSo_khung, EditSo_may, EditMa_Vitri, EditMa_Kho_I, EditMa_Vv_I, EditMa_phi_i, EditMa_HD_I, EditMa_Sp_I, EditMa_ku_I, EditMa_TTLN_i, EditMa_TTCP_i, EditMa_BP_I, EditMa_HS_I, EditMa_CD_I, EditMa_TD1_I, EditMa_TD2_I, EditMa_TD3_I, EditMa_TD4_I, EditMa_TD5_I As New Cyber.Fill.CyberColumnGridView 'Cyber.SmLists.EditLookUp
...
#Region "Valid --- Ma_TD2_H"
    ...
    Private Sub L_Ma_TD2_H(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        ...
        If Not DrReturn Is Nothing Then
            ...
            If TxtMa_Kh.Text = "" Then TxtMa_Kh.Text = DrReturn.Item("Ma_KH")
        Else
            txtMa_TD2_H.Text = ""
            txtTen_TD2_H.Text = ""
        End If
...
#Region "Vat tu kho/Vitri - "
    ...
    Private Sub V_Ma_mau(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        ...
        'MsgBox(_FilterClient)
        'If Not _Ma_Kx = "" Then _FilterClient = _Ma_Kx

        'CyberSupport.V_Lookup("Ma_mau", "DmmauKx", "1=1", "1=1", M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
        CyberSupport.V_Lookup("Ma_mau", "DmmauKx", _FilterClient, _FilterClient, M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    ...
    Private Sub V_SetPriceXePurChase(ByVal iRow As Integer)
        ...
        Dim _ngay_Ct As Date = TxtNgay_Ct.Value
        Dim DsgetPrice As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetPriceXePurchasePDX", _ma_kx.Trim + "#" + _Ma_Mau.Trim + "#" + _Ma_Kh + "#" +
        _ngay_Ct.ToString("yyyyMMdd") + "#" + _So_Luong.ToString.Trim.Replace(",", ".") + "#" + _Gia_NT.ToString.Trim.Replace(",", ".") + "#" + _Tien_Nt.ToString.Trim.Replace(",", ".") + "#" +
         M_Mode.Trim + "#" + M_Stt_Rec + "#" + M_Ma_CT.Trim + "#" + TxtMa_Dvcs.Text.Trim + "#" + M_User_Name.Trim + "#" + IIf(ChkSua_Gia.CheckState = CheckState.Checked, "1", "0"))
...
#Region "Mainform"
    Private Sub V_MainSystem()
        ...
        Dim mnItemsF6 As New MenuItem("Tạo nhiều xe", AddressOf V_Tao_nhieu_Xe, Keys.F6)
        ...
        mnItemsMail.MenuItems.Add(mnItemsF6)
...
#Region "Tạo nhiều xe"
    Private Sub V_Tao_nhieu_Xe(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Dr.Item("Ma_KX").ToString.Trim = "" Then Exit Sub
...
#Region "Button"
    Private Sub V_Save(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        For iRow = 0 To Dt_DetailTmp.Rows.Count - 1
            ...
            Dt_DetailTmp.Rows(iRow).Item("So_PoHang") = TxtMa_TD2_H.Text
        Next
        Dt_DetailTmp.AcceptChanges()
        ...
        For iRow = 0 To Dt_DetailTmp.Rows.Count - 1
            ...
            Dt_DetailTmp.Rows(iRow).Item("Ma_Lo") = drMaster.Item("So_Ct") + "." + Dt_DetailTmp.Rows(iRow).Item("Stt_Rec0")
    ...
    Private Function Add2Database() As Boolean
        ...
        For iRow = 0 To Dt_DetailTmp.Rows.Count - 1
            Dt_DetailTmp.Rows(iRow).Item("Ma_Lo") = TxtLenh_PO.Text + "." + Dt_DetailTmp.Rows(iRow).Item("Stt_Rec0")
            Dt_DetailTmp.Rows(iRow).Item("So_Hang") = Dt_DetailTmp.Rows(iRow).Item("Ma_Lo")
    ...
    Private Sub V_New()
        ...
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetDefaultPDX", M_Stt_Rec & "#" & M_Ma_CT & "#" & M_Mode & "#" & M_Ma_Dvcs & "#" & M_User_Name)
...
#End Region
    ...
    Private Sub V_Phan_Bo_Thue()
        If ChkSua_Thue.Checked Then
            CyberSupport.Phan_Bo(Dt_DetailTmp, "TIEN", "Thue", TxtT_Thue.Double, M_R_TIEN_NT)
    ...
    Private Sub TinhThue_VT(ByVal iRow As Integer)
        ...
        If Dv_DetailTmp.Item(iRow).Item("Sua_Thue").ToString.Trim <> "1" Then
            ...
            Dv_DetailTmp.Item(iRow).Item("Thue_NT") = CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("T_TT_NT") * Dv_DetailTmp.Item(iRow).Item("Thue_Suat") / 100, 0)

        Else
            If Dv_DetailTmp.Item(iRow).Item("Thue_NT") = 0 Then
                Dv_DetailTmp.Item(iRow).Item("Thue_NT") = CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("T_TT_NT") * Dv_DetailTmp.Item(iRow).Item("Thue_Suat") / 100, 0)

            End If

            Dv_DetailTmp.Item(iRow).Item("Thue_NT") = Dv_DetailTmp.Item(iRow).Item("Thue_NT")
