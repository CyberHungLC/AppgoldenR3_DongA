Public Class FAKKCTTS
    Dim CyberMe As New Cyber.ReportsCustom.Sys
    Dim DrReturn As DataRow
    Dim DsLookup As DataSet   
    Private Sub FAKKCTTS_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load       
        V_AddMenuShorcut()
        V_Load()
        V_Addhander()
    End Sub
...
#Region "Button"
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        M_strParameterStore = M_strParameterStore & "#" & IIf(ChkTon.Checked, "1", "0")
