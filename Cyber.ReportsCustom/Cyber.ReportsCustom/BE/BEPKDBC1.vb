Public Class BEPKDBC1
    Dim DtLoai, DtThang1, DtThang2, DtNam As DataTable
    Dim CyberMe As New Cyber.ReportsCustom.Sys
    Dim DrReturn As DataRow
    Dim DsLookup As DataSet
    Private Sub BEPKDBC1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_AddMenuShorcut()
        V_Load()
        V_Addhander()
    End Sub
#Region "Load"
    Private Sub V_Load()
        ...
        '----Set
        DtLoai = CreateTableLoai()
        DtThang1 = CreateTableMonth()
        DtThang2 = DtThang1.Copy
        DtNam = CreateTableYear()
        CyberFill.V_FillComBoxDefaul(CbbM_Loai, DtLoai, "Ma", "Ten", "Default")
    ...
    Private Function CreateTableLoai() As DataTable
        ...
        _Return.Rows.Add("HS", "Báo cáo tháng theo dõi số lượng ký theo TVBH", "1")
        _Return.Rows.Add("KX", "Báo cáo tháng theo dõi số lượng ký theo dòng xe", "0")
...
#Region "Button"
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim M_strParameterStore As String = CbbM_Loai.SelectedValue.ToString.Trim
        M_strParameterStore = M_strParameterStore & "#" & CbbM_Thang1.SelectedValue.ToString.Trim & "#" & CbbM_Nam.SelectedValue.ToString.Trim
