...
#End Region
    ...
    Private Sub BGX_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
        '------------------------------
        '------------------------------
        V_GetColumn()
...
#Region "Valid --- Ma_BH_H"
    ...
    Private Sub L_Ma_DVBH_H(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        ...
        If Not DrReturn Is Nothing Then
            TxtMa_TD3_H.Text = DrReturn.Item("Ma_KH")
            TxtTen_TD3_H.Text = DrReturn.Item("Ten_KH")
        Else
            TxtMa_TD3_H.Text = ""
            TxtTen_TD3_H.Text = ""
        End If
...
#Region "Valid --- Ma_Td3_H"
    ...
    Private Sub L_Ma_Td3_H(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        ...
        Else
            ...
            TxtMa_HD_H.Text = ""
        End If
        If Not TxtMa_HD_H.Text = "" Then L_BGXGetThongTinHDX()
    End Sub

    Private Sub L_BGXGetThongTinHDX()
        Dim _Ma_TD3 As String = txtMa_TD3_H.Text
        Dim Dstmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetDefaultBGX", _Ma_TD3 + "#" + M_Ma_CT + "#" + M_Mode + "#" + M_Ma_Dvcs + "#" + M_User_Name)
        ...
        If Dstmp.Tables(1).Columns.Contains("Ten_KhVAT") Then TxtTen_KhVat.Text = Dstmp.Tables(1).Rows(0).Item("Ten_KhVAT").ToString.Trim
        If Dstmp.Tables(1).Columns.Contains("Dia_ChiVAT") Then TxtDia_ChiVat.Text = Dstmp.Tables(1).Rows(0).Item("Dia_ChiVAT").ToString.Trim
        If Dstmp.Tables(1).Columns.Contains("Ong_Ba") Then TxtOng_Ba.Text = Dstmp.Tables(1).Rows(0).Item("Ong_Ba").ToString.Trim
    ...
    Private Function ChkVsave() As Boolean
        ...
        For iRow = 0 To Dt_DetailTmp.Rows.Count - 1
            ...
            If Dt_DetailTmp.Columns.Contains("MA_HD_I") Then
                If Not TxtMa_HD_H.Text.Trim = "" Then Dt_DetailTmp.Rows(iRow).Item("MA_HD_I") = TxtMa_HD_H.Text.Trim
            End If
