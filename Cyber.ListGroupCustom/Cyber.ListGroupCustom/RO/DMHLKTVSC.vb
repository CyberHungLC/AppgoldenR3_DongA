...
#Region "Load"
    Protected Overrides Sub V_Load()
        MyBase.V_Load()
        TxtTen_Hs.Text = CyberSmodb.SQLGetvalue(Appconn, "Ten_HS", "DmKTVSC", "(Ma_HS = N'" + TxtMa_HS.Text.Trim + "')", CyberSmlib)
        TxtTen_To.Text = CyberSmodb.SQLGetvalue(Appconn, "Ten_to", "DmTo", "(Ma_To = N'" + TxtMa_To.Text.Trim + "')", CyberSmlib)
