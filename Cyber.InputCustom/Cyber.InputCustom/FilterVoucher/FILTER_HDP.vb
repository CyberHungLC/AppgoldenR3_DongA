...
Public Class FILTER_HDP
    ...
    Private Sub V_So_CT1(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        txtSo_ct1.Text = CyberVoucher.V_FormatSo_Ro(AppConn, osysvar, Me.Ma_CT, _Ma_GD, "M", _Dt, txtSo_ct1.Text, M_Ma_TTCP, M_Ma_Dvcs, M_User_Name, CyberSmlib)
    ...
    Private Sub V_So_CT2(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        TxtSo_Ct2.Text = CyberVoucher.V_FormatSo_Ro(AppConn, osysvar, Me.Ma_CT, _Ma_GD, "M", _Dt, TxtSo_Ct2.Text, M_Ma_TTCP, M_Ma_Dvcs, M_User_Name, CyberSmlib)
    End Sub
