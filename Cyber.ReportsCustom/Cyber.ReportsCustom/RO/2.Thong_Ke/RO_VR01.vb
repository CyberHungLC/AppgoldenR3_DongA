...
#Region "Load"
    ...
    Private Sub V_Addhander()
        ...
        AddHandler Chklenh.Click, AddressOf V_Chk_Lenh
        AddHandler ChkXeRa.Click, AddressOf V_ChkXeRa
    End Sub
    Private Sub V_Chk_Lenh(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Chklenh.Checked Then
            ChkXeRa.Checked = False
        Else
            If ChkXeRa.Checked Then
                Chklenh.Checked = False
            End If
        End If
    End Sub
    Private Sub V_ChkXeRa(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If ChkXeRa.Checked Then
            Chklenh.Checked = False
        Else
            If Not ChkXeRa.Checked Then
                Chklenh.Checked = False
            End If
        End If
    End Sub
...
#Region "Button"
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        M_strParameterStore = M_strParameterStore & "#" & IIf(Chklenh.Checked, "1", "0")
        M_strParameterStore = M_strParameterStore & "#" & IIf(ChkXeRa.Checked, "1", "0")
