...
Public Class ROXPTView
    ...
    Private Sub MasterGRV_PopupMenuShowing(ByVal sender As System.Object, ByVal e As DevExpress.XtraGrid.Views.Grid.PopupMenuShowingEventArgs)
        ...
        PopupMenuMasterGrid.ItemLinks.Add(New CyberMenuPopup(sender, 0, "In phiếu xuất", AddressOf V_InPhieuXuat, Nothing, Nothing, True, True), True).BeginGroup = True
    ...
    Private Sub V_InPhieuXuat(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        iRow = MasterGRV.GetFocusedDataSourceRowIndex
        Dim _Stt_Rec As String = ""
        _Stt_Rec = M_Dv_Master.Item(iRow).Item("Stt_Rec").ToString.Trim.ToUpper
