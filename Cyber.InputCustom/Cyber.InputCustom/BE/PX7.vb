...
#Region "Columns Edit"
    ...
    Dim EditMa_Kx, EditMa_Vitri, EditMa_Kho_I, EditMa_Vv_I, EditMa_Phi_i, EditMa_HD_I, EditMa_SP_I, EditSo_Khung, EditMa_Ku_I, EditMa_TTLN_i, EditMa_TTCP_i, EditMa_BP_I, EditMa_Hs_I, EditMa_CD_I, EditMa_TD1_I, EditMa_TD2_I, EditMa_TD3_I, EditMa_TD4_I, EditMa_TD5_I As New Cyber.Fill.CyberColumnGridView
    ...
    Dim EditTen_Kx, EditMa_Mau, EditTen_Mau, EditSo_May, EditTen_Kho_i, EditTen_Tk_Vt, EditTen_Nx_I As New Cyber.Fill.CyberColumnGridView
#End Region
...
#Region "Vat tu kho/Vitri - "
    ...
    Private Sub V_GetTTXe(ByVal iRow As Integer, ByVal Loai As String)
        ...
        If _DsTTXe.Tables(0).Columns.Contains("Ma_Kho") Then Dv_DetailTmp.Item(iRow).Item("Ma_Kho_I") = _DsTTXe.Tables(0).Rows(0).Item("Ma_Kho")
