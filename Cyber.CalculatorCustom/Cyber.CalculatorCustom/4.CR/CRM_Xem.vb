...
#End Region
    Private Sub V_F3(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Not FrmF3_Calculator Is Nothing Then
            FrmF3_Calculator.Loai = Key_Sub3
            FrmF3_Calculator.Ma_Loai = Key_Sub4
    ...
    Private Sub MasterGRV_PopupMenuShowing(ByVal sender As System.Object, ByVal e As DevExpress.XtraGrid.Views.Grid.PopupMenuShowingEventArgs)
        ...
        End If
        PopupMenuMasterGrid.ItemLinks.Add(New Cyber.SmLib.CyberMenuPopup(sender, rowHandle, IIf(Lan = "V", "Lọc dữ liệu", "Filter Data"), AddressOf V_Filter, Shortcut.F6, , True, True)).BeginGroup = False

        PopupMenuMasterGrid.ItemLinks.Add(New Cyber.SmLib.CyberMenuPopup(sender, rowHandle, IIf(Lan = "V", "Đính kèm", "Attach File"), AddressOf V_Attach, Nothing, , True, False)).BeginGroup = True
        ...
        PopupMenuMasterGrid.ItemLinks.Add(New Cyber.SmLib.CyberMenuPopup(sender, 0, IIf(Lan = "V", "Xuất Excel", "Export to Excel"), AddressOf V_XuatExcelx, Shortcut.F11, , True, True), False).BeginGroup = True
