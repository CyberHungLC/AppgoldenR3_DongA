Public Class BEDmHD02
    Dim CyberMe As New Cyber.ReportsCustom.Sys
    Dim DrReturn As DataRow
    Dim DsLookup As DataSet

    Private Sub BEDmHDBk1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_AddMenuShorcut()
...
#Region "Button"
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim M_strParameterStore As String = Dt1.ToString("yyyyMMdd") & "#" & Dt2.ToString("yyyyMMdd").Trim & "#" & Dt3.ToString("yyyyMMdd").Trim
        ...
        M_strParameterStore = M_strParameterStore & "#" & IIf(ChkIs_HD_Ao.Checked, "1", "0")
