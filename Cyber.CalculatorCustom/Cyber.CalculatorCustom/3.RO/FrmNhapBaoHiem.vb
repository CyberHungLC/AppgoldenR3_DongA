...
#End Region
    ...
    Protected Overrides Sub V_GetValueParameter()
        ...
        AddHandler TxtMa_Xe.Leave, AddressOf AddAndFillTTXe
        '----------------------------
    End Sub
    Private Sub V_Load()
        AddAndFillBH()
    ...
    End Sub
    Private Sub AddAndFillTTXe()
        Dim dsBaohiem As DataSet

        dsBaohiem = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_ICGetNgayBH", "" + "#" + TxtMa_Xe.Text.Trim + "#" + "" + "#" + "".Trim + "#" + "".Trim + "#" + "".Trim + "#" + M_Ma_Dvcs + "#" + M_User_Name)
        ...
        TxtDia_Chi.Text = dsBaohiem.Tables(0).Rows(0).Item("Dia_Chi")
        TxtTen_kh.Text = dsBaohiem.Tables(0).Rows(0).Item("Ten_KH")
        TxtDien_Thoai.Text = dsBaohiem.Tables(0).Rows(0).Item("Ten_KH").ToString().Trim
        TxtDt_LX.Text = dsBaohiem.Tables(0).Rows(0).Item("DT_LX").ToString().Trim
        TxtNgay_DS.Value = dsBaohiem.Tables(0).Rows(0).Item("Ngay_DS")
        TxtNgay_VC.Value = dsBaohiem.Tables(0).Rows(0).Item("Ngay_VC")
        TxtNgay_NL.Value = dsBaohiem.Tables(0).Rows(0).Item("Ngay_NL")
    End Sub
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If TxtMa_Xe.Text = "" Then
            MsgBox("Bạn chưa nhập biển số", MsgBoxStyle.Information + MsgBoxStyle.OkOnly, Sysvar("M_CYBER_VER"))
            Return
        End If

        If (_Ma_BH_DS = "" And _Dt_BH_DS.ToString("yyyyMMdd") <> "19000101") Or (_Ma_BH_VC = "" And _Dt_BH_VC.ToString("yyyyMMdd") <> "19000101") Or (_Ma_BH_NL = "" And _Dt_BH_NL.ToString("yyyyMMdd") <> "19000101") Then
            MsgBox("Bạn chưa chọn đơn vị bảo hiểm", MsgBoxStyle.Information + MsgBoxStyle.OkOnly, Sysvar("M_CYBER_VER"))
            Return
        End If

        Dim Dstmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_ICGetNgayBHSaveNhapBH", TxtMa_Xe.Text + "#" + TxtTen_kh.Text + "#" + TxtDia_Chi.Text + "#" + TxtDien_Thoai.Text + "#" + TxtDt_LX.Text + "#" + TxtE_Mail.Text + "#" + _Dt_BH_DS.ToString("yyyyMMdd") + "#" + _Dt_BH_VC.ToString("yyyyMMdd") + "#" + _Dt_BH_NL.ToString("yyyyMMdd") + "#" + _Ma_BH_DS + "#" + _Ma_BH_VC + "#" + _Ma_BH_NL + "#" + M_Ma_Dvcs + "#" + M_User_Name)
