...
#Region "Columns Edit"
    ...
    Dim EditTien_NT, EditTien, EditGia_NT, EditGia, EditSo_luong, EditDien_Giaii, EditSo_So, EditSo_Po, EditSo_Ro, EditSo_VT As New Cyber.Fill.CyberColumnGridView 'DevExpress.XtraEdiors.Repository.RepositoryItemTextEdit
...
#Region "Valid - Detail - Core"
    ...
    Private Sub V_Tinh_Toan(ByVal iRow As Integer)
        ...
        If Dv_DetailTmp.Item(iRow).Item("Gia_NT") * Dv_DetailTmp.Item(iRow).Item("So_Luong") <> 0 Then
            If Dv_DetailTmp.Item(iRow).Item("TIEN_NT") = 0 Then Dv_DetailTmp.Item(iRow).Item("TIEN_NT") = CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("Gia_NT") * Dv_DetailTmp.Item(iRow).Item("So_Luong"), M_R_TIEN)
        End If
