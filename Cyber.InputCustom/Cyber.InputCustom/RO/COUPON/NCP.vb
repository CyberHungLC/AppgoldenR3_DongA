...
#Region "Columns Edit"
    ...
    Dim EditSo_Luong, EditGia_Nt, EditGia, EditTien_Nt, EditTien, EditDien_Giaii, EditSo_So, EditSo_Po, EditSo_VT, EditSo_Ro As New Cyber.Fill.CyberColumnGridView
#End Region
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Master()
        ...
        AddHandler CmdGetDetail.Click, AddressOf V_GetDetailNCP
    ...
    Private Sub VisibleColumnMa_NT()
        If TxtMa_NT.Text.Trim = "" Or TxtMa_NT.Text.Trim.ToUpper = osysvar("M_Ma_NT0").ToString.Trim.ToUpper Then
            ...
            'TxtT_Gia_Tri.Visible = False
        Else
            EditTien.Visible = True
            EditGia.Visible = True
            'TxtT_Gia_Tri.Visible = True
        End If
...
#Region "Valid --- Ma_CPont"
    ...
    Private Sub L_Ma_Coupon(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        ...
        V_GetSeriCoupon()
    End Sub
    Private Sub V_GetSeriCoupon()
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub

        Dim Dstmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_NCPGetSeriCoupon", M_Stt_Rec & "#" & TxtMa_Coupon.Text & "#" & TxtSo_Seri1.Double & "#" & TxtSo_Seri2.Double & "#" & TxtGia_Coupon.Double & "#" & TxtMa_Dvcs.Text & "#" & M_User_Name)
        ...
        If Dstmp.Tables(0).Rows.Count = 0 Then
            ...
            Return
        End If
        If TxtSo_Seri1.Text = "0" Then TxtSo_Seri1.Double = Dstmp.Tables(0).Rows(0).Item("So_Seri")
       
        Dstmp.Dispose()
    End Sub
 
#Region "GetDetail"
    Private Sub V_GetDetailNCP(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
 
        'Dim Dstmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_NCPGetSeriCoupon", TxtMa_Coupon.Text & "#" & TxtSo_Seri1.Text.Trim.Replace(" ", "") & "#" & TxtSo_Seri2.Text.Trim.Replace(" ", "") & "#" & TxtGia_Coupon.Text.Trim.Replace(" ", "") & "#" & TxtMa_Dvcs.Text & "#" & M_User_Name)

        Dim Dstmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetDetailNCP", M_Stt_Rec & "#" & TxtMa_Coupon.Text & "#" & TxtSo_Seri1.Double & "#" & TxtSo_Seri2.Double & "#" & TxtGia_Coupon.Double & "#" & TxtMa_Dvcs.Text & "#" & M_User_Name)
