...
#Region "Columns Edit"
    ...
    Dim Editma_Db_I, EditMa_Xe_I, EditMa_KX_I, EditMa_ChiTieu_I, EditMa_Tuyen_I, EditMa_Ts, EditMa_Cc As New Cyber.Fill.CyberColumnGridView 'Cyber.SmLists.EditLookUp
    ...
    Dim EditMa_Kx, EditTen_kx, EditTen_ChiTieu_I, EditMa_Mau, EditTen_Mau As New Cyber.Fill.CyberColumnGridView
#End Region
...
#End Region
    ...
    Private Sub KNS_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        CreateTableMonth()
        V_Load()
        V_GetColumn()
        V_AddHandler()
...
#Region "Load And Set And Default"
    ...
    Private Sub V_GetColumn()
        ...
        EditMa_ChiTieu_I.GetColumn(DetailGRV, "Ma_ChiTieu_I")
        EditTen_ChiTieu_I.GetColumn(DetailGRV, "Ten_ChiTieu_I")
    End Sub
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_System()
        ...
        AddHandler CmdLoc_PNL.Click, AddressOf V_Loc_PNL
    End Sub
    ...
    Private Sub V_AddHandler_Detail()
        ...
        EditMa_ChiTieu_I.V_ActiLookUpColumn(AddressOf V_Ma_ChiTieu_I, AddressOf L_Ma_ChiTieu_I)
    ...
    Private Sub V_Loc_PNL(ByVal sender As System.Object, ByVal e As System.EventArgs) 'abc
        ...
        Dim DsgetMIP_TT As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetDetaiKNS", _Ma_GD + "#" + TxtMa_Dvcs.Text.Trim + "#" + M_User_Name.Trim)
...
#Region "Valid - Detail - Add On"
    ...
    End Sub
    Private Sub V_Ma_ChiTieu_I(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        CyberSupport.V_Lookup("Ma_So", "GLPNL", "1=1", "1=1", M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_ChiTieu_I(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        ...
        If DrReturn Is Nothing Then
            Dv_DetailTmp.Item(iRow).BeginEdit()
            Dt_DetailTmp.Rows(iRow).Item("Ma_ChiTieu_I") = ""
            If Dt_DetailTmp.Columns.Contains("Ten_ChiTieu_I") Then Dv_DetailTmp.Item(iRow).Item("Ten_ChiTieu_I") = ""
            Dv_DetailTmp.Item(iRow).EndEdit()
            Exit Sub
        Else
            Dv_DetailTmp.Item(iRow).BeginEdit()
            Dv_DetailTmp.Item(iRow).Item("Ma_ChiTieu_I") = DrReturn("Ma_So").ToString.Trim
            If Dt_DetailTmp.Columns.Contains("Ten_ChiTieu_I") Then Dv_DetailTmp.Item(iRow).Item("Ten_ChiTieu_I") = DrReturn("Chi_Tieu").ToString.Trim
...
#Region "Button"
    ...
    Private Function ChkDa_KH(ByVal _Mode) As Boolean
        ...
        DsTmp = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_Chkkhns_KNS", _Ma_GD & "#" & _StrDetail & "#" & _Mode & "#" & _ThangKh & "#" & _NamKh & "#" & M_Stt_Rec & "#" & TxtMa_Dvcs.Text & "#" & M_User_Name)
    ...
    Private Function ChkVsave() As Boolean
        ...
        For iRow = nCount - 1 To 0 Step -1
            If _Fieldname <> "" And Dt_DetailTmp.Columns.Contains(_Fieldname) Then
                ...
                End If
            End If
            'If Dt_DetailTmp.Rows(iRow).Item("Ma_KX").ToString.Trim = "" And Dt_DetailTmp.Rows(iRow).Item("Ma_ChiTieu_I").ToString.Trim = "" And Dt_DetailTmp.Rows(iRow).Item("Ma_Mau").ToString.Trim = "" Then
            '    Dt_DetailTmp.Rows(iRow).Delete()
            '    Dt_DetailTmp.AcceptChanges()
            'End If
        Next
