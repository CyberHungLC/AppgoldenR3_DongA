...
#End Region
    ...
    Private Function V_GetValue(ByVal iRow As Integer) As String
        ...
        Dim _Ma_CD As String = ""
        Dim _Stt_Rec0_Ro As String = ""
        If Dt_Data.Columns.Contains("Tag") Then _Tag = Dv_Data.Item(iRow).Item("Tag").ToString.Trim
        ...
        _Return = "INSERT THUCHIEN SELECT  N'" + _Tag + "',N'" + _Ma_Get + "',N'" + _So_Ro + "',N'" + _Stt_Rec_Ro + "',N'" + _Stt_Rec + "',N'" + _Ma_KTV + "',N'" + _Ma_CV + "',N'" + _Ma_CD + "',N'" + _Stt_Rec0_Ro + "'"
