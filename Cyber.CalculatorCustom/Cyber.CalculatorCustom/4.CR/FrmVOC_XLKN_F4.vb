...
Public Class FrmVOC_XLKN_F4
    ...
    Private Sub FrmVOC_XLKN_F4_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Save_OK = False
        V_Load()
        V_Addhander()
    ...
    Private Sub V_Addhander()
        ...
        AddHandler TxtMa_Hs_TN.CyberValiting, AddressOf V_Ma_Hs_TN
        AddHandler TxtMa_Hs_TN.CyberLeave, AddressOf L_Ma_Hs_TN
    End Sub
#Region "Valid"
...
#End Region
#Region "Ma_Hs_TN"
    Private Sub V_Ma_Hs_TN(ByVal sender As System.Object, ByVal e As System.EventArgs)
        TxtMa_Hs_TN.V_LookUp(M_LAN, Me.Para, Me.Sysvar, AppConn, DsLookup, "Ma_Hs", "DmHs", "1=1", "1=1")
    End Sub
    Private Sub L_Ma_Hs_TN(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If TxtMa_Hs_TN.Text = "" Then
            TxtTen_Hs_TN.Text = ""
            Exit Sub
        End If
        DrReturn = TxtMa_Hs_TN.GetRowsSelectData(True)
        If Not DrReturn Is Nothing Then
            TxtMa_Hs_TN.Text = DrReturn.Item("Ma_Hs")
            TxtTen_Hs_TN.Text = DrReturn.Item("Ten_Hs")
        Else
            TxtMa_Hs_TN.Text = ""
            TxtTen_Hs_TN.Text = ""
        End If
