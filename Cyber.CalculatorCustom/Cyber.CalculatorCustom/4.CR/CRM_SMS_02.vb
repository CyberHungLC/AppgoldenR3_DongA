...
#Region "LoadData"
    Private Sub V_LoadData(ByVal Status As String)
        ...
        Dim _TTCS As String = V_GetValueCombox(CmbTT_CS)
        ...
        Dim _Ma_LanKTDK1 As String = TxtMa_LanKTDK1.Text.Trim
        Dim _Ma_LanKTDK2 As String = TxtMa_LanKTDK2.Text.Trim
        Dim _Ma_LanLH1 As String = TxtMa_LanLH1.Text.Trim
        Dim _Ma_LanLH2 As String = TxtMa_LanLH2.Text.Trim
        Dim _Ma_PhanLoai As String = V_GetValueCombox(CmbPhan_Loai)
        Dim _Ma_ChienDich As String = ""
        Dim _Ma_Sk As String = ""
        Dim _Ma_NN As String = ""
        Dim _Ma_GT As String = ""
...
#Region "Valid --- Ma_LoaiCS"
    Private Sub V_Ma_LoaiCS(ByVal sender As System.Object, ByVal e As System.EventArgs)
        TxtMa_LoaiCS.V_LookUp(M_LAN, Me.Para, Me.Sysvar, AppConn, DsLookup, "CrmMa_Loai", "CrmDmLoai", "1=1", "CrmLoai = 'CR'")
    End Sub
    Private Sub L_Ma_LoaiCS(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim _LoaiCs As String = TxtMa_LoaiCS.Text.Trim
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_CRMQLLLLoad_Filter", "CS#" + _LoaiCs + "#" + M_Ma_Dvcs + "#" + M_User_Name)
        Dim DtPhanLoai As DataTable = DsTmp.Tables(6).Copy
        CyberFill.V_FillComBoxDefaul(CmbPhan_Loai, DtPhanLoai, "Ma_PhanLoai", IIf(Me.Lan = "V", "Ten_PhanLoai", "Ten_PhanLoai2"), "Ngam_Dinh")
        V_SetEnable()
    End Sub
#End Region
#Region "Valid --- Ma_Cs"
...
#End Region
#Region "Set txt"
    Private Sub V_SetEnable()
        Dim _LoaiCs As String = TxtMa_LoaiCS.Text.Trim
        If _LoaiCs = "17" Then
            TxtMa_LanKTDK1.Enabled = True
            TxtMa_LanKTDK2.Enabled = True
            TxtMa_LanLH1.Enabled = True
            TxtMa_LanLH2.Enabled = True
        Else
            TxtMa_LanKTDK1.Enabled = False
            TxtMa_LanKTDK2.Enabled = False
            TxtMa_LanLH1.Enabled = False
            TxtMa_LanLH2.Enabled = False
        End If
    End Sub
#End Region
#Region "Support"
