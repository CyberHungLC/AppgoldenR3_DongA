...
#Region "Load"
    Private Function GetGroupBy() As DataTable
        ...
        GetGroupBy = _Return
    End Function
    Private Function Loc_Pk() As DataTable
        Dim _Return As New DataTable
        _Return.Columns.Add("Ma")
        _Return.Columns.Add("Ten")
        _Return.Columns.Add("Ten2")
        _Return.Columns.Add("Ngam_Dinh")
        _Return.Rows.Add("", "Tất cả", "Tất cả", "1")
        _Return.Rows.Add("01", "Phụ tùng", "Phụ tùng", "0")
        _Return.Rows.Add("02", "Phụ kiện", "Phụ kiện", "0")
        Loc_Pk = _Return
    End Function
    Private Sub V_Load()
        CyberFill.V_FillComBoxDefaul(Me.cbbTinh_dc, _DtGroupBy, "Tinh_dc", "Ten_DC", "Ngam_Dinh")
        CyberFill.V_FillComBoxDefaul(Me.CbbLoc, _DtLoc_Pk, "Ma", "Ten", "Ngam_Dinh")
...
#Region "Button"
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        M_strParameterStore = M_strParameterStore & "#" & CbbLoc.SelectedValue.ToString.Trim
