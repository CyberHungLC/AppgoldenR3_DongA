Public Class BEHDCBK1
    ...
    Dim _Ma_Post1, _Ma_Post2 As DataTable
    Private Sub BEHDCBK1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
#Region "Load"
    ...
    Private Sub V_Load()
        ...
        '-----------Ma_Post
        Dim _DsPost As DataSet = CyberSmLib.SQLExcuteStoreProcedure(AppConn, "CP_DsPostHDC", Me.Ma_Dvcs + "#" + User_Name)
        _Ma_Post1 = _DsPost.Tables(0).Copy
        _Ma_Post2 = _DsPost.Tables(1).Copy

        CyberFill.V_FillComBoxDefaul(Me.CbbMa_Post1, _Ma_Post1, "Ma_Post", "Ten_Post", "Ngam_Dinh")
        CyberFill.V_FillComBoxDefaul(Me.CbbMa_Post2, _Ma_Post2, "Ma_Post", "Ten_Post", "Ngam_Dinh")
        _DsPost.Dispose()
...
#Region "Button"
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim M_Ma_Post1 As String = CbbMa_Post1.SelectedValue.ToString.Trim
        Dim M_Ma_Post2 As String = CbbMa_Post2.SelectedValue.ToString.Trim
        ...
        M_strParameterStore = M_strParameterStore & "#" & M_Ma_Post1
        M_strParameterStore = M_strParameterStore & "#" & M_Ma_Post2
