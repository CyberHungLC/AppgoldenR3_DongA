...
#Region "Load"
    ...
    Private Sub CreateTabe()
        ...
        DtTCap_SC.Rows.Add("1", IIf(M_LAN = "V", "Bảo dưỡng cấp 1", "Account is correct warehouse"))
        DtTCap_SC.Rows.Add("2", IIf(M_LAN = "V", "Bảo dưỡng cấp 2", "Account is correct warehouse"))
        DtTCap_SC.Rows.Add("3", IIf(M_LAN = "V", "Bảo dưỡng cấp 3", "Account is correct warehouse"))
        DtTCap_SC.Rows.Add("4", IIf(M_LAN = "V", "Bảo dưỡng cấp 4", "Account is correct warehouse"))
    ...
    Private Sub V_AddHandMaster()
        ...
        RemoveHandler TxtNh_SC1.CyberValiting, AddressOf V_Nh_SC1
        RemoveHandler TxtNh_SC1.CyberLeave, AddressOf L_Nh_SC1
        AddHandler TxtNh_SC1.CyberValiting, AddressOf V_Nh_SC1
        AddHandler TxtNh_SC1.CyberLeave, AddressOf L_Nh_SC1
...
#Region "Vali --- Ma_SC1"
    Private Sub V_Nh_SC1(ByVal sender As System.Object, ByVal e As System.EventArgs)
        TxtNh_SC1.V_LookUp(M_LAN, M_Para, oSysvar, Appconn, DsLookup, "Ma_NH", "DmNhSC", "1=1", "Loai_Nh='1'")
    End Sub
    Private Sub L_Nh_SC1(ByVal sender As System.Object, ByVal e As System.EventArgs)
        DrReturn = TxtNh_SC1.GetRowsSelectData(True)
        If Not DrReturn Is Nothing Then
            TxtNh_SC1.Text = DrReturn.Item("Ma_Nh")
