...
#Region "Load"
    ...
    Protected Overrides Sub V_Addhander()
        ...
        '--Ma_Vd
        RemoveHandler TxtMa_Vd.CyberValiting, AddressOf V_Ma_Vd
        RemoveHandler TxtMa_Vd.CyberLeave, AddressOf L_Ma_Vd
        AddHandler TxtMa_Vd.CyberValiting, AddressOf V_Ma_Vd
        AddHandler TxtMa_Vd.CyberLeave, AddressOf L_Ma_Vd
...
#Region "Vali --- Ma_Vd"
    Private Sub V_Ma_Vd(ByVal sender As System.Object, ByVal e As System.EventArgs)
        TxtMa_Vd.V_LookUp(M_LAN, M_Para, oSysvar, Appconn, DsLookup, "Ma_Vd", "CRMDMVDKN", "1=1", "1=1")
    End Sub
    Private Sub L_Ma_Vd(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If TxtMa_Vd.Text = "" Then
            TxtTen_Vd.Text = ""
            Exit Sub
        End If
        DrReturn = TxtMa_Vd.GetRowsSelectData(True)
        If Not DrReturn Is Nothing Then
            TxtMa_Vd.Text = DrReturn.Item("Ma_Vd")
            TxtTen_Vd.Text = DrReturn.Item("Ten_Vd")
        Else
            TxtMa_Vd.Text = ""
            TxtTen_Vd.Text = ""
        End If
...
#Region "Buuton"
    Protected Overrides Sub V_Save(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If Not _Value.Trim = "" Then TxtMa_Bphh.Text = _Value
