Public Class FrmTiep_Don_Update_RVR
    ...
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim _Sai_Bien As String = IIf(ChkSai_bien.Checked = True, 1, 0).ToString.Trim

        Dim DsTmp_Up As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_Work_Tiep_Don_Update_RVR", M_Stt_rec.Trim & "#" & _Ma_Xe.Trim & "#" & _Is_SCC.Trim & "#" & _Is_SBD.Trim & "#" & _Is_SDS.Trim & "#" & _Sai_Bien.Trim & "#" & M_Ma_Dvcs & "#" & M_User_Name)
