Public Class RO_HD05
    ...
    Dim DtMa_Post1, DtMa_Post2 As DataTable
...
#End Region
    Private Sub V_Load()
        ...
        Dim DsPost As DataSet = CyberSmLib.SQLExcuteStoreProcedure(AppConn, "CP_GetDsPostHDK", Me.Ma_Dvcs + "#" + User_Name)
        DtMa_Post1 = DsPost.Tables(0).Copy
        DtMa_Post2 = DsPost.Tables(1).Copy
        CyberFill.V_FillComBoxDefaul(Me.CbbMa_Post_HDK1, DtMa_Post1, "Ma_Post", "Ten_Post", "Ngam_Dinh")
        CyberFill.V_FillComBoxDefaul(Me.CbbMa_Post_HDK2, DtMa_Post2, "Ma_Post", "Ten_Post", "Ngam_Dinh")
        DsPost.Dispose()
        '--------------------------------------------------------------------
        '----Set
...
#End Region
#Region "Vali --- Tk_Dt"
    Private Sub V_Tk_Dt(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        TxtTk_Dt.V_LookUp(Me.LAN, Me.Para, Me.sysvar, AppConn, DsLookup, "Tk", "DmTk", "1=1", "1=1")
    End Sub
    Private Sub L_Tk_Dt(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If TxtTk_Dt.Text = "" Then
            TxtTen_Tk.Text = ""
            Exit Sub
        End If
        DrReturn = TxtTk_Dt.GetRowsSelectData(False)
        If Not DrReturn Is Nothing Then
...
#Region "Button"
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim M_Ma_Post_HDK1_Filter As String = Me.CbbMa_Post_HDK1.SelectedValue.ToString.Trim
        Dim M_Ma_Post_HDK2_Filter As String = Me.CbbMa_Post_HDK2.SelectedValue.ToString.Trim
        ...
        M_strParameterStore = M_strParameterStore & "#" & M_Ma_Post_HDK1_Filter
        M_strParameterStore = M_strParameterStore & "#" & M_Ma_Post_HDK2_Filter
        M_strParameterStore = M_strParameterStore & "#" & TxtMa_TTCP.Text
        M_strParameterStore = M_strParameterStore & "#" & CyberMe.GetLoai_BC(ChkVND, ChkNT)
        M_strParameterStore = M_strParameterStore & "#" & M_Ma_Dvcs_Filter
        M_strParameterStore = M_strParameterStore & "#" & Me.User_Name.Trim
        M_strParameterStore = M_strParameterStore & "#" & TxtTk_Dt.Text.Trim
        '-----------------------------------------------------------------------------
        Me.is_continue = True
