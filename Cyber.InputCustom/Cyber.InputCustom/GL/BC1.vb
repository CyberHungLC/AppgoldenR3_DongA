...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Master()
        ...
        AddHandler TxtT_C.Leave, AddressOf GetMaTd3FromMaHd
        '--KH
        ...
        AddHandler btnGoi_TBH.Click, AddressOf btnGoi_TBH_Click
...
#End Region
    ...
    Private Sub GetMaTd3FromMaHd()
        Dim dstmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_TD5GetMa_TD3Detail", TxtMa_HD_H.Text & "#" & "" & "#" & TxtT_C.Double & "#" & M_Stt_Rec & "#" & M_Ma_CT & "#" & M_Ma_Dvcs & "#" & M_User_Name)
...
#End Region
    ...
    End Sub
    Private Sub V_Ma_TD3_i1(ByVal sender As System.Object, ByVal e As System.EventArgs)
...
#Region "Phan bo"
    ...
    Private Sub btnGoi_TBH_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim _Ma_HD_H As String = ""

        If TxtLenh_RO.Text.Trim + TxtMa_Kh.Text.Trim + _Ma_HD_H = "" Then Exit Sub
        Dim _Link As String = TxtLenh_RO.Text.Trim.Replace("#", "") + "#" + TxtMa_Kh.Text.Trim.Replace("#", "") + "#" + _Ma_HD_H.Trim.Replace("#", "")
        If _Link = "" Then Exit Sub
        Dim strAddParar As String = "4#TBH#10#" + _Link
    ...
    End Sub
#End Region
    Private Sub GetPt1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim frm As New FrmLocPT5
    ...
    Private Sub L_So_QTU()
        ...
        Dim DsReturn As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_PT1_BC1_GetQTU", _StrParameter)
