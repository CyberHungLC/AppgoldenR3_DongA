...
Public Class CRM_SMS_06
    ...
    Private Sub V_AddHander()
        ...
        'Ma_HSGX
        AddHandler CmdChon_HSGX.Click, AddressOf V_ChonHSGX
...
#Region "Button"
    ...
    Private Sub V_XoaLoc(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        TxtTen_NhaMang.Text = ""
        TxtMa_HSGX.Text = ""
        ChkIs_TT_All.Checked = True
        ChkIs_TT_KNo.Checked = False
        ChkIs_TT_No.Checked = False
    End Sub
...
#Region "Load Default"
    Private Sub V_Getdefault()
        ...
        TxtMa_HSGX.Text = CyberSmlib.GetKeyValueRegistry(Me.Sysvar, TxtMa_HSGX)
...
#Region "LoadData"
    Private Sub V_LoadData(ByVal Status As String)
        ...
        Dim _Ma_HSGX As String = TxtMa_HSGX.Text.Trim
        Dim _Ma_TT As String = ""

        If ChkIs_TT_All.Checked = True Then _Ma_TT = ""
        If ChkIs_TT_No.Checked = True Then _Ma_TT = "01"
        If ChkIs_TT_KNo.Checked = True Then _Ma_TT = "02"
...
#Region "Valid --- Ma_HSGX"
    Private Sub V_ChonHSGX(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Dim str As String
        str = CyberSupport.V_GetStrSelectList(AppConn, Me.Sysvar, Me.Para, "CP_GetListSelect", "DmHSGX#" & TxtMa_NN.Text.Trim & "##" & M_Ma_Dvcs & "#" & M_User_Name, Me.Lan)
