...
#Region "Valid --- Ma_TD3_H"
    ...
    Private Sub CP_GetHDCFromMa_HD()
        ...
        dsTMp.Dispose()
        If Dt.Columns.Contains("So_Khung") Then If Dt.Rows(0).Item("So_Khung").ToString.Trim = "" Then MsgBox("Chưa thực hiện xếp xe")
...
#Region "Valid --- Ma_HD_H"
    ...
    Private Sub CP_GetHDCFromHDX()
        ...
        Dim _DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetHDCFromHDX", M_Mode & "#" & M_Stt_Rec.Trim & "#" & M_Ma_CT & "#" & _Dt.ToString("yyyyMMdd") & "#" & TxtMa_HD_H.Text.Trim & "#" & M_Ma_Dvcs & "#" & M_User_Name & "#" & TxtMa_Thue.Text.Trim)
...
#Region "Valid - Detail - Core"
    Private Sub V_Tinh_Thue_CK()
        ...
        If Not ChkSua_Thue.Checked Then
            ...
            If nT_Thue_Nt = 0 Then nT_Thue_Nt = CyberSupport.V_Round(nT_Tien_Hang_NT * nThue_Suat / 100, M_R_TIEN_NT)
            If nT_Thue_Nt = 0 Then TxtT_thue_NT.Double = nT_Thue_Nt
    ...
    Private Sub UpdateList()
        ...
        For iRow As Integer = 0 To Dv_DetailTmp.Count - 1
            ...
            If Dt_DetailTmp.Columns.Contains("Thue_NT") Then nThue_NT = nThue_NT + Dv_DetailTmp.Item(iRow).Item("Thue_NT")
            If Dt_DetailTmp.Columns.Contains("Thue") Then nThue = nThue + Dv_DetailTmp.Item(iRow).Item("Thue")

        Next
        nT_CP = nT_KM + nT_BB + nT_Moi_gioi + nT_Km_khac
        If ChkSua_Thue.Checked Then nThue_NT = TxtT_thue_NT.Double
        If ChkSua_Thue.Checked Then nThue = TxtT_Thue.Double
...
#Region "Ma_Kx/Ma_Mau/Vitri - "
    ...
    Private Sub V_GetTtXe(ByVal _row As Integer)
        ...
        If Dstmp.Tables(1).Columns.Contains("Ma_Kho_i") And Dv_DetailTmp.Item(_row).Item("Ma_Kho_i") = "" Then Dv_DetailTmp.Item(_row).Item("Ma_Kho_i") = Dstmp.Tables(1).Rows(0).Item("Ma_Kho_i")

        If Dstmp.Tables(1).Columns.Contains("Tk_Dt") Then Dv_DetailTmp.Item(_row).Item("Tk_Dt") = Dstmp.Tables(1).Rows(0).Item("Tk_Dt")
        If Dstmp.Tables(1).Columns.Contains("Tk_Vt") Then Dv_DetailTmp.Item(_row).Item("Tk_Vt") = Dstmp.Tables(1).Rows(0).Item("Tk_Vt")
        If Dstmp.Tables(1).Columns.Contains("Tk_Gv") Then Dv_DetailTmp.Item(_row).Item("Tk_Gv") = Dstmp.Tables(1).Rows(0).Item("Tk_Gv")
        If Dstmp.Tables(1).Columns.Contains("Gia_Nt0") Then
            Dv_DetailTmp.Item(_row).Item("Gia_Nt") = Dstmp.Tables(1).Rows(0).Item("Gia_Nt0")
            Dv_DetailTmp.Item(_row).Item("Gia") = Dstmp.Tables(1).Rows(0).Item("Gia_Nt0")
        End If
        If Dstmp.Tables(1).Columns.Contains("Tien_Nt0") Then
            Dv_DetailTmp.Item(_row).Item("Tien_Nt") = Dstmp.Tables(1).Rows(0).Item("Tien_Nt0")
            Dv_DetailTmp.Item(_row).Item("Tien") = Dstmp.Tables(1).Rows(0).Item("Tien_Nt0")
        End If
        If Dstmp.Tables(1).Columns.Contains("Ten_VT_Thue") Then TxtTen_VtThue.Text = Dstmp.Tables(1).Rows(0).Item("Ten_VT_Thue")
    ...
    Private Sub V_SetPriceXeSales(ByVal iRow As Integer, ByVal _Loai As String)
        ...
        Dim _ngay_Ct As Date = TxtNgay_Ct.Value
        Dim _Ma_Thue As String = TxtMa_Thue.Text
        ...
        M_Mode.Trim + "#" + _Stt_Rec0 + "#" + _Stt_Rec0_HDX + "#" + M_Stt_Rec + "#" + M_Ma_CT.Trim + "#" + TxtMa_Dvcs.Text.Trim + "#" + M_User_Name.Trim + "#" + _Ma_Thue.Trim)
...
#End Region
    ...
    Private Sub V_Huy_HD(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetHuyHDC", M_Stt_RecOld & "#" & M_Stt_Rec & "#" & M_Ma_CT & "#" & TxtMa_Dvcs.Text & "#" & M_User_Name)
        ...
        UpdateList()
    End Sub
    '#Region "Hóa đơn điện tử 78"
    '    Private Sub CmDTAO_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdTaoHDDT.Click
    '        If (M_Mode = "M" Or M_Mode = "S") Then
    '            Exit Sub
    '        End If
    '        'Check phân quyền
    '        Dim dsCheck As New DataSet
    '        dsCheck = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_Chk_HDDT ", M_Ma_CT.Trim + "#" + M_Stt_Rec.Trim + "#T" + "#" + M_User_Name.Trim + "#" + M_Ma_Dvcs.Trim)
    ...
    '        Dim _postapi As New Cyber.PostAPIInvoiceViettel.Sys
    '        Dim dtvb As Date = TxtNgay_Ct.Value

    '        'Dim DsData As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_APIGetDataToInvoiceTAO", "T#" + dtvb.ToString("yyyyMMdd") + "###" + M_Stt_Rec.Trim + "##" + M_Ma_CT.Trim + "#" + M_Ma_Dvcs.Trim + "#" + M_User_Name.Trim)
    '        Dim DsData As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_APIGetDataToInvoiceTAO", "T#" + dtvb.ToString("yyyyMMdd") + "###" + M_Stt_Rec.Trim + "##" + M_Ma_CT.Trim + "###" + M_Ma_Dvcs.Trim + "#" + M_User_Name.Trim)
    ...
    '        Dim Repones As New Cyber.PostAPIInvoiceViettel.InvoiceViettelRespone
    '        Dim strError As String = ""
    '        If _postapi.V_PostDataToInvoiceViettel(AppConn, osysvar, M_Stt_Rec, M_Ma_Dvcs, M_User_Name, DsData, strError, Repones) = False Then
    '            MsgBox(strError + Repones.description, MsgBoxStyle.Critical, osysvar("M_CYBER_VER"))
    '            Return
    '        End If

    '        ''===============thực thi cập nhật dữ liệu vào bảng khi kết quả FPT trả về thành công
    '        Dim invoiceNo As String = "" 'Repones.result("invoiceNo").ToString

    '        Dim So_hoadon As String = "" 'invoiceNo.Substring(6).ToString()
    '        Dim Serri_hoadon As String = "" 'invoiceNo.Substring(0, 6).ToString()
    '        Dim mauso_hoadon As String = "" 'Repones.result("transactionID").ToString()
    '        Dim Ma_tra_cuu As String = "" 'Repones.result("reservationCode").ToString()

    '        '--================== Viet thu tuc Update lai du lieu
    '        Dim DsData_l As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_APIInvoice_UPDATE", So_hoadon + "#" + Serri_hoadon + "#" + mauso_hoadon + "#" + "T#" + Ma_tra_cuu + "#" + dtvb.ToString("yyyyMMdd") + "#" + M_Ma_CT.Trim + "#" + M_Stt_Rec.Trim + "##" + dtvb.ToString("yyyyMMdd") + "###" + M_Ma_Dvcs.Trim + "#" + M_User_Name.Trim)
    '        MsgBox("Đã tạo hóa đơn điện tử nháp xong!")

    '    End Sub
    '    Private Sub CmDPHATHANH_HD_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdPhatHanhHDDT.Click
    '        If (M_Mode = "M" Or M_Mode = "S") Then
    '            Exit Sub
    '        End If
    '        'Check phân quyền
    ...
    '            End If
    '        End If
    '        If MsgBox("Bạn chắc chắn muốn phát hành hóa đơn điện tử?", MsgBoxStyle.YesNo, osysvar("M_CYBER_VER")) <> MsgBoxResult.Yes Then Return

    '        Dim _postapi As New Cyber.PostAPIInvoiceViettel.Sys
    '        Dim dtvb As Date = TxtNgay_Ct.Value
    '        'Dim DsData As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_APIGetDataToInvoiceTAO", "P#" + dtvb.ToString("yyyyMMdd") + "###" + M_Stt_Rec.Trim + "##" + M_Ma_CT.Trim + "#" + M_Ma_Dvcs.Trim + "#" + M_User_Name.Trim)
    '        Dim DsData As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_APIGetDataToInvoiceTAO", "P#" + dtvb.ToString("yyyyMMdd") + "###" + M_Stt_Rec.Trim + "##" + M_Ma_CT.Trim + "###" + M_Ma_Dvcs.Trim + "#" + M_User_Name.Trim)
    ...
    '        '--================== Viet thu tuc Update lai du lieu
    '        'Dim DsData_l As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_APIInvoice_UPDATE", So_hoadon + "#" + Serri_hoadon + "#" + mauso_hoadon + "#" + "P#" + Ma_tra_cuu + "##" + M_Ma_CT.Trim + "#" + M_Stt_Rec.Trim + "##" + M_Ma_Dvcs.Trim + "#" + M_User_Name.Trim)
    '        Dim DsData_l As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_APIInvoice_UPDATE", So_hoadon + "#" + Serri_hoadon + "#" + mauso_hoadon + "#" + "T#" + Ma_tra_cuu + "#" + dtvb.ToString("yyyyMMdd") + "#" + M_Ma_CT.Trim + "#" + M_Stt_Rec.Trim + "##" + dtvb.ToString("yyyyMMdd") + "###" + M_Ma_Dvcs.Trim + "#" + M_User_Name.Trim)

    '        MsgBox("Đã thực hiện phát hành hóa đơn điện tử xong!")

    '        txtSo_ct.Text = Strings.Right("00000000" & So_hoadon, 8)
    '        TxtSo_HDDT.Text = Strings.Right("00000000" & So_hoadon, 8)
    '        TxtSo_Seri.Text = Serri_hoadon
    '        TxtSo_seriHD.Text = Serri_hoadon
    '        Txtma_tra_cuu.Text = Ma_tra_cuu
    '        TxtMau_VATHD.Text = mauso_hoadon
    '        TxtnoteHDDT.Text = "Hóa đơn điện tử số (" + Strings.Right("00000000" & So_hoadon, 8) + ") mã tra cứu (" + Ma_tra_cuu + ") phát hành trên hệ thống"

    '    End Sub
    '    Private Sub CmdXemHDDT_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdXemHDDT.Click
    '        If (M_Mode = "M" Or M_Mode = "S") Then
    '            Exit Sub
    '        End If
    ...
    '        Dim DsData As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_APIGetDataToInvoiceTAO", "X#" + dtvb.ToString("yyyyMMdd") + "###" + M_Stt_Rec.Trim + "##" + M_Ma_CT.Trim + "###" + M_Ma_Dvcs.Trim + "#" + M_User_Name.Trim)
    '        If DsData.Tables(0).Rows(0)("Status").ToString.Trim.ToUpper <> "Y" Then
    '            MsgBox(DsData.Tables(0).Rows(0)("Note").ToString.Trim, MsgBoxStyle.Critical, osysvar("M_Cyber_Ver"))
    '            Return
    '        End If
    ...
    '        Dim Repones As New Cyber.PostAPIInvoiceViettel.InvoiceViettelRespone
    '        Dim strError As String = ""
    '        If _postapi.V_ViewInvoiceViettel(AppConn, osysvar, M_Stt_Rec, M_Ma_Dvcs, M_User_Name, DsData, strError, Repones) = False Then
    '            MsgBox(strError + Repones.description, MsgBoxStyle.Critical, osysvar("M_CYBER_VER"))
    '            Return
    '        End If
    '        ''===============thực thi cập nhật dữ liệu vào bảng khi kết quả FPT trả về thành công
