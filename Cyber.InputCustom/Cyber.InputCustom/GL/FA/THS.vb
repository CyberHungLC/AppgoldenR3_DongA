...
#End Region
    Private Sub THS_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
...
#Region "Button"
    ...
    Private Function ChkVsave() As Boolean
        ...
        For iRow = 0 To Dt_DetailTmp.Rows.Count - 1
            ...
            If TxtMa_BP_H.Text.Trim <> "" And Dt_DetailTmp.Rows(iRow).Item("Ma_BP_I") = "" Then Dt_DetailTmp.Rows(iRow).Item("Ma_BP_I") = TxtMa_BP_H.Text.Trim
            If TxtMa_Hs_H.Text.Trim <> "" And Dt_DetailTmp.Rows(iRow).Item("Ma_HS_I") = "" Then Dt_DetailTmp.Rows(iRow).Item("Ma_HS_I") = TxtMa_Hs_H.Text.Trim
