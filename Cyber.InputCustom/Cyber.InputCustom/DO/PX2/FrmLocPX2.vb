...
#Region "Get or Set Property----------------------"
    ...
    Public Property Mode() As String
        ...
        End Set
    End Property
    Public Property Lenh_PO() As String
        Get
            Return M_Lenh_PO
        End Get
        Set(ByVal value As String)
...
#Region "Valid --- Ma_Hs"
    ...
    Private Sub V_Ma_VT(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        TxtMa_VT.V_LookUp(M_LAN, Para, Sysvar, AppConn, DsLookup, "Ma_VT", "DmVT", "1=1", "1=1")
    End Sub
...
#Region "Load - "
    ...
    Private Sub V_LoadDatabase(ByVal Status As String)
        ...
        Dim DsLenh_RO As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetPODToPX2", Status & "#" & TxtLenh_RO.Text.Trim & "#" & TxtLenh_PO.Text.Trim & "#" & TxtMa_Hs.Text.Trim & "#" & _Ngay_Ct1.ToString("yyyyMMdd") & "#" & _Ngay_Ct2.ToString("yyyyMMdd") & "#" & M_Stt_rec & "#" & M_Ma_Dvcs & "#" & M_User_Name)
    ...
    Private Sub V_LoadHeaderGridview()
        ...
        Dim DsHeader As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetDetailHeadPODToPX2", M_Ma_Ct.Trim + "#" + M_User_Name)
        '========== Fill datatable
...
#Region "Tinh toan"
    ...
    Private Sub V_Chon(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        V_Detail(IIf(_Tag <> "1", "0", "1"), _Stt_Rec)
    ...
    Private Sub V_BilldtingRo(ByVal MasterGRV As DevExpress.XtraGrid.Views.Grid.GridView, ByVal Dv_Master As DataView, ByVal Dv_DetailTmp As DataView)
        ...
        End Try
    End Sub
    Private Sub V_Detail(ByVal status As String, ByVal _Stt_Rec As String)
...
#End Region
    ...
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim _Dt_Return As DataTable = dtMasterRo.Clone
        ...
        Me.Lenh_PO = TxtLenh_PO.Text.Trim
