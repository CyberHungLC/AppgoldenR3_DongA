Public Class RO_TT02
    ...
    Dim _Dt_post1, _Dt_post2, _DtGroup, _DtGroupct As DataTable
...
#End Region
    Private Sub V_Load()
        ...
        If TxtMa_KX.Text.Trim = "" Then TxtMa_KX.Text = "" Else TxtMa_KX.Text = CyberSmodb.SQLGetvalue(AppConn, "Ten_KX", "DmKx", "(Ma_Kx = N'" + TxtMa_KX.Text.Trim + "')", CyberSmLib)
