...
#End Region
    Private Sub FrmLocRo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Save_OK = False
        Dim Dstmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_SysExecute", "SELECT Ma_Post,Ten_Post,Ten_Post2,'0' as Ngam_Dinh FROM dbo.DmPost WHERE Ma_Ct = N'HDI' AND Ma_Post > N'3' ORDER BY Ma_Post#" + M_Ma_Dvcs + "#" + M_User_Name)
...
#Region "Valid --- Ma_TT"
    Private Sub V_Ma_TT(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        TxtMa_TT.V_LookUp(M_LAN, Me.Para, Me.Sysvar, AppConn, DsLookup, "Ma_TT", "DmTT", "1=1", "1=1")
    End Sub
    Private Sub L_Ma_TT(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        ...
        If Not DrReturn Is Nothing Then
            TxtMa_TT.Text = DrReturn("Ma_TT").ToString.Trim
        Else
            TxtMa_TT.Text = ""
        End If
    End Sub
...
#Region "Load - "
    ...
    Private Sub V_LoadDatabase(ByVal Status As String)
        ...
        Dim _Ma_TT As String = TxtMa_TT.Text
        ...
        End Try
        Dim DsLenh_RO As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetHDIToDN1", Status & "#" & _Ma_TT & "#" & _Ngay_Ct1.ToString("yyyyMMdd") & "#" + _Ngay_Ct2.ToString("yyyyMMdd") & "#" & _Ma_Post & "#" & Ma_GD & "#" & M_Stt_Rec & "#" & M_Ma_Ct & "#" & M_Mode & "#" & TxtMa_Kh.Text & "#" & TxtMa_BH.Text & "#" & TxtLenh_Ro.Text & "#" & M_Ma_Dvcs & "#" & M_User_Name)
...
#End Region
    Private Sub L_So_Lenh(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        TxtLenh_Ro.Text = CyberVoucher.V_FormatSo_Ro(AppConn, Sysvar, Ma_Ct, "S", Mode, _Ngay_Ct, TxtLenh_Ro.Text, "", M_Ma_Dvcs, M_User_Name)
    End Sub
