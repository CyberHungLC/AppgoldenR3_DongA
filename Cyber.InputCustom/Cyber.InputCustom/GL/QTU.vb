...
#End Region
    Private Sub QTU_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Master()
        ...
        AddHandler CmdLoc_PC1_PT1.Click, AddressOf V_Loc_PC1_PT1

        'Ma_LD
        AddHandler TxtMa_LD.CyberValiting, AddressOf V_Ma_LD
        AddHandler TxtMa_LD.CyberLeave, AddressOf L_Ma_LD
        'Ma_Hs_h
        AddHandler TxtMa_KH_H.CyberValiting, AddressOf V_Ma_Hs
        AddHandler TxtMa_KH_H.CyberLeave, AddressOf L_Ma_Hs
        'Ma_Bp_H
        ...
        AddHandler cmdPT1.Click, AddressOf V_Phieu_Thu
        AddHandler CmdPC1.Click, AddressOf V_Phieu_Chi
        AddHandler cmdBC1.Click, AddressOf V_Phieu_BC1
        AddHandler cmdBN1.Click, AddressOf V_Phieu_BN1
    End Sub
...
#Region "Valid --- Ma_Hs"
    Private Sub V_Ma_Hs(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        TxtMa_KH_H.V_LookUp(M_LAN, M_Para, osysvar, AppConn, DsLookup, "Ma_KH", "DMKH", "1=1", "1=1")
    End Sub
    Private Sub L_Ma_Hs(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If TxtMa_KH_H.Text = "" Then
            TxtTen_KH_H.Text = ""
            Exit Sub
        End If
        DrReturn = TxtMa_KH_H.GetRowsSelectData(True)
        If Not DrReturn Is Nothing Then
            TxtMa_KH_H.Text = DrReturn.Item("Ma_KH")
            TxtTen_KH_H.Text = DrReturn.Item("Ten_KH")
        Else
            TxtMa_KH_H.Text = ""
            TxtTen_KH_H.Text = ""
        End If
...
#Region "Valid --- Ma_Bp"
    ...
    End Sub
#End Region
    Private Sub V_Phieu_Thu(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ''If (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If TxtSo_ct.Text.Trim.Replace("#", "").Trim = "" Then Exit Sub
        Dim strAddParar As String = "2#PT1#10#" + TxtSo_ct.Text.Trim.Replace("#", "") + "#"
    ...
    End Sub
    Private Sub V_Phieu_Chi(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ''If (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If TxtSo_ct.Text.Trim.Replace("#", "").Trim = "" Then Exit Sub
        Dim strAddParar As String = "2#PC1#10#" + TxtSo_ct.Text.Trim.Replace("#", "") + "#"
        Dim _Process As Process = CyberSmlib.V_CallRun("Cyber.Input.dll", Me.Para, strAddParar)
        If Not _Process Is Nothing Then ProccessList.Add(_Process)
    End Sub
    Private Sub V_Phieu_BC1(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ''If (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If TxtSo_ct.Text.Trim.Replace("#", "").Trim = "" Then Exit Sub
        Dim strAddParar As String = "2#BC1#10#" + TxtSo_ct.Text.Trim.Replace("#", "") + "#"
        Dim _Process As Process = CyberSmlib.V_CallRun("Cyber.Input.dll", Me.Para, strAddParar)
        If Not _Process Is Nothing Then ProccessList.Add(_Process)
    End Sub
    Private Sub V_Phieu_BN1(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ''If (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If TxtSo_ct.Text.Trim.Replace("#", "").Trim = "" Then Exit Sub
        Dim strAddParar As String = "2#BN1#10#" + TxtSo_ct.Text.Trim.Replace("#", "") + "#"
        Dim _Process As Process = CyberSmlib.V_CallRun("Cyber.Input.dll", Me.Para, strAddParar)
        If Not _Process Is Nothing Then ProccessList.Add(_Process)
    End Sub
...
#Region "Valid - Detail - Core"
    Private Sub UpdateList()
        ...
        For iRow = 0 To Dv_DetailTmp.Count - 1
            ...
            nT_Tien_TU = nT_Tien_TU + Dv_DetailTmp.Item(iRow).Item("Tien_TU")

        Next
        If ChkHT_Thue.Checked Then
        ...
        If TxtT_Tien_TU.Double = 0 Then
                   TxtT_Tien_TU.Double = nT_Tien_TU
        End If

        TxtT_Tien_Chenh.Double = TxtT_Tien_TU.Double - nT_Tien_NT
        ...
        TxtT_TT_NT.Refresh()
        TxtT_TT.Refresh()
        TxtT_Tien_TU.Refresh()
        TxtT_Tien_Chenh.Refresh()
        If TxtT_Tien_Chenh.Double < 0 Then
            CmdPC1.Visible = True
            cmdPT1.Visible = False
            cmdBN1.Visible = True
            cmdBC1.Visible = False
        End If
        If TxtT_Tien_Chenh.Double >= 0 Then
            CmdPC1.Visible = False
            cmdPT1.Visible = True
            cmdBN1.Visible = False
            cmdBC1.Visible = True
        End If
    End Sub
...
#Region "Valid - Detail - Add On"
    ...
    Private Sub L_Ma_TD3_i(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim MaHDTmp As String = CyberSmodb.SQLGetvalue(AppConn, "Ma_HD", "DmTD3", "(Ma_TD3 = N'" & Dv_DetailTmp.Item(iRow).Item("Ma_TD3_I") & "')", CyberSmlib)
        Dim TenHDTmp As String = CyberSmodb.SQLGetvalue(AppConn, "Ten_HD", "DmHD", "(Ma_Hd = N'" & MaHDTmp & "')", CyberSmlib)
        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dv_DetailTmp.Item(iRow)("Ma_HD_i") = MaHDTmp
        Dv_DetailTmp.Item(iRow)("Ten_HD_i") = TenHDTmp
        Dv_DetailTmp.Item(iRow).EndEdit()
        'CyberSupport.V_GetNameList(StatusFooter1, AppConn, osysvar, M_Mode, Dv_DetailTmp.Item(iRow).Item("Ma_TD3_I"), "Ma_TD3", "Ten_TD3", "DMTD3", M_Stt_Rec, M_Ma_CT, M_Ma_Dvcs, M_User_Name, CyberSmlib)
    End Sub
...
#Region "Button"
    ...
    Private Function ChkVsave() As Boolean
        ...
        For iRow = nCount - 1 To 0 Step -1
            If Dt_DetailTmp.Rows(iRow).Item("Tk_No").ToString.Trim = "" And (Dt_DetailTmp.Rows(iRow).Item("Tien") = 0 And Dt_DetailTmp.Rows(iRow).Item("Tien_Nt") = 0) Then
...
#End Region
#Region "Lọc phiếu chi"
    Private Sub V_Loc_PC1_PT1(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim Frm As PC1_PT1_Loc
        Frm = New PC1_PT1_Loc
    ...
    Private Sub L_Lenh_PO_Update(ByVal _Tb_Master As DataTable, ByVal _Dt_Detail As DataTable)
        If _Tb_Master.Rows.Count > 0 Then
            If TxtMa_KH_H.Text.Trim = "" And _Tb_Master.Columns.Contains("Ma_KH") Then TxtMa_KH_H.Text = _Tb_Master.Rows(0).Item("Ma_KH")
            If TxtTen_KH_H.Text.Trim = "" And _Tb_Master.Columns.Contains("Ten_KH") Then TxtTen_KH_H.Text = _Tb_Master.Rows(0).Item("Ten_KH")
            ...
            If _Tb_Master.Columns.Contains("Stt_Rec_TU") Then TxtStt_Rec_TU.Text = _Tb_Master.Rows(0).Item("Stt_Rec_TU")
            If _Tb_Master.Columns.Contains("So_Ct") Then txtSo_TU.Text = _Tb_Master.Rows(0).Item("So_Ct")
        End If
        Dt_DetailTmp.Clear()
