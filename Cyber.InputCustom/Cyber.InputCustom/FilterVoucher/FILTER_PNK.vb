...
Public Class FILTER_PNK
    ...
    Private Sub V_Addhander()
        ...
        'AddHandler TxtSo_PO.Leave, AddressOf L_Lenh_Ro
...
#End Region
    ...
    '    TxtSo_PO.Text = CyberVoucher.V_FormatSo_Ro(AppConn, osysvar, Me.Ma_CT, _Ma_GD, "M", _Dt, TxtSo_PO.Text, "", M_Ma_Dvcs, M_User_Name, CyberSmlib)
    'End Sub
End Class
