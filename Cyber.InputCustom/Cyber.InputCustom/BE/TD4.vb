...
#Region "Columns Edit"
    ...
    Dim EditDien_Giaii, EditSo_So, EditSo_Po, EditSo_Ro, EditSo_VT, EditTT_PDI, EDitTT_PK As New Cyber.Fill.CyberColumnGridView
#End Region
...
#Region "Load And Set And Default"
    ...
    Private Sub V_GetColumn()
        ...
        EditTT_PDI.GetColumn(DetailGRV, "TT_PDI")
        EDitTT_PK.GetColumn(DetailGRV, "TT_PK")
...
#Region "V_AddHandler"
    ...
    Private Sub VisibleColumnMa_GD()
        If CmbMa_GD.SelectedValue = "2" Then
            TxtMa_TD3_H.Enabled = True
        End If
        If CmbMa_GD.SelectedValue = "5" Then
            TxtMa_TD3_H.Enabled = False
            'TxtMa_TD3_H.Enabled = False
        End If
    End Sub
...
#Region "Valid --- Ma_HD"
    ...
    Private Sub L_Ma_HD_H(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Not TxtMa_TD3_H.Text.Trim = "" And CmbMa_GD.SelectedValue = "2" Then
            CP_TD5GetMa_HD()
        End If
        If CmbMa_GD.SelectedValue = "5" Then
            CP_TD5GetMa_HD()
    ...
    Private Sub GetMaTd3FromMaHd()
        Dim dstmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_TD5GetMa_TD3", TxtMa_HD_H.Text & "#" & TxtMa_TD3_H.Text & "#" & M_Stt_Rec & "#" & M_Ma_CT & "#" & CmbMa_GD.SelectedValue & "#" & M_Ma_Dvcs & "#" & M_User_Name)
        For Each dt As DataTable In dstmp.Tables
            CyberSmodb.SetNotNullTable(dt)
        Next
        If CmbMa_GD.SelectedValue <> "5" Then
    ...
    Private Sub CP_TD5GetMa_HD()
        Dim dstmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_TD5GetMa_HD", TxtMa_HD_H.Text & "#" & TxtMa_TD3_H.Text & "#" & M_Stt_Rec & "#" & M_Ma_CT & "#" & CmbMa_GD .SelectedValue  & "#" & M_Ma_Dvcs & "#" & M_User_Name)
        For Each dt As DataTable In dstmp.Tables
            CyberSmodb.SetNotNullTable(dt)
        Next
        Dt_DetailTmp.Rows.Clear()
        ...
        If dstmp.Tables(1).Columns.Contains("Dien_Giai") And TxtDien_Giai.Text = "" Then TxtDien_Giai.Text = dstmp.Tables(1).Rows(0)("Dien_Giai").ToString().Trim()
...
#Region "Button"
    Private Sub V_Save(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim _Ngay_GX As Date = TxtNgay_Gx.Value
        'MsgBox(TxtNgay_Ct.Value.ToString)
        If _Ngay_GX.ToString("yyyyMMdd") = "19000101" Then
            If MsgBox("Ngày giao xe thực tế đang trống bạn có lưu không?", MsgBoxStyle.YesNo, osysvar("M_CYBER_VER")) <> MsgBoxResult.Yes Then Return
        End If
    ...
    Private Sub V_Edit(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        TxtMa_TD3_H.ReadOnly = True
        TxtMa_Hs_BL.ReadOnly = True
        TxtMa_Hs_H.ReadOnly = True
        TxtMa_Xe.ReadOnly = True
        TxtGio_CT.ReadOnly = True
        TxtGio_Gx.ReadOnly = True
        TxtGio_Ve.ReadOnly = True
