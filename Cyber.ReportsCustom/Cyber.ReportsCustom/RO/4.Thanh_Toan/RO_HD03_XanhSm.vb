Public Class RO_HD03_XanhSm
    Dim CyberMe As New Cyber.ReportsCustom.Sys
    Dim DsLookup As DataSet
    Dim DrReturn As DataRow
    Private Sub RO_HD03_XanhSm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_AddMenuShorcut()
...
#Region "Load"
    Private Sub V_Load()
        ...
        Try
            Text = Me.Para(Me.VT_PARA + 1).ToString.Trim
        ...
        'If TxtMa_Kh.Text.Trim = "" Then TxtMa_Kh.Text = "01.01.00002"
...
#Region "Button"
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        M_strParameterStore = M_strParameterStore & "#" & IIf(ChkIs_Con_CN.Checked, "1", "0")
        '-----------------------------------------------------------------------------
        Me.is_continue = True
