...
#End Region
    ...
    End Sub
    Private Sub FrmCRQLDV_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Getdefault()
        V_loadData()
        V_MainSystem()
        V_Addhandler()
