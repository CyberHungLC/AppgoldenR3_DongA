Public Class DMTD2
    ...
    Private Sub FDMTD2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Cyber.ListGroupCustom.Sys.SetAutoCode(Appconn, Me.Tb_Name, Me.Mode, CyberSmlib, CyberSmodb, TxtMa_TD2, TxtNh_TD1, TxtNh_TD2, TxtNh_TD3, TxtNh_TD4, TxtNh_TD5)
        TxtMa_TD2.Focus()
        CyberSupport.Translaste(Me, M_LAN, True)
    End Sub
#Region "Load"
...
#Region "Vali --- Ma_KH"
    ...
    Private Sub L_Ma_Kh(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Not DrReturn Is Nothing Then
            ...
            TxtTen_KH.Text = DrReturn.Item("Ma_Kh")
        Else
            TxtMa_Kh.Text = ""
            TxtTen_KH.Text = ""
        End If
