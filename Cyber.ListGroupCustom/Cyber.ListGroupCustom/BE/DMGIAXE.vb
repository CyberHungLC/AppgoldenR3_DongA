...
#Region "Load"
    ...
    Protected Overrides Sub V_Addhander()
        ...
        AddHandler TxtGia_nt2.Leave, AddressOf L_Gia_NT2
        AddHandler TxtGia_nt3.Leave, AddressOf L_Gia_NT3
    ...
    End Sub
#End Region
    Private Sub L_Gia_NT2(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If TxtGia_nt3.Text = 0 Then
            TxtGia_nt3.Text = CyberSupport.V_Round(TxtGia_nt2.Text * 1.1, 0)
        End If
    End Sub
    Private Sub L_Gia_NT3(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If TxtGia_nt2.Text = 0 Then
            TxtGia_nt2.Text = CyberSupport.V_Round(TxtGia_nt3.Text / 1.1, 0)
        End If
    End Sub
#Region "Vali --- Ma_kx"
