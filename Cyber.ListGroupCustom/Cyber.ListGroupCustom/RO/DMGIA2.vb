...
#Region "Load"
    ...
    Protected Overrides Sub V_Addhander()
        ...
        AddHandler TxtGio_HL.Leave, AddressOf V_Gio_HL
    ...
    Protected Overrides Sub V_GetValueParameter()
        ...
        _Para_Loai_VT = M_Para(M_Para.Length - 1).Trim
    End Sub
#End Region

#Region "Giờ"
    Private Sub V_Gio_HL(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (Me.Mode = "M" Or Me.Mode = "S") Then Exit Sub
        TxtGio_HL.Text = CyberVoucher.V_GetTG(TxtGio_HL.Text, 0)
    End Sub
#Region "Vali --- Ma_Vt"
    Private Sub V_Ma_Vt(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Dim _fileter = "1=1"
        If _Para_Loai_VT = "2" Then
            _fileter = "Nh_VT1<>'01'"
        End If
        'TxtMa_Vt.V_LookUp(M_LAN, M_Para, oSysvar, Appconn, DsLookup, "Ma_Vt", "DmVt", "1=1", "1=1")
        TxtMa_Vt.V_LookUp(M_LAN, M_Para, oSysvar, Appconn, DsLookup, "Ma_Vt", "DmVt", "1=1", _fileter)
    End Sub
...
#End Region
    ...
    Private Sub TxtTen_KH_TextChanged(sender As Object, e As EventArgs) Handles TxtTen_KH.TextChanged
