...
#End Region
    Private Sub HDQ_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
#Region "Load And Set And Default"
    ...
    Private Sub V_LoadPTTheoHD(ByVal Status As String)
        ...
        Dim Dstmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_HDQHDMFromHDX", Status + "#" + _Loai + "#" + _Ma_HD + "#" + M_Ma_Dvcs + "#" + M_User_Name)
...
#Region "Valid - Tinh toan"
    ...
    Private Sub Tinh_Gia2(ByVal iRow As Integer)
        ...
        dsGia2 = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetHDKGia2", _Ngay_Ct.ToString("yyyyMMdd") & "#" & M_Ma_CT.Trim & "#" & M_Stt_Rec & "#" & M_Mode & "#" &
                                                   ...
                                                   _Gia2.ToString.Trim.Replace(" ", "").Replace(",", ".") & "#" & TxtMa_Dvcs.Text.Trim + "#" + M_User_Name.Trim + "#" + TxtGio_BD.Text.Trim)
...
#Region "Button"
    ...
    Private Function Add2Database() As Boolean
        ...
        '-----------------------------------------------------------------------------------------------------
        Dim _Ngay_Ct As Date = TxtNgay_Ct.Value
        Dim DsTmpSave As DataSet = CyberSmodb.V_ChkAndSaveVoucher(Mode, M_Stt_Rec, M_Ma_CT, _Ngay_Ct, TxtMa_Dvcs.Text, M_User_Name, {"PH89", "CT89", "CTGT40", "DmXe", "PH89Xe"}, {_DtPH89, Dt_DetailTmp, Dt_DetailCvTmp, _DtDmxeXe, _DtPh89Xe}, AppConn, osysvar, M_LAN, "CP_ChkAndSaveVoucherHDQ", CyberSmlib, CyberSupport)
    ...
    Private Sub V_Print(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Frm.Loai_In = "PRINT" Then
            ...
            End If
        End If
        DsPrint = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_PrintHDQ", M_Stt_Rec & "#" & Frm.Ma_In & "#" & Frm.Key_Sub1.ToString.Trim & "#" & Frm.Key_Sub2.ToString.Trim & "#" & Frm.Key_Sub3.ToString.Trim & "#" & M_User_Name)
