...
#Region "Load And Set And Default"
    ...
    Private Sub V_Getdefault()
        ...
        End Try
        Try
            _Para_Ma_TTCP_H = M_Para(M_VT_PARA + 4).Trim
        Catch ex As Exception
        End Try
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_System()
        ...
        AddHandler cmdPXE.Click, AddressOf V_Phieu_XuatPXE
        '---
...
#Region "Valid --- Ma_KH"
    ...
    Private Sub L_Ma_KH(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        ...
        If Not DrReturn Is Nothing Then
            ...
            TxtDia_Chi.Text = DrReturn.Item("Dia_Chi")
...
#Region "Lenh/SO/Po/Ro/Vt"
    ...
    Private Sub GetDetail()
        ...
        DsTmpDetal = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetPXKDetail", TxtLenh_Ro.Text.Trim + "#" + dt.ToString("yyyyMMdd") + "#" +
...
#Region "Add Or Detete Item"
    ...
    Private Sub V_AddItem(Optional ByVal iRow As Integer = -1)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim DrvOld As DataRowView
        Dim _Dr As DataRow = Dv_DetailTmp.Table.NewRow '===================================
        Dim vTbAdd As New DataView
        Dim TbHeader As New DataTable
        vTbAdd = Dv_DetailTmp
        TbHeader = M_DsHead.Tables(1)
        '=================================== 
        If iRow < -1 Then iRow = -1
        If iRow >= 0 Then DrvOld = vTbAdd.Item(iRow) Else DrvOld = Nothing
        vTbAdd.Table.Rows.InsertAt(_Dr, iRow + 1)
        CyberSmodb.SetValueBlankRow(vTbAdd.Table.Rows(iRow + 1))
        CyberSupport.SetCarryOn(DrvOld, vTbAdd.Table.Rows(iRow + 1), New DataView(TbHeader))
        CarrOn(vTbAdd.Table.Rows(iRow + 1))
        iRow = iRow + 1
        CyberFill.V_ForcusCell(DetailGRV, iRow, 0)
        UpdateList()
    End Sub
...
#Region "Xử lý Barcode"
    ...
    End Sub
#End Region
    Private Sub V_Phieu_XuatPXE(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ''If (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If txtSo_ct.Text.Trim.Replace("#", "").Trim = "" Then Exit Sub

        Dim strAddParar As String = "4#PXE#10###" + TxtLenh_Ro.Text.Trim.Replace("#", "") + "#" + M_Stt_Rec
