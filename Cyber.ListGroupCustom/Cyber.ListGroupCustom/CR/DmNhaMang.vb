...
#Region "Load"
    ...
    Protected Overrides Sub V_Addhander()
        MyBase.V_Addhander()
        RemoveHandler TxtMa_NhaMang.KeyPress, AddressOf TxtCodeError_KeyPress
        AddHandler TxtMa_NhaMang.KeyPress, AddressOf TxtCodeError_KeyPress
...
#Region "Buuton"
    Protected Overrides Sub V_Save(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If Not _Value.Trim = "" Then TxtMa_NhaMang.Text = _Value
