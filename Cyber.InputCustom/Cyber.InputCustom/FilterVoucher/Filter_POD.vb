...
Public Class Filter_POD
    ...
    Private Sub L_Lenh_Ro(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        TxtSo_Ro.Text = CyberVoucher.V_FormatSo_Ro(AppConn, osysvar, Me.Ma_CT, "S", "S", _Ngay_CT, TxtSo_Ro.Text, "", M_Ma_Dvcs, M_User_Name, CyberSmlib)
    End Sub
...
#Region "Vali --- Nh_Vt3"
    ...
    Private Sub L_Nh_Vt3(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        ...
        If Not DrReturn Is Nothing Then
            TxtNh_Vt3.Text = DrReturn.Item("TK0")
        Else
            TxtNh_Vt3.Text = ""
        End If
    End Sub
