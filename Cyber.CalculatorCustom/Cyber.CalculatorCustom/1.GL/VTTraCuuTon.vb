...
Public Class VTTraCuuTon
    ...
    Dim _Dt_Ma_Post1 As DataTable
    Dim _Dt_Ma_Post2 As DataTable
    ...
    Private Sub VTTraCuuTon_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_ROBC_Load_Ngam_Dinh", CbbMa_Dvcs.SelectedValue + "#" + M_User_Name)
    ...
    End Sub
    Private Sub V_Load()
        For i As Integer = 0 To MasterGRV.Columns.Count - 1
            MasterGRV.Columns(i).OptionsFilter.AllowAutoFilter = True
            MasterGRV.Columns(i).OptionsFilter.AllowFilter = True
            MasterGRV.Columns(i).OptionsFilter.AutoFilterCondition = DevExpress.XtraGrid.Columns.AutoFilterCondition.Contains
        Next
