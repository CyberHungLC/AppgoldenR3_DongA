...
#Region "Tinh toan"
    ...
    Private Sub TotalItem(ByVal _Rec_Ro As String)
        ...
        For Each drCv As DataRow In dtDetailCvRo.Select("Tag='1' AND Rec_Ro ='" + _Rec_Ro.ToString.Trim + "'")
            ...
            T_ConLai = T_ConLai + drCv("Tien_ConLai")
        Next
        For Each drVt As DataRow In dtDetailVtRo.Select("Tag='1' AND Rec_Ro ='" + _Rec_Ro.ToString.Trim + "'")
            ...
            T_ConLai = T_ConLai + drVt("Tien_ConLai")
        Next
        ...
        TxtTien_ConLai.Double = T_ConLai
    End Sub
    Private Sub V_LoadTotal()
        Dim T_CV_NTn, T_Thue_CV_NTn, T_Tien_Nt2n, T_Thue_NTn, T_TT_NTn, T_ConLai_N As Decimal
        T_CV_NTn = 0
        T_Thue_CV_NTn = 0
        T_Tien_Nt2n = 0
        T_Thue_NTn = 0
        ...
        For Each dr As DataRow In dtMasterRo.Select("Tag ='1'")
            For Each drcv As DataRow In dtDetailCvRo.Select("Tag= '1' And Rec_Ro='" & dr("Rec_RO").ToString.Trim & "'")
                ...
                T_ConLai_N = T_ConLai_N + drcv("Tien_ConLai")
            Next
            For Each drVt As DataRow In dtDetailVtRo.Select("Tag='1' And Rec_Ro='" & dr("Rec_Ro").ToString.Trim & "'")
                ...
                T_ConLai_N = T_ConLai_N + drVt("Tien_ConLai")
            Next
        Next

        T_TT_NTn = T_CV_NTn + T_Tien_Nt2n + T_Thue_CV_NTn + T_Thue_NTn
        TxtT_CV_N.Double = T_CV_NTn
        TxtT_Thue_CV_N.Double = T_Thue_CV_NTn
        TxtT_Tien2_N.Double = T_Tien_Nt2n
        TxtT_Thue_N.Double = T_Thue_NTn
        TxtT_TT_N.Double = T_TT_NTn
        TxtT_Tien_ConLai.Double = T_ConLai_N
    End Sub
#End Region
    ...
    Private Sub V_LocRo(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If CbbMa_TT.SelectedValue = "W" And txtSo_BC_BH.Text = "" Then
            MsgBox("Bạn phải nhập số xác nhận bảo hành")
            Exit Sub
        End If
        V_LoadDatabase("2")
