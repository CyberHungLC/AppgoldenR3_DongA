...
#End Region
    Private Sub HDR_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
#Region "Load And Set And Default"
    ...
    Private Sub V_LoadPTTheoHD(ByVal Status As String)
        ...
        Dim Dstmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_HDRHDMFromHDX", Status + "#" + _Loai + "#" + _Ma_HD + "#" + M_Ma_Dvcs + "#" + M_User_Name)
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Master()
        ...
        '--LhBaoHanh
        AddHandler txtMa_LHBaoHanh.CyberValiting, AddressOf V_Ma_LhBaoHanh
        AddHandler txtMa_LHBaoHanh.CyberLeave, AddressOf L_Ma_LhBaoHanh
...
#Region "Valid --- Ma_Xe/So_khung"
    ...
    Private Sub V_Ma_Xe(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        '----------------------------------------------------------------------------------------------
    End Sub
    Private Sub Fill_TT_Xe()
        If Not (M_Mode.Trim = "M" Or M_Mode.Trim = "S") Then Exit Sub

        Dim _ma_Gd As String = CbbMa_GD.SelectedValue.ToString.Trim

        Dim _ma_Post As String = CbbMa_Post.SelectedValue.ToString.Trim
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_FillTTXe", TxtMa_Xe.Text.Trim & "#" & _
                                                                  _ma_Gd & "#" & M_Mode.Trim & "#" & _ma_Post & "#" & M_Stt_Rec & "#" & M_Ma_Dvcs & "#" & M_User_Name)
        ...
        If DsTmp.Tables(0).Columns.Contains("Ma_KH") And TxtMa_Kh.Text.Trim = "" Then TxtMa_Kh.Text = DsTmp.Tables(0).Rows(0).Item("Ma_KH").ToString.Trim
        ...
        If DsTmp.Tables(0).Columns.Contains("Ma_Nthat") And TxtMa_nthat.Text.Trim = "" Then TxtMa_nthat.Text = DsTmp.Tables(0).Rows(0).Item("Ma_Nthat").ToString.Trim
        If DsTmp.Tables(0).Columns.Contains("Ten_Kh") And TxtTen_kh.Text.Trim = "" Then TxtTen_kh.Text = DsTmp.Tables(0).Rows(0).Item("Ten_Kh").ToString.Trim
        ...
        If DsTmp.Tables(0).Columns.Contains("Ten_Lx") And txtTen_Lx.Text.Trim = "" Then txtTen_Lx.Text = DsTmp.Tables(0).Rows(0).Item("Ten_Lx").ToString.Trim
        If DsTmp.Tables(0).Columns.Contains("Dien_Thoai") And TxtDien_Thoai.Text.Trim = "" Then TxtDien_Thoai.Text = DsTmp.Tables(0).Rows(0).Item("Dien_Thoai").ToString.Trim
        ...
        If DsTmp.Tables(0).Columns.Contains("Dt_LX") And TxtDt_LX.Text.Trim = "" Then TxtDt_LX.Text = DsTmp.Tables(0).Rows(0).Item("Dt_LX").ToString.Trim
        If DsTmp.Tables(0).Columns.Contains("Fax") And TxtFax.Text.Trim = "" Then TxtFax.Text = DsTmp.Tables(0).Rows(0).Item("Fax").ToString.Trim

        If DsTmp.Tables(0).Columns.Contains("Ma_hd_H") And TxtMa_HD_H.Text.Trim = "" Then TxtMa_HD_H.Text = DsTmp.Tables(0).Rows(0).Item("Ma_hd_H").ToString.Trim

        If DsTmp.Tables(0).Columns.Contains("Ma_Td3_H") And TxtMa_td3_H.Text.Trim = "" Then TxtMa_td3_H.Text = DsTmp.Tables(0).Rows(0).Item("Ma_Td3_H").ToString.Trim

        If DsTmp.Tables(0).Columns.Contains("Xuat_Xu") And TxtXuat_Xu.Text.Trim = "" Then TxtXuat_Xu.Text = DsTmp.Tables(0).Rows(0).Item("Xuat_Xu").ToString.Trim

        If DsTmp.Tables(0).Columns.Contains("Dai_Ly") And TxtDai_Ly.Text.Trim = "" Then TxtDai_Ly.Text = DsTmp.Tables(0).Rows(0).Item("Dai_Ly").ToString.Trim

        If DsTmp.Tables(0).Columns.Contains("Nam_Sx") Then CmbNam_Sx.SelectedValue = DsTmp.Tables(0).Rows(0).Item("Nam_Sx").ToString.Trim



        If DsTmp.Tables(0).Columns.Contains("Ma_TP") Then CmbMa_TP.SelectedValue = DsTmp.Tables(0).Rows(0).Item("Ma_TP").ToString.Trim
        If DsTmp.Tables(0).Columns.Contains("Ma_Quan") Then CmbMa_Quan.SelectedValue = DsTmp.Tables(0).Rows(0).Item("Ma_Quan").ToString.Trim
        If DsTmp.Tables(0).Columns.Contains("Ma_Xa") Then CmbMa_Xa.SelectedValue = DsTmp.Tables(0).Rows(0).Item("Ma_Xa").ToString.Trim

        If DsTmp.Tables(0).Columns.Contains("Vai_Tro") Then CmbVai_Tro.SelectedValue = DsTmp.Tables(0).Rows(0).Item("Vai_Tro").ToString.Trim
        If DsTmp.Tables(0).Columns.Contains("Ma_HTLL") Then CmbMa_HTLL.SelectedValue = DsTmp.Tables(0).Rows(0).Item("Ma_HTLL").ToString.Trim
    ...
    End Function
#End Region
#Region "Valid --- Ma_LhBaoHanh"
    Private Sub V_Ma_LhBaoHanh(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        sender.V_LookUp(M_LAN, M_Para, osysvar, AppConn, DsLookup, "Ma_LhBaoHanh", "DmLHBaoHanh", "1=1", "1=1")
    End Sub
    Private Sub L_Ma_LhBaoHanh(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        DrReturn = sender.GetRowsSelectData(True)
        If Not DrReturn Is Nothing Then
            txtMa_LHBaoHanh.Text = DrReturn.Item("Ma_LhBaoHanh")
            txtTen_LHBaoHanh.Text = DrReturn.Item("Ten_LhBaoHanh")
        Else
            txtMa_LHBaoHanh.Text = ""
            txtTen_LHBaoHanh.Text = ""
        End If
    End Sub
#End Region
#Region "Khach hang"
    ...
    Private Sub L_Ma_KH(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        ...
        If Not DrReturn Is Nothing Then
            ...
            txtTen_Lx.Text = IIf(txtTen_Lx.Text.Trim = "", DrReturn.Item("Ong_ba").ToString.Trim, txtTen_Lx.Text)
...
#End Region
    Private Sub V_PT_CK(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        CyberSupport.V_Lookup("Ma_kh", "DMPTCK", "1=1 AND Ma_LoaiCK='02' ", "Acti=1 AND Ma_kh='" + TxtMa_Kh.Text + "'", M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_PT_CK(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        ...
        If Dv_DetailTmp.Item(iRow).Item("PT_CK_i1").ToString = "" Then
            Exit Sub
        End If
        If Dv_DetailTmp.Item(iRow).Item("PT_CK_i1") = 0 Then
            Exit Sub
        End If
        DrReturn = CyberSupport.L_Lookup(M_Mode, M_Ma_CT, sender, True)
        If DrReturn Is Nothing Then
            Dv_DetailTmp.Item(iRow).BeginEdit()
            Dv_DetailTmp.Item(iRow).Item("PT_CK_i1") = 0
        ...
        '-----------------------------------------------------------------------------------------------------------
        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dv_DetailTmp.Item(iRow).Item("PT_CK_i1") = _PT_CK
        Dv_DetailTmp.Item(iRow).EndEdit()
        Tinh_TienPT(iRow)
    End Sub
    ...
    Private Sub L_PT_CKCV(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        ...
        If iRow < 0 Then Exit Sub
        If Dv_DetailCvTmp.Item(iRow).Item("PT_CK_i1").ToString = "" Then
            Exit Sub
        End If
        If Dv_DetailCvTmp.Item(iRow).Item("PT_CK_i1") = 0 Then
            Exit Sub
        End If
        DrReturn = CyberSupport.L_Lookup(M_Mode, M_Ma_CT, sender, True)
        If DrReturn Is Nothing Then
            Dv_DetailCvTmp.Item(iRow).BeginEdit()
            Dv_DetailCvTmp.Item(iRow).Item("PT_CK_i1") = 0
        ...
        '-----------------------------------------------------------------------------------------------------------
        Dv_DetailCvTmp.Item(iRow).BeginEdit()
        Dv_DetailCvTmp.Item(iRow).Item("PT_CK_i1") = _PT_CK
        Dv_DetailCvTmp.Item(iRow).EndEdit()
        Tinh_TienCV(iRow)
    End Sub
#Region "=====GDV Va MG"
...
#Region "Valid - Tinh toan"
    ...
    Private Sub Tinh_Gia2(ByVal iRow As Integer)
        ...
        dsGia2 = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetHDKGia2", _Ngay_Ct.ToString("yyyyMMdd") & "#" & M_Ma_CT.Trim & "#" & M_Stt_Rec & "#" & M_Mode & "#" &
                                                   ...
                                                   _Gia2.ToString.Trim.Replace(" ", "").Replace(",", ".") & "#" & TxtMa_Dvcs.Text.Trim + "#" + M_User_Name.Trim + "#" + TxtGio_BD.Text.Trim + "#" + TxtMa_LHKH.Text.Trim)
    ...
    Private Sub Tinh_TienPT(ByVal iRow As Integer)
        ...
        If Not ChkVT.Checked Then
            ...
            If CyberSupport.ChkFieldKey(Dv_DetailTmp.Item(iRow).Item("Ma_TT"), "I,C") Then
                If Dv_DetailTmp.Item(iRow).Item("PT_Ck_I1").ToString <> "" Then
                    Dv_DetailTmp.Item(iRow).Item("CK_I1") = IIf(Dv_DetailTmp.Item(iRow).Item("PT_Ck_I1") = 0, Dv_DetailTmp.Item(iRow).Item("CK_I1"), CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("Tien2") * Dv_DetailTmp.Item(iRow).Item("PT_Ck_I1") / 100, 0))

                End If
                Dv_DetailTmp.Item(iRow).Item("CK_I2") = IIf(Dv_DetailTmp.Item(iRow).Item("PT_Ck_I2") = 0, Dv_DetailTmp.Item(iRow).Item("CK_I2"), CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("Tien2") * Dv_DetailTmp.Item(iRow).Item("PT_Ck_I2") / 100, 0))
                Dv_DetailTmp.Item(iRow).Item("CK_I") = Dv_DetailTmp.Item(iRow).Item("CK_I1") + Dv_DetailTmp.Item(iRow).Item("CK_I2")
                If Dv_DetailTmp.Item(iRow).Item("PT_Ck_I1").ToString = "" Then
                    Dv_DetailTmp.Item(iRow).Item("PT_Ck_I") = Dv_DetailTmp.Item(iRow).Item("PT_Ck_I2")
                Else
                    Dv_DetailTmp.Item(iRow).Item("PT_Ck_I") = Dv_DetailTmp.Item(iRow).Item("PT_Ck_I1") + Dv_DetailTmp.Item(iRow).Item("PT_Ck_I2")
                End If

                Dv_DetailTmp.Item(iRow).Item("CK_I") = Dv_DetailTmp.Item(iRow).Item("CK_I1") + Dv_DetailTmp.Item(iRow).Item("CK_I2") - -CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("Tien2") * Dv_DetailTmp.Item(iRow).Item("PT_Ck_I") / 100, 0)
            ...
            Else
                ...
                Dv_DetailTmp.Item(iRow).Item("CK_I") = 0
                Dv_DetailTmp.Item(iRow).Item("PT_Ck_I1") = 0
                Dv_DetailTmp.Item(iRow).Item("CK_I1") = 0
                Dv_DetailTmp.Item(iRow).Item("PT_Ck_I2") = 0
                Dv_DetailTmp.Item(iRow).Item("CK_I2") = 0
            ...
            '    End If
            '    If _Ma_Post > 1 Then
            '        Dv_DetailTmp.Item(iRow).Item("CK_I") = CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("Tien2") * Dv_DetailTmp.Item(iRow).Item("PT_Ck_I") / 100, 0)
            '    End If
...
#Region "Ma_Vt"
    ...
    Private Sub L_Ma_Vt(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If DrReturn Is Nothing Then
            ...
            Exit Sub
        End If
        Dim _Ma_kho_i As String = "", _Ma_VT As String = "", _DVT As String = "", _Ten_VT As String = "", _Ten_VT3 As String = "", _Thue_Suat As Decimal = 0
    ...
    Private Sub Tinh_TienCV(ByVal iRow As Integer)
        ...
        If Not ChkCV.Checked Then
            ...
            If CyberSupport.ChkFieldKey(Dv_DetailCvTmp.Item(iRow).Item("Ma_TT"), "I,C") Then
                If Dv_DetailCvTmp.Item(iRow).Item("PT_Ck_I1").ToString <> "" Then
                    Dv_DetailCvTmp.Item(iRow).Item("CK_I1") = IIf(Dv_DetailCvTmp.Item(iRow).Item("PT_Ck_I1") = 0, Dv_DetailCvTmp.Item(iRow).Item("CK_I1"), CyberSupport.V_Round(Dv_DetailCvTmp.Item(iRow).Item("Tien_Cv") * Dv_DetailCvTmp.Item(iRow).Item("PT_Ck_I1") / 100, 0))
                End If
                Dv_DetailCvTmp.Item(iRow).Item("CK_I2") = IIf(Dv_DetailCvTmp.Item(iRow).Item("PT_Ck_I2") = 0, Dv_DetailCvTmp.Item(iRow).Item("CK_I2"), CyberSupport.V_Round(Dv_DetailCvTmp.Item(iRow).Item("Tien_Cv") * Dv_DetailCvTmp.Item(iRow).Item("PT_Ck_I2") / 100, 0))
                Dv_DetailCvTmp.Item(iRow).Item("CK_I") = Dv_DetailCvTmp.Item(iRow).Item("CK_I1") + Dv_DetailCvTmp.Item(iRow).Item("CK_I2")

                If Dv_DetailCvTmp.Item(iRow).Item("PT_Ck_I1").ToString = "" Then
                    Dv_DetailCvTmp.Item(iRow).Item("PT_Ck_I") = Dv_DetailCvTmp.Item(iRow).Item("PT_Ck_I2")
                Else
                    Dv_DetailCvTmp.Item(iRow).Item("PT_Ck_I") = Dv_DetailCvTmp.Item(iRow).Item("PT_Ck_I1") + Dv_DetailCvTmp.Item(iRow).Item("PT_Ck_I2")
                End If
                Dv_DetailCvTmp.Item(iRow).Item("CK_I") = Dv_DetailCvTmp.Item(iRow).Item("CK_I1") + Dv_DetailCvTmp.Item(iRow).Item("CK_I2") - -CyberSupport.V_Round(Dv_DetailCvTmp.Item(iRow).Item("Tien_Cv") * Dv_DetailCvTmp.Item(iRow).Item("PT_Ck_I") / 100, 0)
            ...
            Else
                ...
                Dv_DetailCvTmp.Item(iRow).Item("CK_I") = 0
                Dv_DetailCvTmp.Item(iRow).Item("PT_Ck_I1") = 0
                Dv_DetailCvTmp.Item(iRow).Item("CK_I1") = 0
                Dv_DetailCvTmp.Item(iRow).Item("PT_Ck_I2") = 0
                Dv_DetailCvTmp.Item(iRow).Item("CK_I2") = 0
            ...
            '    End If
            '    If _Ma_Post > 1 Then
            '        Dv_DetailCvTmp.Item(iRow).Item("Ck_I") = CyberSupport.V_Round(Dv_DetailCvTmp.Item(iRow).Item("Tien_Cv") * Dv_DetailCvTmp.Item(iRow).Item("PT_Ck_I") / 100, 0)
...
#Region "Button"
    ...
    Private Function Add2Database() As Boolean
        ...
        '-----------------------------------------------------------------------------------------------------
        Dim _Ngay_Ct As Date = TxtNgay_Ct.Value
        Dim DsTmpSave As DataSet = CyberSmodb.V_ChkAndSaveVoucher(Mode, M_Stt_Rec, M_Ma_CT, _Ngay_Ct, TxtMa_Dvcs.Text, M_User_Name, {"PH89", "CT89", "CTGT40", "DmXe", "PH89Xe"}, {_DtPH89, Dt_DetailTmp, Dt_DetailCvTmp, _DtDmxeXe, _DtPh89Xe}, AppConn, osysvar, M_LAN, "CP_ChkAndSaveVoucherHDR", CyberSmlib, CyberSupport)
    ...
    Private Sub V_Print(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        DsTmp = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_SysGetPrintVoucher", M_Ma_CT + "#" + M_Ma_Dvcs + "#" + M_User_Name)
        DtMaIn = DsTmp.Tables(0).Copy
        Dim ClsParameterPrint As New Voucher.ParamenterPrintVoucher
        ClsParameterPrint._Lan = M_LAN
        ClsParameterPrint._Stt_Rec = M_Stt_Rec
        ClsParameterPrint.osysvar = osysvar
        ClsParameterPrint._ma_Ct = M_Ma_CT
        ClsParameterPrint._Para = M_Para
        ClsParameterPrint.DtMaIn = DtMaIn
        ClsParameterPrint._App = AppConn
        ClsParameterPrint._DrDmct = DrDmct
        ClsParameterPrint._DtPrint = Nothing
        ClsParameterPrint._Ma_Dvcs = M_Ma_Dvcs
        ClsParameterPrint._User_name = M_User_Name
        Dim Frm As New FrmPrintVoucherHDR
        ClsParameterPrint.V_LoadParameter(Frm)
        Frm.ShowDialog()
        If Frm.ReturnOk = False Then Return
        'If Frm.CbbMa_BH.SelectedValue = "" Then Return
        ClsParameterPrint.V_SetParameter(Frm)
        '===========================
        ...
        If Frm.Loai_In = "PRINT" Then
            ...
            End If
        End If
        DsPrint = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_PrintHDR", M_Stt_Rec & "#" & Frm.Ma_In & "#" & Frm.Key_Sub1.ToString.Trim & "#" & Frm.Key_Sub2.ToString.Trim & "#" & Frm.Key_Sub3.ToString.Trim & "#" & M_User_Name)
        _Return = CyberSupport.V_MsgChk(DsPrint.Tables(0), osysvar, M_LAN)
        If Not _Return Then MsgBox("Bạn phải chọn đơn vị bảo hiểm")
        If Not _Return Then Exit Sub

        Print = New DataSet
        ReportName = DsPrint.Tables(0).Rows(0)("Repo_Name")
        For i = 1 To DsPrint.Tables.Count - 1
            Print.Tables.Add(DsPrint.Tables(i).Copy)
        Next
        Dim CyberPrint As New Cyber.Print.Sys
        CyberPrint.CyberPrintReportcustomer(Nothing, printsetting, AppConn, Frm.Loai_In, ReportName, Print, ClsParameterPrint._Title1, ClsParameterPrint._Title2, SysVar, M_Para, M_Ma_Dvcs)
        DsPrint.Dispose()
        Print.Dispose()
        DsPrint = Nothing
        Print = Nothing
