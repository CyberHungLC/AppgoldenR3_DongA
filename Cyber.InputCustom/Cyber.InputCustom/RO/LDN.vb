...
#Region "Columns Edit"
    ...
    Dim EditTien_NT, EditTien, EditTien_I, EditTien_I0, EditThue_NT, EditThue, EditT_TT_NT, EditT_TT, EditThue_Suat, EditMa_Thue, EditDien_Giaii, EditSo_So, EditSo_Po, EditSo_Ro, EditSo_VT As New Cyber.Fill.CyberColumnGridView 'DevExpress.XtraEditors.Repository.RepositoryItemTextEdit
    ...
    Dim EditTen_HD_I, EditNgay_Ro, EditSL_TD_I, EditMoi_Gioi, EditNgay_HD, EditNgay_PT, EditTien_HD, EditTien_HDVAT, EditTien_PT As New Cyber.Fill.CyberColumnGridView
#End Region
...
#Region "Load And Set And Default"
    ...
    Private Sub V_Getdefault()
        ...
        Dim DmLoaiThu As DataTable = CyberSmodb.OpenTableKey(AppConn, Nothing, "DmLoaiThu", "Loai_Thu", "Loai_Thu IN('00','01')", CyberSmlib)

        CyberFill.V_FillComBoxDefaul(Me.CmbMa_HTTT, DmLoaiThu, "Loai_Thu", If(M_LAN = "V", "Ten_Loai", "Ten_Loai2"), "Ngam_Dinh")
    ...
    Private Sub V_GetColumn()
        ...
        EditNgay_Ro.GetColumn(DetailGRV, "Ngay_Ro")
        ...
        EditTien_HDVAT.GetColumn(DetailGRV, "Tien_HDVAT")
        EditTien_PT.GetColumn(DetailGRV, "Tien_PT")

        EditTien_I.GetColumn(DetailGRV, "Tien_I")
        EditTien_I0.GetColumn(DetailGRV, "Tien_I0")
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_System()
        ...
        AddHandler CmbMa_HTTT.SelectedValueChanged, AddressOf VisibleMa_HTTT
    End Sub
    ...
    Private Sub V_AddHandler_Detail()
        'If Not EditSo_Ro.Column Is Nothing Then AddHandler EditSo_Ro.EditColumn.Leave, AddressOf L_Tinh_ToanHHGDV
        'If Not EditSL_TD_I.Column Is Nothing Then AddHandler EditSL_TD_I.EditColumn.Leave, AddressOf L_Tinh_ToanHHGDV
    ...
    End Sub
    Private Sub VisibleMa_HTTT()
        Select Case CmbMa_HTTT.SelectedValue.ToString
            Case "01"
                LabTk_Nh.Visible = True
                TxtTk_Nh.Visible = True
                LabTen_Nh.Visible = True
                TxtTen_Nh.Visible = True
                LabChu_Tk.Visible = True
                TxtChu_Tk.Visible = True
            Case Else
                LabTk_Nh.Visible = False
                TxtTk_Nh.Visible = False
                LabTen_Nh.Visible = False
                TxtTen_Nh.Visible = False
                LabChu_Tk.Visible = False
                TxtChu_Tk.Visible = False
        End Select
    End Sub
    Private Sub VisibleColumnMa_GD()
        ...
        EditMa_TD3_I.Visible = (_Ma_GD = "4")
        EditMa_TD3_I.EditColumn.ReadOnly = (_Ma_GD = "4")
        '------------------------------------------------------------------------------
        ...
        CmdChon_Lenh.Visible = (_Ma_GD = "1" Or _Ma_GD = "2" Or _Ma_GD = "3" Or _Ma_GD = "5")
        '------------------------------------------------------------------------------
        EditSo_Ro.Visible = (_Ma_GD = "1" Or _Ma_GD = "2" Or _Ma_GD = "3" Or _Ma_GD = "6" Or _Ma_GD = "8" Or _Ma_GD = "9" Or _Ma_GD = "5")
        ...
        EditTien_HD.Visible = (_Ma_GD = "1" Or _Ma_GD = "2" Or _Ma_GD = "3" Or _Ma_GD = "4" Or _Ma_GD = "5")
        EditTien_HDVAT.Visible = (_Ma_GD = "1" Or _Ma_GD = "2" Or _Ma_GD = "3" Or _Ma_GD = "4" Or _Ma_GD = "5")
        EditNgay_PT.Visible = (_Ma_GD = "1" Or _Ma_GD = "2" Or _Ma_GD = "3" Or _Ma_GD = "4" Or _Ma_GD = "5")
        EditTien_PT.Visible = (_Ma_GD = "1" Or _Ma_GD = "2" Or _Ma_GD = "3" Or _Ma_GD = "4" Or _Ma_GD = "5")
        EditMoi_Gioi.Visible = (_Ma_GD = "1" Or _Ma_GD = "2" Or _Ma_GD = "3" Or _Ma_GD = "4" Or _Ma_GD = "5")

        EditNgay_HD.EditColumn.ReadOnly = (_Ma_GD = "1" Or _Ma_GD = "2" Or _Ma_GD = "3" Or _Ma_GD = "4")
        EditTien_HD.EditColumn.ReadOnly = (_Ma_GD = "1" Or _Ma_GD = "2" Or _Ma_GD = "3" Or _Ma_GD = "4" Or _Ma_GD = "5")
        EditTien_HDVAT.EditColumn.ReadOnly = (_Ma_GD = "1" Or _Ma_GD = "2" Or _Ma_GD = "3" Or _Ma_GD = "4" Or _Ma_GD = "5")
        EditNgay_PT.EditColumn.ReadOnly = (_Ma_GD = "1" Or _Ma_GD = "2" Or _Ma_GD = "3" Or _Ma_GD = "4" Or _Ma_GD = "5")
        EditTien_PT.EditColumn.ReadOnly = (_Ma_GD = "1" Or _Ma_GD = "2" Or _Ma_GD = "3" Or _Ma_GD = "4" Or _Ma_GD = "5")
        EditMoi_Gioi.EditColumn.ReadOnly = (_Ma_GD = "1" Or _Ma_GD = "2" Or _Ma_GD = "3" Or _Ma_GD = "4" Or _Ma_GD = "5")
        EditTien_I.Visible = (_Ma_GD = "1" Or _Ma_GD = "2" Or _Ma_GD = "3" Or _Ma_GD = "4" Or _Ma_GD = "5")
        EditTien_I0.Visible = (_Ma_GD = "1" Or _Ma_GD = "2" Or _Ma_GD = "3" Or _Ma_GD = "4" Or _Ma_GD = "5")
        EditMa_Xe_I.Visible = (_Ma_GD = "5")
        EditSL_TD_I.Visible = (_Ma_GD = "5")
        EditNgay_Ro.Visible = (_Ma_GD = "5")
        'End If
        CyberFill.SetFoCusGRV(DetailGRV, M_Mode)
    End Sub
...
#End Region
    ...
    Private Sub L_Tinh_ToanHHGDV(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim _Ma_GD As String = CbbMa_GD.SelectedValue.ToString.Trim
        If _Ma_GD <> "5" Then Exit Sub
        ...
        V_Tinh_ToanHHGDV(iRow)
        V_Tinh_Toan(iRow)
    End Sub
    Private Sub V_Tinh_ToanHHGDV(ByVal iRow As Decimal)
        Dim DsTienPTHH As DataSet
        Dim _So_RO As String = Dv_DetailTmp.Item(iRow).Item("So_RO")
        Dim _Ty_Le As String = Dv_DetailTmp.Item(iRow).Item("SL_TD_I")
        Dim _Ma_GD As String = CbbMa_GD.SelectedValue.ToString.Trim
        Dim Dt As Date = TxtNgay_Ct.Value
        DsTienPTHH = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GETHHGDVTOLDN", Stt_Rec.Trim + "#" + _So_RO.ToString.Trim + "#" +
        _Ty_Le.ToString.Trim + "#" + _Ma_GD.ToString.Trim + "#" + Dt.ToString("yyyyMMdd") + "#" + M_Mode + "#" + M_Ma_Dvcs + "#" + M_User_Name)
        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dv_DetailTmp.Item(iRow).Item("Ma_Xe_I") = DsTienPTHH.Tables(0).Rows(0).Item("Ma_Xe")
        If Dv_DetailTmp.Item(iRow).Item("SL_TD_I") = 0 Then Dv_DetailTmp.Item(iRow).Item("SL_TD_I") = DsTienPTHH.Tables(0).Rows(0).Item("Ty_Le")
        Dv_DetailTmp.Item(iRow).Item("Tien_I") = DsTienPTHH.Tables(0).Rows(0).Item("Tien_I")
        Dv_DetailTmp.Item(iRow).Item("Tien_I0") = DsTienPTHH.Tables(0).Rows(0).Item("Tien_I0")
        If Dv_DetailTmp.Item(iRow).Item("Tien_NT") = 0 Then Dv_DetailTmp.Item(iRow).Item("Tien_NT") = DsTienPTHH.Tables(0).Rows(0).Item("HH_GDV")
        Dv_DetailTmp.Item(iRow).Item("Ngay_RO") = DsTienPTHH.Tables(0).Rows(0).Item("Ngay_RO")
    ...
    Private Sub L_Ma_Bh(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        ...
        If Not DrReturn Is Nothing Then
            ...
            If TxtMa_Kh.Text = "" Then
                TxtTen_kh.Text = ""
            Else
                TxtTen_kh.Text = CyberSmodb.SQLGetvalue(AppConn, "Ten_Kh", "DmKh", "Ma_Kh = '" & TxtMa_Kh.Text.Trim & "'", CyberSmlib)
                TxtDia_Chi.Text = CyberSmodb.SQLGetvalue(AppConn, "Dia_Chi", "DmKh", "Ma_Kh = '" & TxtMa_Kh.Text.Trim & "'", CyberSmlib)
                txtOng_ba.Text = IIf(txtOng_ba.Text.Trim = "", CyberSmodb.SQLGetvalue(AppConn, "Ong_Ba", "DmKh", "Ma_Kh = '" & TxtMa_Kh.Text.Trim & "'", CyberSmlib), txtOng_ba.Text)
            End If
        Else
            TxtMa_BH.Text = ""
            TxtTen_BH.Text = ""
...
#Region "Valid - Detail - Core"
    ...
    Private Sub V_Tinh_Toan(ByVal iRow As Integer)
        ...
        'If _Ma_GD = "5" Then
        '    Dv_DetailTmp.Item(iRow).BeginEdit()
        '    Dv_DetailTmp.Item(iRow).Item("Tien_NT") = CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("Tien_I0") * Dv_DetailTmp.Item(iRow).Item("SL_TD_I") / 100, M_R_TIEN)
        '    Dv_DetailTmp.Item(iRow).EndEdit()
        'End If
        ...
        Dv_DetailTmp.Item(iRow).BeginEdit()
        If nTy_Gia <> 1 Then
            Dv_DetailTmp.Item(iRow).Item("T_TT") = CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("T_TT_NT") * nTy_Gia, M_R_TIEN)
        ...
        Else
            ...
            Dv_DetailTmp.Item(iRow).Item("T_TT") = Dv_DetailTmp.Item(iRow).Item("T_TT_NT")
        End If
    ...
    Private Function ChkVsave() As Boolean
        ...
        For iRow = nCount - 1 To 0 Step -1
            If _Ma_GD = "1" Or _Ma_GD = "2" Or _Ma_GD = "3" Then
                If Dt_DetailTmp.Rows(iRow).Item("Stt_Rec_HD").ToString.Trim = "" Or Dt_DetailTmp.Rows(iRow).Item("So_Ro").ToString.Trim = "" Or Dt_DetailTmp.Rows(iRow).Item("Tien_NT") = 0 Then
                    Dt_DetailTmp.Rows(iRow).Delete()
                    Dt_DetailTmp.AcceptChanges()
                End If
            End If

            If _Ma_GD = "6" Or _Ma_GD = "8" Then
                If Dt_DetailTmp.Rows(iRow).Item("So_Ro").Trim.ToString = "" Or Dt_DetailTmp.Rows(iRow).Item("Dien_Giaii").ToString.Trim = "" Or Dt_DetailTmp.Rows(iRow).Item("Tien_NT") = 0 Then
                    Dt_DetailTmp.Rows(iRow).Delete()
                    Dt_DetailTmp.AcceptChanges()
                End If
            End If
            ...
            If _Ma_GD = "9" Then
                If Dt_DetailTmp.Rows(iRow).Item("Tien_NT") = 0 Or Dt_DetailTmp.Rows(iRow).Item("So_Ro").Trim.ToString = "" Then
                    Dt_DetailTmp.Rows(iRow).Delete()
                    Dt_DetailTmp.AcceptChanges()
                End If
            End If
...
#Region "Tính bảo hiểm/Tính Hợp đồng"
    Private Sub V_Chon_Lenh(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (M_Mode = "M") Then Exit Sub
        Dim _Ma_Gd As String = CbbMa_GD.SelectedValue.ToString.Trim
        If Not (_Ma_Gd.Trim = "1" Or _Ma_Gd.Trim = "2" Or _Ma_Gd.Trim = "3" Or _Ma_Gd.Trim = "5") Then Return
        Dim _TL_MG As Double = 0
    ...
    Private Sub V_GetDetailFromHDS(ByVal iRow As Decimal)
        ...
        Dim _strV As String = ""
        Dim _Ngay_Ct As Date = TxtNgay_Ct.Value
        Dim _Tl_MG As String = ""

        If _So_Ro.Trim = "" Then Return

        CyberSmodb.GetValueData(Dv_DetailTmp.Item(iRow), _strF, _strV, "Ten_Kx,Ten_mau")
        Dim Dstmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetHDSToLDN", M_Mode.Trim + "#" + TxtSo_Ct.Text.Trim + "#" + _Ngay_Ct.ToString("yyyyMMdd") + "#" + _Ma_GD + "#" + M_Ma_CT + "#" +
                                                                   M_Stt_Rec + "#" + _So_Ro + "#" + _Ma_HD + "#" + _Tl_MG + "#" + _strF + "#" + _strV + "#" + M_Ma_Dvcs + "#" + M_User_Name)
