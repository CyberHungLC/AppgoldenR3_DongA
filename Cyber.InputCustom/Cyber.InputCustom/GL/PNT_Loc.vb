...
Public Class PNT_Loc
    ...
    Private Sub PNT_Loc_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Save_OK = False
        Me.Text = "Lọc đề xuất mua CCDC"
        V_Load()
        V_GetColumn()
        TxtMa_Kh.Focus()
        '------------------------------------------------------------------------------------
    ...
    Sub V_Loaddatatabase(ByVal _Type As String)
        ...
        Dim _DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetDetailPNIFromDXM", "0#" & _Dt1.ToString("yyyyMMdd") & "#" & _Dt2.ToString("yyyyMMdd") & "#" & TxtSo_Ct_DXM.Text & "#" & TxtMa_Kh.Text & "#" & M_Stt_rec & "#" & M_ma_Ct & "#" & M_Ma_Dvcs & "#" & M_User_Name)
...
#Region "Grid..."
    ...
    Private Sub V_FillDataToGridview(ByVal GRV As DevExpress.XtraGrid.Views.Grid.GridView, ByVal _M_lan As String, ByVal DvHeader As DataView, ByVal DvData As DataView)
        ...
        For Each clm As DevExpress.XtraGrid.Columns.GridColumn In GRV.Columns
