...
#Region "Columns Edit"
    ...
    Dim EditGIA_NY, EditGia_NY_Nt, EditTien_NY, EditTien_NY_Nt, EditPT_CK, EditCK, EditCK_NT As New Cyber.Fill.CyberColumnGridView
#End Region
...
#Region "Load And Set And Default"
    Private Sub V_Load()
        Try
            TimeBarCode = Me.SysVar("M_TIME_BARCODE")
    ...
    Private Sub V_GetColumn()
        ...
        EditGIA_NY.GetColumn(DetailGRV, "GIA_NY")
        EditGia_NY_Nt.GetColumn(DetailGRV, "Gia_NY_Nt")
        EditTien_NY.GetColumn(DetailGRV, "Tien_NY")
        EditTien_NY_Nt.GetColumn(DetailGRV, "Tien_NY_Nt")
        EditPT_CK.GetColumn(DetailGRV, "PT_CK_I")
        EditCK_NT.GetColumn(DetailGRV, "CK_I")
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Master()
        ...
        AddHandler ChkSua_ThueVat.CheckedChanged, AddressOf V_Sua_ThueVAT
        ...
        AddHandler txtLenh_Po_Hang.Leave, AddressOf L_Lenh_Po_Hang
        ...
        'Ma_Barcode
        AddHandler TxtMa_BarCode.KeyDown, AddressOf TxtMa_BarCode_KeyDown
        AddHandler TxtMa_BarCode.KeyPress, AddressOf TxtMa_BarCode_KeyPress
        AddHandler TxtMa_BarCode.KeyUp, AddressOf TxtMa_BarCode_KeyUp
        'Ma_LD
        AddHandler TxtMa_LD.CyberValiting, AddressOf V_Ma_LD
        AddHandler TxtMa_LD.CyberLeave, AddressOf L_Ma_LD

        AddHandler CmdCapNhatHD.Click, AddressOf V_CapNhatHDVAT
    End Sub
    Private Sub V_AddHandler_Detail()
        ...
        If Not EditGia_NY_Nt.Column Is Nothing Then AddHandler EditGia_NY_Nt.EditColumn.Leave, AddressOf L_Tinh_Toan
        If Not EditGIA_NY.Column Is Nothing Then AddHandler EditGIA_NY.EditColumn.Leave, AddressOf L_Tinh_Toan
        ...
        If Not EditTien_NY_Nt.Column Is Nothing Then AddHandler EditTien_NY_Nt.EditColumn.Leave, AddressOf L_Tinh_Toan
        If Not EditTien_NY.Column Is Nothing Then AddHandler EditTien_NY.EditColumn.Leave, AddressOf L_Tinh_Toan
        '----------------------------------------------------------------------------------------------------------
    ...
    Private Sub VisibleColumnMa_NT()
        If TxtMa_NT.Text.Trim = "" Or TxtMa_NT.Text.Trim.ToUpper = osysvar("M_Ma_NT0").ToString.Trim.ToUpper Then
            ...
            EditGIA_NY.Visible = False
            EditTien_NY.Visible = False
            TxtT_Tien_NY.Visible = False
        ...
        Else
            ...
            TxtT_Tien_NY.Visible = True
            EditTien_NY.Visible = True
            EditGIA_NY.Visible = True
            TxtT_CK.Visible = True
        End If
        SetFoCusGRV()
    End Sub
    Private Sub VisibleColumnMa_GD()
        If CmbMa_GD.SelectedValue.ToString.ToUpper = "1" Then
...
#End Region
    ...
    Private Sub V_Sua_Thue(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        UpdateList()
    End Sub
    Private Sub V_Sua_ThueVAT(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If Not ChkSua_ThueVat.Checked Then
...
#Region "Lenh/SO/Po/Ro/Vt"
    ...
    Private Sub L_Lenh_Po(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim _DsTmp As DataSet = CyberInput.V_GetPNKFromPOD(AppConn, CyberSmlib, "1", "19000101", "19000101", TxtLenh_PO.Text, TxtMa_Kh.Text, M_Stt_Rec, "", M_Ma_Dvcs, M_User_Name)
    ...
    Private Sub L_Lenh_Po_Hang(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub

        If (M_Mode = "S" And ChkIs_Them.Checked = False) Then Exit Sub
        Dim nCount As Integer = Dt_DetailTmp.Rows.Count - 1
        For iRow As Integer = nCount To 0 Step -1
            If Dt_DetailTmp.Rows(iRow).Item("Ma_VT").ToString.Trim = "" Then Dt_DetailTmp.Rows(iRow).Delete()
        Next
        Dt_DetailTmp.AcceptChanges()
        nCount = Dt_DetailTmp.Rows.Count
        If nCount > 0 And 1 = 0 Then Exit Sub

        '--------------------------------------------------------------------------------------------
        Dim _Dt As Date = TxtNgay_Ct.Value
        'TxtLenh_PO.Text = CyberVoucher.V_FormatSo_PO(AppConn, osysvar, M_Ma_CT, CmbMa_GD.SelectedValue, M_Mode, _Dt, TxtLenh_PO.Text, CbbMa_TTCP_H, M_Ma_Dvcs, M_User_Name, CyberSmlib)

        If txtLenh_Po_Hang.Text.Trim = "" Then Return
        Dim _DsTmp As DataSet = CyberInput.V_GetPNKFromPOD(AppConn, CyberSmlib, "1", "19000101", "19000101", txtLenh_Po_Hang.Text, TxtMa_Kh.Text, M_Stt_Rec, "", M_Ma_Dvcs, M_User_Name)
        nCount = _DsTmp.Tables.Count
    ...
    Private Sub V_Phan_Bo_Tien()
        ...
        For iRow As Integer = 0 To Dv_DetailTmp.Count - 1
            If Dv_DetailTmp.Item(iRow).Item("So_Luong") <> 0 Then
                Dv_DetailTmp.Item(iRow).BeginEdit()
                Dv_DetailTmp.Item(iRow).Item("Gia_NT") = CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("Tien_NT") / Dv_DetailTmp.Item(iRow).Item("So_Luong"), M_R_GIA_NT)
                Dv_DetailTmp.Item(iRow).Item("Gia") = CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("Tien") / Dv_DetailTmp.Item(iRow).Item("So_Luong"), M_R_GIA_NT)
                Dv_DetailTmp.Item(iRow).EndEdit()
            End If
...
#Region "Valid - Detail - Core"
    Private Sub UpdateList()
        ...
        Dim nT_Tien_NY_Nt As Decimal = 0
        Dim nT_Tien_NY As Decimal = 0
        ...
        For iRow As Integer = 0 To Dv_DetailTmp.Count - 1
            ...
            nT_CK_NT = nT_CK_NT + Dv_DetailTmp.Item(iRow).Item("CK_I")
            nT_CK = nT_CK + Dv_DetailTmp.Item(iRow).Item("CK_I")
            nT_Tien_NY_Nt = nT_Tien_NY_Nt + Dv_DetailTmp.Item(iRow).Item("Tien_NY_Nt")
            nT_Tien_NY = nT_Tien_NY + Dv_DetailTmp.Item(iRow).Item("Tien_NY")
        Next
        ...
        TxtT_Tien_NY.Double = nT_Tien_NY
        TxtT_Tien_NY_NT.Double = nT_Tien_NY_Nt

        TxtT_So_Luong.Double = nT_So_Luong
        nT_Tien_Nt = nT_Tien_NY_Nt - nT_CK_NT
        nT_Tien = nT_Tien_NY - nT_CK
    ...
    Private Sub V_Tinh_Tien()
        ...
        'If ChkSua_ThueVat.Checked Then
    ...
    Private Sub V_Tinh_Toan(ByVal iRow As Integer)
        ...
        Dv_DetailTmp.Item(iRow).BeginEdit()
        'Dv_DetailTmp.Item(iRow).Item("Tien_NY_Nt") = CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("So_Luong") * Dv_DetailTmp.Item(iRow).Item("Gia_NY_Nt"), M_R_TIEN_NT)
        If Dv_DetailTmp.Item(iRow).Item("PT_CK_I") <> 0 Then
            Dv_DetailTmp.Item(iRow).Item("CK_I") = CyberSupport.V_Round((Dv_DetailTmp.Item(iRow).Item("PT_CK_I") * Dv_DetailTmp.Item(iRow).Item("Tien_NY_Nt") / 100), M_R_TIEN_NT)
        End If
        Dv_DetailTmp.Item(iRow).EndEdit()

        If Dv_DetailTmp.Item(iRow).Item("So_Luong") * Dv_DetailTmp.Item(iRow).Item("Tien_NY_Nt") <> 0 Then
            'Dv_DetailTmp.Item(iRow).Item("Gia_NY_Nt") = CyberSupport.V_Round((Dv_DetailTmp.Item(iRow).Item("Tien_NY_Nt") / Dv_DetailTmp.Item(iRow).Item("So_Luong")), M_R_GIA_NT)
            If Dv_DetailTmp.Item(iRow).Item("Gia_NY_Nt") = 0 Then Dv_DetailTmp.Item(iRow).Item("Gia_NY_Nt") = CyberSupport.V_Round((Dv_DetailTmp.Item(iRow).Item("Tien_NY_Nt") / Dv_DetailTmp.Item(iRow).Item("So_Luong")), 4)
        End If

        'Nếu số lượng = 0 thì tiền bằng 0
        If Dv_DetailTmp.Item(iRow).Item("So_Luong") = 0 Then
            Dv_DetailTmp.Item(iRow).BeginEdit()
            Dv_DetailTmp.Item(iRow).Item("TIEN_NY_NT") = 0
            Dv_DetailTmp.Item(iRow).EndEdit()
        End If

        'If Dv_DetailTmp.Item(iRow).Item("So_Luong") * Dv_DetailTmp.Item(iRow).Item("Gia_NY_Nt") <> 0 Then

        If Dv_DetailTmp.Item(iRow).Item("Tien_NY_Nt") = 0 Then Dv_DetailTmp.Item(iRow).Item("Tien_NY_Nt") = CyberSupport.V_Round((Dv_DetailTmp.Item(iRow).Item("Gia_NY_Nt") * Dv_DetailTmp.Item(iRow).Item("So_Luong")), 0)
        'End If

        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dv_DetailTmp.Item(iRow).Item("Tien_Nt0") = CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("Tien_NY_Nt") - Dv_DetailTmp.Item(iRow).Item("CK_I"), M_R_TIEN_NT)
        Dv_DetailTmp.Item(iRow).EndEdit()
        If Dv_DetailTmp.Item(iRow).Item("So_Luong") <> 0 And Dv_DetailTmp.Item(iRow).Item("CK_I") <> 0 Then
            Dv_DetailTmp.Item(iRow).BeginEdit()
            Dv_DetailTmp.Item(iRow).Item("Gia_NT0") = CyberSupport.V_Round(((Dv_DetailTmp.Item(iRow).Item("Tien_Nt0")) / Dv_DetailTmp.Item(iRow).Item("So_Luong")), M_R_GIA_NT)
            Dv_DetailTmp.Item(iRow).EndEdit()
        Else
            Dv_DetailTmp.Item(iRow).Item("Gia_NT0") = Dv_DetailTmp.Item(iRow).Item("Gia_NY")
        End If
        '--------------------------------------------------------------------------------
        ...
        If Dv_DetailTmp.Item(iRow).Item("Sl_TD_I") = 0 Then
            Dv_DetailTmp.Item(iRow).Item("Sl_TD_I") = Dv_DetailTmp.Item(iRow).Item("So_Luong")
        End If
        '--------------------------------------------------------------------------------
        '----------------VND
        Dv_DetailTmp.Item(iRow).BeginEdit()
        If nTy_Gia = 1 Then
            ...
            Dv_DetailTmp.Item(iRow).Item("Tien_NY") = Dv_DetailTmp.Item(iRow).Item("Tien_NY_Nt")
            Dv_DetailTmp.Item(iRow).Item("GIA_NY") = Dv_DetailTmp.Item(iRow).Item("Gia_NY_Nt")
            Dv_DetailTmp.Item(iRow).Item("CK_I") = Dv_DetailTmp.Item(iRow).Item("CK_I")
        ...
        Else
            ...
            Dv_DetailTmp.Item(iRow).Item("Tien_NY") = CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("Tien_NY_Nt") * nTy_Gia, M_R_TIEN)
            Dv_DetailTmp.Item(iRow).Item("Gia_NY") = CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("Gia_NY_Nt") * nTy_Gia, M_R_GIA)
        End If
        Dv_DetailTmp.Item(iRow).EndEdit()
        Dv_DetailTmp.Table.AcceptChanges()
        Dv_DetailTmp.Item(iRow).BeginEdit()
...
#Region "Vat tu kho/Vitri - "
    ...
    Private Sub L_Ma_Vt(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Dv_DetailTmp.Table.Columns.Contains("Ma_Thue") Then Dv_DetailTmp.Item(iRow).Item("Ma_Thue") = _Ma_Thue
...
#Region "Mainform"
    ...
    Private Sub V_ShortAddItem(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        'Kiểm tra quyền sửa chi tiết
        'If V_ChekRight_Edit() = False Then Exit Sub
...
#Region "Button"
    ...
    Private Sub V_Save_Luu(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim _Ngay_Ct As Date = TxtNgay_Ct.Value
        Dim _Ngay_LCt As Date = TxtNgay_Ct.Value
        If CmbMa_GD.SelectedValue.ToString.Trim = "2" Then TxtLenh_PO.Text = ""
        '----------------------------------------------------------------------------------------------------------------------
        V_GetDateVoucher(M_Mode, _Ngay_Ct, _Ngay_LCt)
        '----------------------------------------------------------------------------------------------------------------------
        If Not ChkRightsVoucher("L") Then Exit Sub
    ...
    Private Sub V_New(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        '--------------
        TxtNgay_Ct0.Value = New Date(1900, 1, 1)
    ...
    Private Sub V_Edit(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        'If V_ChekRight_Edit() = False Then
        '    _Readonly = True
        'End If

        'EditMa_VT.ColumnReadOnly = _Readonly
        'EditMa_Kho_I.ColumnReadOnly = _Readonly
        'EditSo_Luong.ColumnReadOnly = _Readonly
        'EditGia_NT0.ColumnReadOnly = _Readonly
        'EditTien_NT0.ColumnReadOnly = _Readonly
    End Sub
    Private Function V_ChekRight_Edit()
        Dim _Dt As Date = TxtNgay_Ct.Value
        Dim _DsChk As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GLChkRightPN", M_Mode.Trim & "#" & _Dt.ToString("yyyyMMdd") & "#" & M_Ma_CT.Trim & "#" & M_Stt_Rec.Trim & "#" & M_Ma_Dvcs.Trim & "#" & M_User_Name.Trim)
        If _DsChk.Tables(0).Rows(0).Item("Reaonly") = 1 Then
            Return False
            Exit Function
        End If
...
#Region "Sms - Import"
    ...
    Private Sub SetTxt()
        ...
        If M_Mode = "M" Or M_Mode = "S" Then
            ...
            If ChkSua_ThueVat.Checked Then TxtT_thue_NT.ReadOnly = False
        End If
...
#End Region
#Region "Xử lý Barcode"
    Dim strKey As String = ""
    Dim bTime As Date

    Private Sub TxtMa_BarCode_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If e.KeyCode <> Keys.Enter Then
            If strKey.Trim = "" Then bTime = Now
        End If
    End Sub
    Private Sub TxtMa_BarCode_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        strKey += e.KeyChar.ToString.ToUpper
    End Sub
    Private Sub TxtMa_BarCode_KeyUp(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If e.KeyCode = Keys.Enter Then
            If DateDiff(DateInterval.Second, bTime, Now) <= TimeBarCode Then
                sender.Text = strKey.ToString.ToUpper
                L_Ma_Barcode()
                sender.Text = ""
            Else
                sender.Text = ""
        ...
        sender.Refresh()
    End Sub
    Private Sub L_Ma_Barcode()
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If TxtMa_BarCode.Text = "" Then Exit Sub
        ...
        For iRow = nCount - 1 To 0 Step -1
            If Dt_DetailTmp.Rows(iRow).Item("Ma_VT").ToString.ToUpper = TxtMa_BarCode.Text.Trim Then
                'Dt_DetailTmp.Rows(iRow).Item("Ma_Barcode") = TxtMa_BarCode.Text.Trim
                Dt_DetailTmp.Rows(iRow).Item("SL_Barcode") = Dt_DetailTmp.Rows(iRow).Item("SL_Barcode") + 1
                If Dt_DetailTmp.Rows(iRow).Item("So_Luong") < Dt_DetailTmp.Rows(iRow).Item("SL_RO") Then
                    Dt_DetailTmp.Rows(iRow).Item("So_Luong") = Dt_DetailTmp.Rows(iRow).Item("SL_Barcode")
                End If
        ...
        TxtMa_BarCode.Text = ""
        TxtMa_BarCode.Focus()
        TxtMa_BarCode.SelectAll()
    End Sub

#End Region
    Private Sub V_CapNhatHDVAT(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If M_Stt_Rec = "" Then Exit Sub
        If (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim Frm As FrmCapNhatHD30
        Frm = New FrmCapNhatHD30
        Frm.Sysvar = Me.osysvar
        Frm.Para = Me.M_Para
        Frm.AppConn = Me.AppConn
        Frm.Stt_Rec = M_Stt_Rec
        ...
        Frm.ShowDialog()
        If Not Frm.Save_OK Then Exit Sub
        TxtSo_Ct0.Text = Frm.So_HDDT
        TxtNgay_Ct0.Value = Frm.Ngay_HDDT
        TxtSo_Seri0.Text = Frm.So_Seri
    End Sub
End Class
