Public Class RO_W_NonBBH
    ...
    Private Sub BC_PhieuHS_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_AddMenuShorcut()
        V_Load()
        V_Addhander()
    End Sub
...
#End Region
    Private Sub V_Load()
        ...
        Dim _DsLoai_Phieu As DataSet = CyberSmLib.SQLExcuteStoreProcedure(AppConn, "CP_GetMaGD_PHS", Ma_Dvcs + "#" + User_Name)
...
#Region "Button"
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim _Ma_GD_Filter As String = txtSo_BH.Text.ToString.Trim
        Dim _Ma_Dvcs_Filter As String = Me.CBBMa_Dvcs.SelectedValue.ToString.Trim

        Dim M_strParameterStore As String = _Ma_GD_Filter
        ...
        M_strParameterStore = M_strParameterStore & "#" & IIf(ChkIs_Non_PBH.Checked, "1", "0")
