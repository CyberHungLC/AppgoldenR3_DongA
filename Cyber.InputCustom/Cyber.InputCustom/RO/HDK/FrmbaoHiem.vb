...
#End Region
    ...
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim _VC_DL As String = "0"
        If ChkVc_Dl.Checked Then _VC_DL = "1"

        Dim _DS_DL As String = "0"
        If ChkDs_Dl.Checked Then _DS_DL = "1"
        ...
        Dim Dstmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_ICGetNgayBHSave", TxtMa_Xe.Text + "#" + _Dt_BH_DS.ToString("yyyyMMdd") + "#" + _Dt_BH_VC.ToString("yyyyMMdd") + "#" + _Dt_BH_NL.ToString("yyyyMMdd") + "#" + _Ma_BH_DS + "#" + _Ma_BH_VC + "#" + _Ma_BH_NL + "#" + txtSo_Lenh.Text.Trim + "#" + TxtMa_HS.Text.Trim + "#" + M_Ma_Dvcs + "#" + M_User_Name)
