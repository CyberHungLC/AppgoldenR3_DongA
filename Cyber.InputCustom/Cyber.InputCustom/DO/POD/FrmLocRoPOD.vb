...
#End Region
    ...
    Private Sub V_AddHander()
        ...
        AddHandler TxtSo_YCT.Leave, AddressOf L_So_Lenh
        ...
        AddHandler ChkDetail.CheckedChanged, AddressOf V_ChkDetail
...
#Region "Load - "
    ...
    Private Sub V_LoadDatabase(ByVal Status As String)
        ...
        Dim DsLenh_RO As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_YCTGetPOD", Status & "#" & TxtSo_YCT.Text.Trim & "#" & M_Ma_GD.Trim & "##" & TxtMa_Hs.Text.Trim & "#" & _Ngay_Ct1.ToString("yyyyMMdd") & "#" & _Ngay_Ct2.ToString("yyyyMMdd") & "#" & M_Stt_rec & "#" & M_Ma_Dvcs & "#" & M_User_Name)
    ...
    Private Sub V_LoadHeaderGridview()
        Dim DsHeader As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetDetailHeadPOD", TxtSo_YCT.Text + "#" + M_Ma_Ct.Trim + "#" + M_User_Name)
        '========== Fill datatable
...
#Region "Tinh toan"
    ...
    Private Sub V_ChonVt(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim _Rec_YCT As String = ""
        Try
            _Rec_YCT = selectedRow("Rec_YCT").ToString.Trim
    ...
    Private Sub V_Chon(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        V_Detial(IIf(_Tag <> "1", "0", "1"), _Rec_YCT)
    ...
    Private Sub DetailGRVRo_Master_FocusedRowChanged(ByVal sender As System.Object, ByVal e As DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs)
        ...
        If selectedRow Is Nothing Then _stt_Rec = "" Else _stt_Rec = selectedRow("Rec_YCT").ToString.Trim
    ...
    Private Sub V_BilldtingRo(ByVal MasterGRV As DevExpress.XtraGrid.Views.Grid.GridView, ByVal Dv_Master As DataView, ByVal Dv_DetailTmp As DataView)
        ...
        If Not Dv_DetailTmp.Table.Columns.Contains("Rec_YCT") Then Exit Sub
        If Not Dv_Master.Table.Columns.Contains("Rec_YCT") Then Exit Sub
        ...
        Try
            ...
            If (Not String.IsNullOrEmpty(selectedRow("Rec_YCT").ToString)) Then
                filter = "Rec_YCT='" + selectedRow("Rec_YCT").ToString() + "'"
        ...
        End Try
    End Sub
    Private Sub V_Detial(ByVal status As String, ByVal _Rec_YCT As String)
        _Rec_YCT = _Rec_YCT.Trim
        dtDetailVtRo.AcceptChanges()

        For Each dr As DataRow In dtDetailVtRo.Select("Rec_YCT='" & _Rec_YCT & "'")
            dr.BeginEdit()
            dr("tag") = status
            dr.EndEdit()
        Next
        ...
        dtDetailVtRo.AcceptChanges()
    End Sub
    Private Sub TotalItem(ByVal _Rec_YCT As String)
        ...
        For Each drVt As DataRow In dtDetailVtRo.Select("Tag='1' AND Rec_YCT ='" + _Rec_YCT.ToString.Trim + "'")
...
#End Region
    ...
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        For i As Integer = 0 To dtMasterRo.Rows.Count - 1
            ...
            Dim _Rec_YCT As String = dtMasterRo.Rows(i).Item("Stt_rec").ToString.Trim.ToUpper

            For iRowVt = 0 To dtDetailVtRo.Rows.Count - 1
                If Not dtDetailVtRo.Rows(iRowVt).Item("Tag").ToString.Trim = "1" Then Continue For
                If Not dtDetailVtRo.Rows(iRowVt).Item("Rec_YCT").ToString.Trim.ToUpper = _Rec_YCT Then Continue For
    ...
    Private Sub V_ChkDetail()
        Dim i As Integer
        For i = 0 To dtDetailVtRo.Rows.Count - 1
            dtDetailVtRo.Rows(i).BeginEdit()
            dtDetailVtRo.Rows(i).Item("Tag") = ChkDetail.Checked
            dtDetailVtRo.Rows(i).EndEdit()
            dtDetailVtRo.AcceptChanges()
        Next
    End Sub
