Public Class BC_CRMNhac_BD
    Dim DtThang1, DtThang2, DtNam As DataTable
    Dim CyberMe As New Cyber.ReportsCustom.Sys
    Dim DrReturn As DataRow
    Dim DsLookup As DataSet
    Dim Dt_LoaiCs As DataTable
    Private Sub CSKH024_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_AddMenuShorcut()
        V_Load()
        V_Addhander()
    End Sub
#Region "Load"
    Private Sub V_Load()
        ...
        '-- Loại Cs
        Dim _DtDsCS As DataSet = CyberSmLib.SQLExcuteStoreProcedure(AppConn, "CP_CRM_Loai_Ngay", Ma_Dvcs + "#" + User_Name)
        Dt_LoaiCs = _DtDsCS.Tables(0).Copy
        CyberFill.V_FillComBoxDefaul(CbbCRM_Loai_Ngay, Dt_LoaiCs, "Ma_Loai", "Ten_Loai", "Ngam_Dinh")
        _DtDsCS.Dispose()
        '----Set
...
#Region "Button"
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim M_Loai_Cs As String = Me.CbbCRM_Loai_Ngay.SelectedValue.ToString.Trim
        Dim M_strParameterStore As String = CbbM_Thang1.SelectedValue.ToString.Trim
        M_strParameterStore = M_strParameterStore & "#" & CbbM_Thang2.SelectedValue.ToString.Trim
        M_strParameterStore = M_strParameterStore & "#" & CbbM_Nam.SelectedValue.ToString.Trim
        M_strParameterStore = M_strParameterStore & "#" & M_Loai_Cs
