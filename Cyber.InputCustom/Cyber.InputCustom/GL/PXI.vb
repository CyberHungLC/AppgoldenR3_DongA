...
#End Region
#Region "Columns Edit"
    Dim EditMa_Lo, EditTk_Cc, EditMa_Nx_I, EditTk_CP As New Cyber.Fill.CyberColumnGridView
    Dim EditMa_CTCc, EditMa_Cc, EditMa_Kho_I, EditMa_VitriCC, EditMa_Vv_I, EditMa_Phi_i, EditMa_HD_I, EditMa_Sp_I, EditMa_Ku_I, EditMa_TTLN_i, EditMa_TTCP_i, EditMa_BP_I, EditMa_HS_I, EditMa_CD_I, EditMa_TD1_I, EditMa_TD2_I, EditMa_TD3_I, EditMa_TD4_I, EditMa_TD5_I As New Cyber.Fill.CyberColumnGridView
    Dim Editma_Db_I, EditMa_Xe_I, EditMa_KX_I, EditMa_Tuyen_I, EditMa_Ts As New Cyber.Fill.CyberColumnGridView
    Dim EditSo_Luong, EditSo_Ky_Pb, EditGt_Pb_Ky, EditGt_Pb_KyNT, EditGia_NT, EditGia, EditTien_NT, EditTien, EditDien_Giaii, EditSo_So, EditSo_Po, EditSo_Ro, EditSo_VT As New Cyber.Fill.CyberColumnGridView
    Dim EditGia_HC, EditTien_HC, EditSo_Ky_Pb_HC, EditGt_Pb_Ky_HC As New Cyber.Fill.CyberColumnGridView
#End Region
...
#Region "Load And Set And Default"
    Private Sub V_Load()
        ...
        TxtT_Tien_HC.InputMask = IIf(DrDmct.Item("M_IP_MK_TIEN_NT").ToString.Trim <> "", DrDmct.Item("M_IP_MK_TIEN_NT").ToString.Trim, TxtT_Tien_HC.InputMask)
    End Sub
    ...
    Private Sub V_GetColumn()
        ...
        EditMa_CTCc.GetColumn(DetailGRV, "Ma_CTCc")
        EditMa_Cc.GetColumn(DetailGRV, "Ma_Cc")
        EditMa_VitriCC.GetColumn(DetailGRV, "Ma_VitriCC")
        ...
        EditGia_HC.GetColumn(DetailGRV, "Gia_HC")
        EditTien_HC.GetColumn(DetailGRV, "Tien_HC")
        EditSo_Ky_Pb_HC.GetColumn(DetailGRV, "So_Ky_Pb_HC")
        EditGt_Pb_Ky_HC.GetColumn(DetailGRV, "Gt_Pb_Ky_HC")
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Master()
        ...
        'Ma_TD2_H
        AddHandler TxtMa_TD2_H.CyberValiting, AddressOf V_Ma_TD2_H
        AddHandler TxtMa_TD2_H.CyberLeave, AddressOf L_Ma_TD2_H
        'Ma_Hs_N
        AddHandler TxtMa_Hs_N.CyberValiting, AddressOf V_Ma_Hs_N
        AddHandler TxtMa_Hs_N.CyberLeave, AddressOf L_Ma_Hs_N
        'Ma_BP_N
        AddHandler TxtMa_BP_N.CyberValiting, AddressOf V_Ma_BP_N
        AddHandler TxtMa_BP_N.CyberLeave, AddressOf L_Ma_BP_N
        'Ma_TD2_N
        AddHandler TxtMa_TD2_N.CyberValiting, AddressOf V_Ma_TD2_N
        AddHandler TxtMa_TD2_N.CyberLeave, AddressOf L_Ma_TD2_N
        '----------------------------------------------------------------------------------------------------------
    ...
    Private Sub V_AddHandler_Detail()
        ...
        '----------------------------------------------------------------------------------------------------------
        If Not EditGia_HC.Column Is Nothing Then AddHandler EditGia_HC.EditColumn.Leave, AddressOf L_Tinh_Toan
        If Not EditTien_HC.Column Is Nothing Then AddHandler EditTien_HC.EditColumn.Leave, AddressOf L_Tinh_Toan
        If Not EditSo_Ky_Pb_HC.Column Is Nothing Then AddHandler EditSo_Ky_Pb_HC.EditColumn.Leave, AddressOf L_Tinh_Toan
        If Not EditGt_Pb_Ky_HC.Column Is Nothing Then AddHandler EditGt_Pb_Ky_HC.EditColumn.Leave, AddressOf L_Tinh_Toan

        '----------------------------------------------------------------------------------------------------------
        If Not EditDien_Giaii.Column Is Nothing Then AddHandler EditDien_Giaii.EditColumn.Enter, AddressOf E_Dien_Giaii
        '-------------------------------------
        EditMa_CTCc.V_ActiLookUpColumn(AddressOf V_Ma_CTCC, AddressOf L_Ma_CTCc)
        ...
        EditMa_VitriCC.V_ActiLookUpColumn(AddressOf V_Ma_ViTriCC, AddressOf L_Ma_ViTriCC)
...
#Region "Valid --- Ma_Hs_H"
    ...
    Private Sub V_GetBP()
        ...
        Dim _Dt As Date = TxtNgay_Ct.Value
        Dim _Ma_Hs As String = TxtMa_Hs_H.Text.Trim
        Dim _DsBP As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetBP", _Dt.ToString("yyyyMMdd") & "#" & _Ma_Hs & "#" & M_Ma_Dvcs & "#" & M_User_Name)

        If _DsBP.Tables.Count < 1 Then
            _DsBP.Dispose()
            Exit Sub
        End If

        If _DsBP.Tables(0).Rows.Count < 1 Then
            _DsBP.Dispose()
            Exit Sub
        End If

        If _DsBP.Tables(0).Columns.Contains("Ma_BP") Then TxtMa_BP_H.Text = _DsBP.Tables(0).Rows(0).Item("Ma_BP")
        If _DsBP.Tables(0).Columns.Contains("Ten_BP") Then TxtTen_BP_H.Text = _DsBP.Tables(0).Rows(0).Item("Ten_BP")
        If _DsBP.Tables(0).Columns.Contains("Ma_TD2") Then TxtMa_TD2_H.Text = _DsBP.Tables(0).Rows(0).Item("Ma_TD2")
        If _DsBP.Tables(0).Columns.Contains("Ten_TD2") Then TxtTen_TD2_H.Text = _DsBP.Tables(0).Rows(0).Item("Ten_TD2")
    End Sub
#End Region
#Region "Valid --- Ma_BP_H"
    ...
    End Sub
#End Region
#Region "Valid --- Ma_TD2_H"
    Private Sub V_Ma_TD2_H(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        TxtMa_TD2_H.V_LookUp(M_LAN, M_Para, osysvar, AppConn, DsLookup, "Ma_TD2", "DmTD2", "1=1", "1=1")
    End Sub
    Private Sub L_Ma_TD2_H(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If TxtMa_TD2_H.Text = "" Then
            TxtTen_TD2_H.Text = ""
            Exit Sub
        End If
        DrReturn = TxtMa_TD2_H.GetRowsSelectData(True)
        If Not DrReturn Is Nothing Then
            TxtMa_TD2_H.Text = DrReturn.Item("Ma_TD2")
            TxtTen_TD2_H.Text = DrReturn.Item("Ten_TD2")
        Else
            TxtMa_TD2_H.Text = ""
            TxtTen_TD2_H.Text = ""
        End If
...
#Region "Valid --- Ma_Hs_N"
    ...
    Private Sub L_Ma_Hs_N(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        ...
        V_GetBP_N()
    End Sub
    Private Sub V_GetBP_N()
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub

        Dim _Dt As Date = TxtNgay_Ct.Value
        Dim _Ma_Hs As String = TxtMa_Hs_N.Text.Trim
        Dim _DsBP As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetBP", _Dt.ToString("yyyyMMdd") & "#" & _Ma_Hs & "#" & M_Ma_Dvcs & "#" & M_User_Name)
        ...
        If _DsBP.Tables(0).Columns.Contains("Ma_BP") Then TxtMa_BP_N.Text = _DsBP.Tables(0).Rows(0).Item("Ma_BP")
        If _DsBP.Tables(0).Columns.Contains("Ten_BP") Then TxtTen_BP_N.Text = _DsBP.Tables(0).Rows(0).Item("Ten_BP")
        If _DsBP.Tables(0).Columns.Contains("Ma_TD2") Then TxtMa_TD2_N.Text = _DsBP.Tables(0).Rows(0).Item("Ma_TD2")
        If _DsBP.Tables(0).Columns.Contains("Ten_TD2") Then TxtTen_TD2_N.Text = _DsBP.Tables(0).Rows(0).Item("Ten_TD2")
    End Sub
#End Region
#Region "Valid --- Ma_BP_N"
    Private Sub V_Ma_BP_N(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        TxtMa_BP_N.V_LookUp(M_LAN, M_Para, osysvar, AppConn, DsLookup, "Ma_BP", "DmBP", "1=1", "1=1")
    End Sub
    Private Sub L_Ma_BP_N(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If TxtMa_BP_N.Text = "" Then
            TxtTen_BP_N.Text = ""
            Exit Sub
        End If
        DrReturn = TxtMa_BP_N.GetRowsSelectData(True)
        If Not DrReturn Is Nothing Then
            TxtMa_BP_N.Text = DrReturn.Item("Ma_BP")
            TxtTen_BP_N.Text = DrReturn.Item("Ten_BP")
        Else
            TxtMa_BP_N.Text = ""
            TxtTen_BP_N.Text = ""
        End If
    End Sub
#End Region
#Region "Valid --- Ma_TD2_N"
    Private Sub V_Ma_TD2_N(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        TxtMa_TD2_N.V_LookUp(M_LAN, M_Para, osysvar, AppConn, DsLookup, "Ma_TD2", "DmTD2", "1=1", "1=1")
    End Sub
    Private Sub L_Ma_TD2_N(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If TxtMa_TD2_N.Text = "" Then
            TxtTen_TD2_N.Text = ""
            Exit Sub
        End If
        DrReturn = TxtMa_TD2_N.GetRowsSelectData(True)
        If Not DrReturn Is Nothing Then
            TxtMa_TD2_N.Text = DrReturn.Item("Ma_TD2")
            TxtTen_TD2_N.Text = DrReturn.Item("Ten_TD2")
        Else
            TxtMa_TD2_N.Text = ""
            TxtTen_TD2_N.Text = ""
        End If
...
#Region "Valid - Detail - Core"
    ...
    Private Sub V_Tinh_Toan(ByVal iRow As Integer)
        ...
        If Dv_DetailTmp.Item(iRow).Item("So_Luong") * Dv_DetailTmp.Item(iRow).Item("Gia_HC") <> 0 Then
            Dv_DetailTmp.Item(iRow).BeginEdit()
            Dv_DetailTmp.Item(iRow).Item("Tien_HC") = CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("So_Luong") * Dv_DetailTmp.Item(iRow).Item("Gia_HC"), M_R_TIEN_NT)
            Dv_DetailTmp.Item(iRow).EndEdit()
        End If
        ...
        If Dv_DetailTmp.Item(iRow).Item("So_Ky_Pb_QD") <> 0 And Dv_DetailTmp.Item(iRow).Item("So_Ky_Da_Pb") <> 0 Then
            Dv_DetailTmp.Item(iRow).Item("So_Ky_Pb") = CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("So_Ky_Pb_QD") - Dv_DetailTmp.Item(iRow).Item("So_Ky_Da_Pb"), M_R_TIEN)
        End If

        If Dv_DetailTmp.Item(iRow).Item("So_Ky_Pb_QD_HC") <> 0 And Dv_DetailTmp.Item(iRow).Item("So_Ky_Da_Pb_HC") <> 0 Then
            Dv_DetailTmp.Item(iRow).Item("So_Ky_Pb_HC") = CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("So_Ky_Pb_QD_HC") - Dv_DetailTmp.Item(iRow).Item("So_Ky_Da_Pb_HC"), M_R_TIEN)
        End If
        ...
        If Dv_DetailTmp.Item(iRow).Item("So_Ky_Pb_HC") <> 0 Then Dv_DetailTmp.Item(iRow).Item("Gt_Pb_Ky_HC") = CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("Tien_HC") / Dv_DetailTmp.Item(iRow).Item("So_Ky_Pb_HC"), M_R_TIEN)
        Dv_DetailTmp.Item(iRow).EndEdit()
...
#Region "Ma_Cc, Ma_Kho - "
    ...
    Private Sub L_Ma_Lo(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        V_SetSD(iRow)
    End Sub
    Private Sub V_Ma_CTCC(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        CyberSupport.V_Lookup("Ma_CTCC", "DmCTCC", "1=1", "1=1", M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_CTCc(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim iRow As Integer = -1
        iRow = DetailGRV.GetFocusedDataSourceRowIndex
        If iRow < 0 Then Exit Sub
        ...
        If DrReturn Is Nothing Then
            Dv_DetailTmp.Item(iRow)("Ma_CTCC") = ""
            Dv_DetailTmp.Item(iRow)("Ten_CTCC") = ""
            Dv_DetailTmp.Item(iRow)("Dvt_CTCC") = ""
            Exit Sub
        End If
        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dv_DetailTmp.Item(iRow).Item("Ma_CTCC") = DrReturn("Ma_CTCC").ToString.Trim
        Dv_DetailTmp.Item(iRow).Item("Ten_CTCC") = DrReturn("Ten_CTCC").ToString.Trim
        Dv_DetailTmp.Item(iRow)("Dvt_CTCC") = DrReturn("Dvt").ToString.Trim
        Dv_DetailTmp.Item(iRow).Item("Ma_Cc") = DrReturn("Ma_Cc").ToString.Trim

        If Dv_DetailTmp.Table.Columns.Contains("Ten_Cc") Then
            If DrReturn.Table.Columns.Contains("Ten_Cc") Then
                Dv_DetailTmp.Item(iRow).Item("Ten_Cc") = DrReturn("Ten_Cc").ToString.Trim
            Else
                Dv_DetailTmp.Item(iRow).Item("Ten_Cc") = CyberSmodb.SQLGetvalue(AppConn, "Ten_Cc", "DmCc", "(Ma_Cc = N'" + DrReturn("Ma_Cc").ToString.Trim + "')", CyberSmlib)
            End If
        End If

        If Dv_DetailTmp.Table.Columns.Contains("Dvt") Then
            If DrReturn.Table.Columns.Contains("Dvt") Then
                Dv_DetailTmp.Item(iRow).Item("Dvt") = DrReturn("Dvt").ToString.Trim
            Else
                Dv_DetailTmp.Item(iRow).Item("Dvt") = CyberSmodb.SQLGetvalue(AppConn, "Dvt", "DmCc", "(Ma_Cc = N'" + DrReturn("Ma_Cc").ToString.Trim + "')", CyberSmlib)
            End If
        End If
    ...
    Private Sub L_Ma_Cc(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dv_DetailTmp.Item(iRow).Item("Ma_Nx_I") = IIf(Dv_DetailTmp.Item(iRow).Item("Ma_Nx_I").ToString.Trim = "", _TK_TT, Dv_DetailTmp.Item(iRow).Item("Ma_Nx_I").ToString.Trim)
    ...
    Private Sub L_Ma_Kho_i(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        V_SetSD(iRow)
    End Sub
    Private Sub V_Ma_ViTriCC(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        CyberSupport.V_Lookup("Ma_ViTriCC", "DmViTriCC", "1=1", "1=1", M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_ViTriCC(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim iRow As Integer = -1
        iRow = DetailGRV.GetFocusedDataSourceRowIndex
        If iRow < 0 Then Exit Sub
        DrReturn = CyberSupport.L_Lookup(M_Mode, M_Ma_CT, sender, True)
        If DrReturn Is Nothing Then
            Dv_DetailTmp.Item(iRow)("Ma_ViTriCC") = ""
            Dv_DetailTmp.Item(iRow)("Ten_ViTriCC") = ""
            Exit Sub
        End If
        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dv_DetailTmp.Item(iRow).Item("Ma_ViTriCC") = DrReturn("Ma_ViTriCC").ToString.Trim
        Dv_DetailTmp.Item(iRow).Item("Ten_ViTriCC") = DrReturn("Ten_ViTriCC").ToString.Trim
        Dv_DetailTmp.Item(iRow).EndEdit()
        DetailGRV.UpdateCurrentRow()
    End Sub
    Private Sub V_TinhToanPB(ByVal iRow As Integer)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If iRow < 0 Then Exit Sub

        Dim _Dt As Date = TxtNgay_Ct.Value
        Dim _Ma_Cc As String = Dv_DetailTmp.Item(iRow).Item("Ma_Cc").ToString.Trim
        Dim _Ma_CTCc As String = Dv_DetailTmp.Item(iRow).Item("Ma_CTCc").ToString.Trim
        Dim _Ma_TTCP As String = CmbMa_TTCP_H.SelectedValue.ToString.Trim
        Dim _Ma_GD As String = CmbMa_GD.SelectedValue.ToString.Trim

        Dim _DsPB As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_ImTinhToanPB", _Dt.ToString("yyyyMMdd") & "#" & _Ma_CTCc & "#" & _Ma_Cc & "#" & _Ma_TTCP & "#" & _Ma_GD & "#" & M_Mode.Trim & "#" & M_Stt_Rec.Trim & "#" & M_Ma_Dvcs.Trim & "#" & M_User_Name.Trim)

        If _DsPB.Tables.Count < 1 Then
            _DsPB.Dispose()
            Exit Sub
        End If

        If _DsPB.Tables(0).Rows.Count < 1 Then
            _DsPB.Dispose()
            Exit Sub
        End If

        If _DsPB.Tables(0).Columns.Contains("So_Luong") Then Dv_DetailTmp.Item(iRow).Item("So_Luong") = _DsPB.Tables(0).Rows(0).Item("So_Luong")
        If _DsPB.Tables(0).Columns.Contains("Nguyen_Gia") Then Dv_DetailTmp.Item(iRow).Item("Nguyen_Gia") = _DsPB.Tables(0).Rows(0).Item("Nguyen_Gia")
        If _DsPB.Tables(0).Columns.Contains("GT_Da_PB") Then Dv_DetailTmp.Item(iRow).Item("GT_Da_PB") = _DsPB.Tables(0).Rows(0).Item("GT_Da_PB")
        If _DsPB.Tables(0).Columns.Contains("Gia") Then Dv_DetailTmp.Item(iRow).Item("Gia") = _DsPB.Tables(0).Rows(0).Item("Gia")
        If _DsPB.Tables(0).Columns.Contains("Tien") Then Dv_DetailTmp.Item(iRow).Item("Tien") = _DsPB.Tables(0).Rows(0).Item("Tien")
        If _DsPB.Tables(0).Columns.Contains("Gia_Nt") Then Dv_DetailTmp.Item(iRow).Item("Gia_Nt") = _DsPB.Tables(0).Rows(0).Item("Gia_Nt")
        If _DsPB.Tables(0).Columns.Contains("Tien_Nt") Then Dv_DetailTmp.Item(iRow).Item("Tien_Nt") = _DsPB.Tables(0).Rows(0).Item("Tien_Nt")

        If _DsPB.Tables(0).Columns.Contains("So_Ky_PB_QD") Then Dv_DetailTmp.Item(iRow).Item("So_Ky_PB_QD") = _DsPB.Tables(0).Rows(0).Item("So_Ky_PB_QD")
        If _DsPB.Tables(0).Columns.Contains("So_Ky_Da_PB") Then Dv_DetailTmp.Item(iRow).Item("So_Ky_Da_PB") = _DsPB.Tables(0).Rows(0).Item("So_Ky_Da_PB")
        If _DsPB.Tables(0).Columns.Contains("So_Ky_PB") Then Dv_DetailTmp.Item(iRow).Item("So_Ky_PB") = _DsPB.Tables(0).Rows(0).Item("So_Ky_PB")
        If _DsPB.Tables(0).Columns.Contains("GT_PB_KyNt") Then Dv_DetailTmp.Item(iRow).Item("GT_PB_KyNt") = _DsPB.Tables(0).Rows(0).Item("GT_PB_KyNt")
        If _DsPB.Tables(0).Columns.Contains("GT_PB_Ky") Then Dv_DetailTmp.Item(iRow).Item("GT_PB_Ky") = _DsPB.Tables(0).Rows(0).Item("GT_PB_Ky")

        If _DsPB.Tables(0).Columns.Contains("Nguyen_Gia_HC") Then Dv_DetailTmp.Item(iRow).Item("Nguyen_Gia_HC") = _DsPB.Tables(0).Rows(0).Item("Nguyen_Gia_HC")
        If _DsPB.Tables(0).Columns.Contains("GT_Da_PB_HC") Then Dv_DetailTmp.Item(iRow).Item("GT_Da_PB_HC") = _DsPB.Tables(0).Rows(0).Item("GT_Da_PB_HC")
        If _DsPB.Tables(0).Columns.Contains("Gia_HC") Then Dv_DetailTmp.Item(iRow).Item("Gia_HC") = _DsPB.Tables(0).Rows(0).Item("Gia_HC")
        If _DsPB.Tables(0).Columns.Contains("Tien_HC") Then Dv_DetailTmp.Item(iRow).Item("Tien_HC") = _DsPB.Tables(0).Rows(0).Item("Tien_HC")

        If _DsPB.Tables(0).Columns.Contains("So_Ky_PB_QD_HC") Then Dv_DetailTmp.Item(iRow).Item("So_Ky_PB_QD_HC") = _DsPB.Tables(0).Rows(0).Item("So_Ky_PB_QD_HC")
        If _DsPB.Tables(0).Columns.Contains("So_Ky_Da_PB_HC") Then Dv_DetailTmp.Item(iRow).Item("So_Ky_Da_PB_HC") = _DsPB.Tables(0).Rows(0).Item("So_Ky_Da_PB_HC")
        If _DsPB.Tables(0).Columns.Contains("So_Ky_PB_HC") Then Dv_DetailTmp.Item(iRow).Item("So_Ky_PB_HC") = _DsPB.Tables(0).Rows(0).Item("So_Ky_PB_HC")
        If _DsPB.Tables(0).Columns.Contains("GT_PB_Ky_HC") Then Dv_DetailTmp.Item(iRow).Item("GT_PB_Ky_HC") = _DsPB.Tables(0).Rows(0).Item("GT_PB_Ky_HC")

        If _DsPB.Tables(0).Columns.Contains("Tk_Cc") Then Dv_DetailTmp.Item(iRow).Item("Tk_Vt") = _DsPB.Tables(0).Rows(0).Item("Tk_Cc")
        If _DsPB.Tables(0).Columns.Contains("Ma_Nx_I") Then Dv_DetailTmp.Item(iRow).Item("Ma_Nx_I") = _DsPB.Tables(0).Rows(0).Item("Ma_Nx_I")
        If _DsPB.Tables(0).Columns.Contains("Tk_CP") Then Dv_DetailTmp.Item(iRow).Item("Tk_CP") = _DsPB.Tables(0).Rows(0).Item("Tk_CP")
        If _DsPB.Tables(0).Columns.Contains("Ma_Phi_i") Then Dv_DetailTmp.Item(iRow).Item("Ma_Phi_i") = _DsPB.Tables(0).Rows(0).Item("Ma_Phi_i")
        If _DsPB.Tables(0).Columns.Contains("Ten_Phi_i") Then Dv_DetailTmp.Item(iRow).Item("Ten_Phi_i") = _DsPB.Tables(0).Rows(0).Item("Ten_Phi_i")
    End Sub
    Private Sub V_SetSD(ByVal iRow As Integer)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If iRow < 0 Then Exit Sub
        Dim _Date As Date = TxtNgay_Ct.Value

        Dim _Ma_TTCP As String = CmbMa_TTCP_H.SelectedValue
        Dim _Ma_Kho As String = Dv_DetailTmp.Item(iRow).Item("Ma_Kho_I").ToString.Trim
        Dim _Ma_Cc As String = Dv_DetailTmp.Item(iRow).Item("Ma_Cc").ToString.Trim
        Dim _Ma_CTCc As String = Dv_DetailTmp.Item(iRow).Item("Ma_CTCc").ToString.Trim

        Dim _DsTon As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_TinhTonKhoCc", M_Stt_Rec.Trim & "#" & M_Ma_CT.Trim & "#" & _Date.ToString("yyyyMMdd") & "#" & M_Mode.Trim & "#" & _Ma_CTCc.Trim & "#" & _Ma_Cc.Trim & "#" & _Ma_TTCP.Trim & "#" & _Ma_Kho.Trim & "#" & M_Ma_Dvcs.Trim & "#" & M_User_Name.Trim)

        If _DsTon.Tables.Count < 1 Then
            _DsTon.Dispose()
            Exit Sub
        End If
        If _DsTon.Tables(0).Rows.Count < 1 Then
            _DsTon.Dispose()
            Exit Sub
        End If
        ...
        If Dv_DetailTmp.Table.Columns.Contains("Ton13") Then
            Dv_DetailTmp.Item(iRow).BeginEdit()
            Dv_DetailTmp.Item(iRow).Item("Ton13") = _DsTon.Tables(0).Rows(0).Item("Ton13")
            Dv_DetailTmp.Item(iRow).EndEdit()
        End If
    End Sub
#End Region
...
#Region "Button"
    ...
    Private Sub V_Save_Luu(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        CyberInput.V_Save_Default_TTCP(Dt_DetailVaTTmp, M_Is_Visible_TTCP, CmbMa_TTCP_H, M_Ma_CT, CyberSmodb)
        '----------------------------------------------------------------------------------------------------------------------
        If Not CyberSupport.ChkVoucherInput(Me, AppConn, osysvar, M_LAN, DrDmct, M_Mode, M_Ma_CT, _Ngay_Ct, CmbMa_GD.SelectedValue, M_Stt_Rec, CbbMa_Post.SelectedValue, M_Ma_Dvcs, M_User_Name, Dt_DetailTmp, "Ten_Tk,TEN_KH", "Ten_Cc,TEN_KHO_I", CyberSmlib, CyberSupport, CyberSmodb, CyberLoading) Then Exit Sub
        '----------------------------------------------------------------------------------------------------------------------
        If Not CyberSupport.V_ChkExistNovoucher(AppConn, osysvar, M_LAN, DrDmct, M_Mode, M_Stt_Rec, M_Ma_CT, TxtSo_Ct.Text.Trim, _Ngay_Ct, _Ngay_LCt, M_Ma_Dvcs, M_User_Name, CyberSmlib) Then Exit Sub '---Kiem tra trung so chung tu
        '----------------------------------------------------------------------------------------------------------------------
    ...
    Private Sub V_New()
        If Dt_DetailTmp.Rows.Count < 1 Then
            ...
            DrCurren.Item("Ngay_Pb_HC") = TxtNgay_Ct.Value
...
#Region "Sms - Import"
    ...
    Private Sub SetTxt()
        ...
        TxtMa_BP_H.ReadOnly = True
        TxtTen_BP_H.ReadOnly = True
        TxtMa_TD2_H.ReadOnly = True
        TxtTen_TD2_H.ReadOnly = True

        TxtTen_Hs_N.ReadOnly = True
        TxtMa_BP_N.ReadOnly = True
        TxtTen_BP_N.ReadOnly = True
        TxtMa_TD2_N.ReadOnly = True
        TxtTen_TD2_N.ReadOnly = True

        TxtT_So_Luong.ReadOnly = True
        TxtT_Tien_NT.ReadOnly = True
        TxtT_Tien.ReadOnly = True
        TxtT_Tien_HC.ReadOnly = True
    End Sub
#End Region
#Region "TTCP Default and New/Save _TTCP"
    ...
    Private Sub V_LoadDefault()
        ...
        If M_Is_Visible_TTCP Then
            ...
            If DsTmp.Tables(4).Columns.Contains("Ma_HS_H") Then M_Ma_HS_H = DsTmp.Tables(4).Rows(0).Item("Ma_HS_H").ToString.Trim
            If DsTmp.Tables(4).Columns.Contains("Ten_HS_H") Then M_Ten_HS_H = DsTmp.Tables(4).Rows(0).Item("Ten_HS_H").ToString.Trim
            If DsTmp.Tables(4).Columns.Contains("Ten_HS2_H") Then M_Ten_HS2_H = DsTmp.Tables(4).Rows(0).Item("Ten_HS2_H").ToString.Trim

            If DsTmp.Tables(4).Columns.Contains("Ma_BP_H") Then M_Ma_BP_H = DsTmp.Tables(4).Rows(0).Item("Ma_BP_H").ToString.Trim
            If DsTmp.Tables(4).Columns.Contains("Ten_BP_H") Then M_Ten_BP_H = DsTmp.Tables(4).Rows(0).Item("Ten_BP_H").ToString.Trim
            If DsTmp.Tables(4).Columns.Contains("Ten_BP2_H") Then M_Ten_BP2_H = DsTmp.Tables(4).Rows(0).Item("Ten_BP2_H").ToString.Trim
