...
Public Class PC1_PT1_Loc
    ...
    Sub V_Loaddatatabase(ByVal Status As String)
        ...
        Dim _DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetdetailFromPC1PT1", Status + "#" + "2" + "#" & M_Stt_rec & "#" & M_ma_Ct & "#" & _Dt1.ToString("yyyyMMdd") & "#" & _Dt2.ToString("yyyyMMdd") & "#" & M_Mode & "#" & strFiled & "#" & strValues & "#" & M_Ma_Dvcs & "#" & M_User_Name)
        ...
        For iRow = 0 To DvTable1.Count - 1
            If DvTable1.Item(iRow).Item("Tag").ToString.Trim = "True" Then
                For i = 0 To DvTable2.Count - 1
                    ...
                    If (DvTable2.Item(i).Item("Tag").ToString.Trim = "1" Or DvTable2.Item(i).Item("Tag").ToString.Trim = "True") And DvTable2.Item(i).Item("Stt_Rec").ToString.Trim = DvTable1.Item(iRow).Item("Stt_Rec").ToString.Trim Then
