...
#Region "Valid - Detail - Core"
    Private Sub UpdateList()
        ...
        Dim nT_Tien20 As Decimal = 0
        For iRow As Integer = 0 To Dv_DetailTmp.Count - 1
            nT_Tien2 = nT_Tien2 + Dv_DetailTmp.Item(iRow).Item("Tien2")
            nT_Tien20 = nT_Tien20 + Dv_DetailTmp.Item(iRow).Item("Tien20")
        Next
        TxtT_Tien20.Double = nT_Tien20
...
#Region "Button"
    Private Sub V_LocDL(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Dim DsTmp As New DataSet, nCount As Integer = 0
        Dim d1 As Date = TxtNgay_1.Value, d2 As Date = TxtNgay_2.Value
        DsTmp = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_ROGetInfoHDK4PCP", d1.ToString("yyyyMMdd").Trim & "#" & d2.ToString("yyyyMMdd").Trim & "#" & M_Mode & "#" & M_Stt_Rec & "#" & M_Ma_Dvcs & "#" & M_User_Name)
    ...
    Private Function ChkVsave() As Boolean
        ...
        For iRow = 0 To Dt_DetailTmp.Rows.Count - 1
            ...
            Dt_DetailTmp.Rows(iRow).Item("Ma_Post") = CbbMa_Post.SelectedValue.Trim
            Dt_DetailTmp.Rows(iRow).Item("Ma_GD") = M_Ma_GD.Trim
