...
#Region "Load - "
    ...
    Private Sub V_Load()
        ...
        If TxtMa_BH.Text = "" Then TxtTen_BH.Text = "" Else TxtTen_BH.Text = CyberSmodb.SQLGetvalue(AppConn, "Ten_BH", "DmBH", "Ma_BH = '" & TxtMa_BH.Text.Trim & "'")
        If TxtMa_Hs.Text = "" Then TxtTen_Hs.Text = "" Else TxtTen_Hs.Text = CyberSmodb.SQLGetvalue(AppConn, "Ten_Hs", "DmHs", "Ma_Hs = '" & TxtMa_Hs.Text.Trim & "'")
    ...
    Private Sub V_LoadDatabase(ByVal Status As String)
        ...
        Dim DsLenh_RO As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetTBHToLDN", Status & "#" & M_Ma_GD & "#" & "" & "#" &
                                                                    _Ngay_Ct1.ToString("yyyyMMdd") & "#" + _Ngay_Ct2.ToString("yyyyMMdd") & "#" & _Ma_Post + "#" &
                                                                    M_Stt_rec & "#" & M_Ma_Ct & "#" & M_Mode & "#" & "" & "#" & TxtMa_BH.Text & "#" &
                                                                    TxtLenh_RO.Text & "#" & TxtMa_Hs.Text.Trim & "#" & M_Ma_Dvcs & "#" & M_User_Name)
