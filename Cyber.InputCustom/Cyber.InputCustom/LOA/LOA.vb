...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_System()
        ...
        AddHandler CmdDoi_TVBH.Click, AddressOf V_Doi_TVBH
    ...
    Private Sub V_AddHandler_Master()
        ...
        '--Ma_BP_New
        AddHandler TxtMa_BP_New.CyberValiting, AddressOf V_Ma_BP_New
        AddHandler TxtMa_BP_New.CyberLeave, AddressOf L_Ma_BP_New
        '--Ma_HS_H
        ...
        AddHandler TxtMa_Hs_New.CyberValiting, AddressOf V_Ma_HS_New
        AddHandler TxtMa_Hs_New.CyberLeave, AddressOf L_Ma_HS_New
        '----------------------------------------------------------------------------------------------------------
...
#Region "Valid --- Ma_BP_H"
    ...
    Private Sub V_Ma_BP_New(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        TxtMa_BP_New.V_LookUp(M_LAN, M_Para, osysvar, AppConn, DsLookup, "Ma_BP", "DmBP", "1=1", "1=1")
    End Sub
    Private Sub L_Ma_BP_New(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If TxtMa_BP_New.Text = "" Then
            txtTen_BP_H.Text = ""
            Exit Sub
        End If
        DrReturn = TxtMa_BP_New.GetRowsSelectData(True)
        If Not DrReturn Is Nothing Then
            TxtMa_BP_New.Text = DrReturn.Item("Ma_BP")
            TxtTen_BP_New.Text = DrReturn.Item("Ten_BP")
        Else
            TxtMa_BP_New.Text = ""
            TxtTen_BP_New.Text = ""
        End If
...
#Region "Valid --- Ma_HD_H"
    ...
    Private Sub L_Ma_HD_H(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        ...
        If Not DrReturn Is Nothing Then
            ...
            TxtMa_Hs_Old.Text = DrReturn.Item("Ma_HsKd")
            TxtTen_HS_Old.Text = CyberSmodb.SQLGetvalue(AppConn, "Ten_Hs", "DmHs", "Ma_Hs = N'" + TxtMa_Hs_Old.Text.Trim + "'", CyberSmlib)
            TxtStt_Rec_Old.Text = CyberSmodb.SQLGetvalue(AppConn, "Stt_Rec", "PHHDX", "Ma_Hd_H = N'" + TxtMa_HD_H.Text.Trim + "'", CyberSmlib)
        Else
            TxtMa_HD_H.Text = ""
            TxtTen_Hd_H.Text = ""
            TxtMa_Hs_Old.Text = ""
    ...
    End Sub
#End Region
#Region "Valid --- Ma_HS_New"
    Private Sub V_Ma_HS_New(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        TxtMa_Hs_New.V_LookUp(M_LAN, M_Para, osysvar, AppConn, DsLookup, "Ma_HS", "DmHS", "Ma_Hs <> '" & TxtMa_Hs_Old.Text & "'", "1=1")
    End Sub
    Private Sub L_Ma_HS_New(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If TxtMa_Hs_New.Text = "" Then
            TxtTen_Hs_New.Text = ""
            Exit Sub
        End If
        DrReturn = TxtMa_Hs_New.GetRowsSelectData(True)
        If Not DrReturn Is Nothing Then
            TxtMa_Hs_New.Text = DrReturn.Item("Ma_HS")
            TxtTen_Hs_New.Text = DrReturn.Item("Ten_HS")
            TxtMa_BP_New.Text = DrReturn.Item("Ma_BP")
        Else
            TxtMa_Hs_New.Text = ""
            TxtTen_Hs_New.Text = ""
...
#Region "Sms - Import"
    Private Sub V_Import(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dt_DetailTmp.AcceptChanges()
    End Sub
    Private Sub V_Doi_TVBH(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If M_Stt_Rec.Trim = "" Then Exit Sub
        If M_Mode = "S" Or M_Mode = "M" Then Exit Sub
        If MsgBox("Bạn có chắc chắn đổi TVBH từ " + TxtTen_HS_Old.Text.Trim + " thành " + TxtTen_Hs_New.Text.Trim + " của hợp đồng " + TxtMa_HD_H.Text.Trim + " - " + TxtTen_Hd_H.Text.Trim + " không?", MsgBoxStyle.Information + MsgBoxStyle.OkCancel, osysvar("M_CYBER_VER")) = MsgBoxResult.Cancel Then
            Exit Sub
        End If
        Dim M_strParameterStore As String = M_Stt_Rec.Trim
        M_strParameterStore = M_strParameterStore & "#" & TxtMa_HD_H.Text.Trim
        M_strParameterStore = M_strParameterStore & "#" & TxtMa_Hs_Old.Text.Trim
        M_strParameterStore = M_strParameterStore & "#" & TxtMa_Hs_New.Text.Trim
        M_strParameterStore = M_strParameterStore & "#" & TxtMa_BP_New.Text.Trim
        ...
        CyberSupport.V_MsgChk(DsTmp.Tables(0), SysVar, M_LAN)
        DsTmp.Dispose()
    End Sub
    Private Sub SetTxt()
        'TxtT_SO_LUONG.ReadOnly = True
