...
Public Class HDI_Loc
    ...
    Sub V_Loaddatatabase(ByVal Status As String)
        ...
        Dim _DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetdetailFromHDI", Status + "#" + "2" + "#" & M_Stt_rec & "#" & M_ma_Ct & "#" & _Dt1.ToString("yyyyMMdd") & "#" & _Dt2.ToString("yyyyMMdd") & "#" & M_Mode & "#" & strFiled & "#" & strValues & "#" & M_Ma_Dvcs & "#" & M_User_Name)
