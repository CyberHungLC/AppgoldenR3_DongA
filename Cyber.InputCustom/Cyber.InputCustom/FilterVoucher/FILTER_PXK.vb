...
Public Class FILTER_PXK
    ...
    Private Sub V_Addhander()
        ...
        RemoveHandler TxtSo_Ro.Leave, AddressOf V_So_Ro
    ...
    Private Sub V_So_RO(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        TxtSo_Ro.Text = CyberVoucher.V_FormatSo_Ro(AppConn, osysvar, "HDK", _Ma_GD, "M", _Dt, TxtSo_Ro.Text, _Ma_TTCP, M_Ma_Dvcs, M_User_Name, CyberSmlib)
