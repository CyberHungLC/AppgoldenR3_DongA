...
#Region "Columns Edit"
    ...
    Dim EditTk_No, EditTk_Co, EditMa_So, Editke_hoach, EditMa_ChiTieu, EditDien_Giaii, EditSo_So, EditSo_Po, EditSo_Ro, EditSo_VT, EditNh_Cv1, EditNh_Cv2, EditNh_Cv3, EditNh_VT1, EditNh_VT2, EditNh_VT3, EditNh_KH1, EditNh_KH2, EditNh_KH3 As New Cyber.Fill.CyberColumnGridView 'DevExpress.XtraEditors.Repository.RepositoryItemTextEdit
#End Region
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Detail()
        ...
        EditMa_So.V_ActiLookUpColumn(AddressOf V_Ma_ChiTieu, AddressOf L_Ma_ChiTieu)
        EditMa_ChiTieu.V_ActiLookUpColumn(AddressOf V_Ma_ChiTieu, AddressOf L_Ma_ChiTieu)
...
#Region "Valid - Detail - Core"
    ...
    Private Sub V_Ma_ChiTieu(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        CyberSupport.V_Lookup("Ma_ChiTieu", "DmKHM", "1=1", "1=1", M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_ChiTieu(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim iRow As Integer = -1
        iRow = DetailGRV.GetFocusedDataSourceRowIndex
        If iRow < 0 Then Exit Sub
        ...
        If DrReturn Is Nothing Then
            Dv_DetailTmp.Item(iRow)("Ma_So") = ""
            Exit Sub
        End If
        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dv_DetailTmp.Item(iRow).Item("Ma_So") = DrReturn("Ma_ChiTieu").ToString.Trim
        Dv_DetailTmp.Item(iRow).Item("Chi_Tieu") = DrReturn("Ten_ChiTieu").ToString.Trim
