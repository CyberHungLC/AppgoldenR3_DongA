...
#Region "Columns Edit"
    ...
    Dim EditTen_Vt, EditDvt, EditTen_Kho_i, EditTen_Tk_VT, EditSo_Luong, EditGia_NT0, EditGia0, EditGia_NT, EditTien_NT0, EditTien0, EditCP_NT, EditCP, EditGia, EditTien_NT, EditTien, EditDien_Giaii, EditSo_So, EditSo_Po, EditSo_Ro, EditSo_VT As New Cyber.Fill.CyberColumnGridView
#End Region
...
#Region "Load And Set And Default"
    Private Sub V_LoadNew(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        CmbMa_TTCP_H.SelectedValue = _Para_Ma_TTCP_H
        L_Lenh_Ro(sender, e)
        TxtLenh_RO.Focus()
    End Sub
    Private Sub V_Load()
    ...
    Private Sub V_AddVat(ByRef _DtVat As DataTable, ByVal _Ma_Post As String, ByVal _Ngay_Ct As Date, ByVal _Ngay_LCt As Date, ByVal _Ma_NT As String, ByVal _Ty_GIa As Decimal)
        ...
        If nCountSo_Detail = nCountSo_Hd_Gtgt And nCountSo_Hd_Gtgt > 1 Then
            For iRow As Integer = 0 To nCountSo_Detail - 1
                ...
                If nCountSo_Detail > 0 Then _DrVat.Item("So_RO") = Dt_DetailTmp.Rows(iRow).Item("So_RO")
        ...
        Else
            ...
            If nCountSo_Detail > 0 Then _DrVat.Item("So_RO") = Dt_DetailTmp.Rows(0).Item("So_RO")
            _DtVat.Rows.Add(_DrVat)
...
#Region "Lenh/SO/Po/Ro/Vt"
    ...
    Private Sub L_Lenh_Ro(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        _Ma_TTCP = CmbMa_TTCP_H.SelectedValue
        If _Ma_TTCP = "" Then Exit Sub
        TxtLenh_RO.Text = CyberVoucher.V_FormatSo_Ro(AppConn, osysvar, "HDK", _Ma_GD, "M", _Dt, TxtLenh_RO.Text, _Ma_TTCP, M_Ma_Dvcs, M_User_Name, CyberSmlib)
    ...
    Private Sub GetDetail()
        ...
        DsTmpDetal = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetPNADetail", TxtLenh_RO.Text.Trim + "#" + dt.ToString("yyyyMMdd") + "#" +
            M_Ma_CT.Trim + "#" + TxtSo_Ct.Text + "#" + CbbMa_Post.SelectedValue.Trim + "#" + M_Stt_Rec.Trim + "#" + M_Mode + "#" +
             "" + "#" + TxtMa_Kh.Text + "#" + TxtDia_Chi.Text + "#" + TxtOng_Ba.Text + "#" + M_Ma_Dvcs.Trim + "#" + M_User_Name)
        ...
        If DsTmpDetal.Tables(2).Columns.Contains("Dien_giai") Then TxtDien_Giai.Text = DsTmpDetal.Tables(2).Rows(0).Item("Dien_giai")
        DsTmpDetal.Dispose()
...
#Region "Vat tu kho/Vitri - "
    ...
    Private Sub L_Ma_Vt(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Dv_DetailTmp.Item(iRow).Item("Ma_KHo_I").ToString.Trim = "" Then Dv_DetailTmp.Item(iRow).Item("Ma_KHo_I") = _Ma_kho
    ...
    Private Sub V_SetPricePurChase(ByVal iRow As Integer)
        ...
        If _DtGia.Columns.Contains("Ten_VT") Then Dv_DetailTmp.Item(iRow).Item("Ten_VT") = _DtGia.Rows(0).Item("Ten_VT")
        If _DtGia.Columns.Contains("Ma_Kho") And Dv_DetailTmp.Item(iRow).Item("Ma_Kho_I") = "" Then Dv_DetailTmp.Item(iRow).Item("Ma_Kho_I") = _DtGia.Rows(0).Item("Ma_kho")
        If _DtGia.Columns.Contains("DVT") Then Dv_DetailTmp.Item(iRow).Item("DVT") = _DtGia.Rows(0).Item("DVT")
...
#Region "Xử lý Barcode"
    ...
    Private Sub L_Ma_Barcode()
        ...
        For iRow = nCount - 1 To 0 Step -1
            If Dt_DetailTmp.Rows(iRow).Item("Ma_VT").ToString.Trim = TxtMa_BarCode.Text.Trim Then
                chkVT = 1
        ...
        For iRow = nCount - 1 To 0 Step -1
            ...
            Else
                If chkVT = 0 Then
                    If Dt_DetailTmp.Rows(iRow).Item("Ma_VT").ToString.Trim = "" Then
                        Dt_DetailTmp.Rows(iRow).Item("Ma_VT") = TxtMa_BarCode.Text.Trim
                        Dt_DetailTmp.Rows(iRow).Item("So_Luong") = 1
                        Dim iRowNew As Integer = DetailGRV.FocusedRowHandle
                        V_AddItem(iRowNew)
                        Dt_DetailTmp.AcceptChanges()
                    End If
