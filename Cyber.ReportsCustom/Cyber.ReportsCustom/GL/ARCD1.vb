...
#Region "Load"
    ...
    Private Sub V_Addhander()
        ...
        ''Ma_TTCP
        'AddHandler CmbMa_TTCP.CyberValiting, AddressOf V_Ma_TTCP
        'AddHandler CmbMa_TTCP.CyberLeave, AddressOf L_Ma_TTCP
    End Sub
#End Region
#Region "Valid"
#Region "Valid --- Tk"
...
#End Region
    ...
    '        CmbMa_TTCP.V_LookUp(Me.LAN, Me.Para, Me.sysvar, AppConn, DsLookup, "Ma_TTCP", "DMTTCP", "1=1", "1=1")
    '    End Sub
    '    Private Sub L_Ma_TTCP(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
    '        DrReturn = CmbMa_TTCP.GetRowsSelectData(True)
    '        If Not DrReturn Is Nothing Then
    '            CmbMa_TTCP.Text = DrReturn.Item("Ma_TTCP")
