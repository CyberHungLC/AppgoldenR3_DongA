...
#Region "Load - "
    ...
    Private Sub V_LoadDatabase(ByVal Status As String)
        ...
        _Loai_Phieu = "2"
        'End If
        Dim DsLenh_RO As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetdetailHD3Default", Status + "#" + _Loai_Phieu + "#" & M_Stt_rec & "#" & M_Ma_Ct & "#" & _Ngay_Ct1.ToString("yyyyMMdd") & "#" & _Ngay_Ct2.ToString("yyyyMMdd") & "#" & M_Mode & "#" & _Is_BG & "#" & strFiled & "#" & strValues & "#" & M_Ma_Dvcs & "#" & M_User_Name)
    ...
    Private Sub V_LoadHeaderGridview()
        Dim DsHeader As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetDetailHeadHD3", M_Ma_Ct.Trim + "#" + M_User_Name)
        '========== Fill datatable
...
#End Region
    ...
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        For i As Integer = 0 To dtMasterRo.Rows.Count - 1
            ...
            Next
        Next
        Is_ALL_Thue = ChkIs_All_Thue.Checked
