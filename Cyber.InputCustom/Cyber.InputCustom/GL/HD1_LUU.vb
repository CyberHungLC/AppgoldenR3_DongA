...
#Region "Columns Edit"
    ...
    Dim EditMa_KH_I, EditMa_Vv_I, EditMa_phi_i, EditMa_HD_I, EditMa_THue_I, EditThue_SuatI, EditThue_NT, EditMa_Sp_I, EditMa_ku_I, EditMa_TTLN_i, EditMa_TTCP_i, EditMa_BP_I, EditMa_HS_I, EditMa_CD_I, EditMa_TD1_I, EditMa_TD2_I, EditMa_TD3_I, EditMa_TD4_I, EditMa_TD5_I As New Cyber.Fill.CyberColumnGridView 'Cyber.SmLists.EditLookUp
...
#Region "Load And Set And Default"
    ...
    Private Sub V_GetColumn()
        ...
        EditMa_THue_I.GetColumn(DetailGRV, "Ma_Thue_i")
        EditThue_SuatI.GetColumn(DetailGRV, "Thue_Suati")
...
#Region "Valid --- Ma_KH"
    ...
    Private Sub L_Ma_KH(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        ...
        If Not DrReturn Is Nothing Then
            ...
            If DrReturn.Table.Columns.Contains("Ma_So_Thue") Then TxtMa_So_Thue.Text = DrReturn.Item("Ma_So_Thue")
            If DrReturn.Table.Columns.Contains("ten_KhVAT") Then TxtTen_KhVAT.Text = DrReturn.Item("ten_KhVAT")
            If DrReturn.Table.Columns.Contains("Dia_ChiVAT") Then TxtDia_ChiVAT.Text = DrReturn.Item("Dia_ChiVAT")
    ...
    Private Sub L_T_CK_NT(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Else
            ...
            For iRow As Integer = 0 To Dv_DetailTmp.Count - 1
                ...
                If Dv_DetailTmp.Item(iRow).Item("Tien_NT2") * Dv_DetailTmp.Item(iRow).Item("Thue_SuatI") <> 0 Then
                    Dv_DetailTmp.Item(iRow).BeginEdit()
                    Dv_DetailTmp.Item(iRow).Item("Thue_NT") = CyberSupport.V_Round((Dv_DetailTmp.Item(iRow).Item("Tien_NT2") - Dv_DetailTmp.Item(iRow).Item("CK_NT")) * Dv_DetailTmp.Item(iRow).Item("Thue_SuatI") / 100, M_R_TIEN_NT)
