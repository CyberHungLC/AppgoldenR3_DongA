...
#Region "Load - "
    ...
    Private Sub V_Load()
        ...
        CyberFill.V_FillComBoxValue(CmbMa_TT, tbDmTT, "Ma_TT", "Ten_TT", "C")
        V_LoadDatabase("1")
    End Sub
    Private Sub V_LoadDatabase(ByVal Status As String)
        ...
        Dim _TK_Co, _Ma_HD, _So_Ro As String
        ...
        Dim DsLenh_RO As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetdetailTBHFFromHDS_2", Status & "#" & _Loai & "#" & CmbMa_TT.SelectedValue.ToString() & "#" & _Ngay_Ct1.ToString("yyyyMMdd") & "#" + _
                                                                  _Ngay_Ct2.ToString("yyyyMMdd") & "#" & _Ma_Post + "#" & _
                                                                  M_Stt_rec & "#" & M_Ma_Ct & "#" & M_Mode & "#" & _TK_Co & "#" & TxtMa_KH.Text & "#" & _Ma_HD & "#" & _So_Ro & "#" & _
                                                                  M_Ma_Dvcs & "#" & M_User_Name)
