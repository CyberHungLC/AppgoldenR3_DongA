...
#Region "Load"
    ...
    Protected Overrides Sub V_Addhander()
        ...
        AddHandler TxtKm_BH.Leave, AddressOf V_Km_BH
        AddHandler TxtKm_BH_Min.Leave, AddressOf V_Km_BH
        AddHandler TxtKm_BH_Max.Leave, AddressOf V_Km_BH
        ...
        AddHandler TxtBh_Mr.Leave, AddressOf V_BH_MR
...
#Region "Vali Min_MAX"
    ...
    Private Sub V_Tien_NT(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If TxtNiem_Yet.Double = 0 Then TxtNiem_Yet.Double = TxtTien_NT.Double
        If TxtTien_NT.Double <> 0 Or TxtTien_NT.Double = 0 Then TxtNiem_Yet.Double = TxtTien_NT.Double
        'If TxtTien_NT.Double <> 0 Or TxtTien_NT.Double = 0 Then TxtTien_NT_Min.Double = TxtTien_NT.Double - TxtCk.Double - TxtKm_PK.Double - TxtKm_BH.Double - TxtKm_Khac.Double - TxtBh_Mr.Double
    End Sub
    ...
    Private Sub V_CK_I(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        'If TxtCk.Double <> 0 Or TxtCk.Double = 0 Then TxtTien_NT_Min.Double = TxtTien_NT.Double - TxtCk.Double - TxtKm_PK.Double - TxtKm_BH.Double - TxtKm_Khac.Double - TxtBh_Mr.Double
    End Sub
    Private Sub V_Km_PK(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        'If TxtKm_PK.Double <> 0 Or TxtKm_PK.Double = 0 Then TxtTien_NT_Min.Double = TxtTien_NT.Double - TxtCk.Double - TxtKm_PK.Double - TxtKm_BH.Double - TxtKm_Khac.Double - TxtBh_Mr.Double
    End Sub
    Private Sub V_Km_BH(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If TxtKm_BH_Min.Double > TxtKm_BH.Double And TxtKm_BH_Min.Double <> 0 Then TxtKm_BH_Min.Double = TxtKm_BH.Double
        If TxtKm_BH_Max.Double < TxtKm_BH.Double And TxtKm_BH_Max.Double <> 0 Then TxtKm_BH_Max.Double = TxtKm_BH.Double
        'If TxtKm_BH.Double <> 0 Or TxtKm_BH.Double = 0 Then TxtTien_NT_Min.Double = TxtTien_NT.Double - TxtCk.Double - TxtKm_PK.Double - TxtKm_BH.Double - TxtKm_Khac.Double - TxtBh_Mr.Double
    End Sub
    ...
    Private Sub V_Km_Khac(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If TxtKm_Khac.Double <> 0 Or TxtKm_Khac.Double = 0 Then TxtTien_NT_Min.Double = TxtTien_NT.Double - TxtCk.Double - TxtKm_PK.Double - TxtKm_BH.Double - TxtKm_Khac.Double - TxtBh_Mr.Double
    End Sub
    Private Sub V_BH_MR(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If TxtBh_Mr.Double <> 0 Or TxtBh_Mr.Double = 0 Then TxtTien_NT_Min.Double = TxtTien_NT.Double - TxtCk.Double - TxtKm_PK.Double - TxtKm_BH.Double - TxtKm_Khac.Double - TxtBh_Mr.Double
    End Sub
#End Region
#Region "Vali --- Ma_Kx"
    ...
    Private Sub V_GetGiaXeCoso()
        ...
        If Dstmp.Tables(1).Columns.Contains("Niem_Yet") Then TxtNiem_Yet.Double = Dstmp.Tables(1).Rows(0).Item("Niem_Yet")
...
#Region "Buuton"
    Protected Overrides Sub V_Save(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If TxtTen_CSBH.Text = "" Then
            TxtTen_CSBH.Text = "CS: " + TxtTen_Kx.Text + " - Màu: " + TxtTen_Mau.Text + " - SX " + Replace(TxtNam_Sx.Text, " ", "") + " - HL từ " + TxtNgay_HL1.Text
        End If
        CyberSmodb.AddValueToRow(Me.DrNew, Me)
        If Not CyberSmlistSys.SaveToSQLOfList(Appconn, oSysvar, Me, CyberSmodb, CyberSmlib, CyberSupport) Then Exit Sub
        'Update lại bỏ acti đi những chính sách cũ
        Dim _strF As String = ""
        Dim _strV As String = ""
        Dim _Ma_Kx As String = TxtMa_Kx.Text.Trim
        Dim _Ma_Mau As String = TxtMa_Mau.Text
        ...
        Dim _Ngay_HL2 As Date = TxtNgay_HL2.Value
        CyberSmodb.GetValueControler(Me, _strF, _strV, "Ten_Kx,Ten_Mau")
        Dim Dstmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(Appconn, "CP_BECSBHRemoveActi", Mode & "#" & _Ma_Kx & "#" & _Ma_Mau & "#" & TxtNam_Sx.Double.ToString.Trim & "#" &
                                                               _Ngay_HL1.ToString("yyyyMMdd") & "#" &
                                                             _Ngay_HL2.ToString("yyyyMMdd") & "#" &
                                                               _strF & "#" & _strV & "#" & M_Ma_Dvcs & "#" & M_User_Name)
        V_Tien_NT(sender, e)
