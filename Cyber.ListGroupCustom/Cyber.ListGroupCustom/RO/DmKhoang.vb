Public Class DmKhoang
    ...
    Private Sub FDMKH_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Cyber.ListGroupCustom.Sys.SetAutoCode(Appconn, Me.Tb_Name, Me.Mode, CyberSmlib, CyberSmodb, TxtMa_khoang, TxtNh_khoang1, TxtNh_khoang2, TxtNh_khoang3, TxtNh_khoang4, TxtNh_khoang5)
        _Load_TP = True
    End Sub
#Region "Load"
