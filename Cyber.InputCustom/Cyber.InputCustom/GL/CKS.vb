...
#End Region
#Region "Columns Edit"    
    Dim EditMa_Ct_S, EditMa_Vv_I, EditMa_Phi_i, EditMa_HD_I, EditMa_SP_I, EditMa_Ku_I, EditMa_TTLN_i, EditMa_TTCP_i, EditMa_BP_I, EditMa_HS_I, EditMa_CD_I, EditMa_TD1_I, EditMa_TD2_I, EditMa_TD3_I, EditMa_TD4_I, EditMa_TD5_I As New Cyber.Fill.CyberColumnGridView
...
#End Region
    Private Sub CKS_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
...
#Region "Load And Set And Default"
    ...
    Private Sub V_GetColumn()
        EditMa_Ct_s.GetColumn(DetailGRV, "Ma_Ct_S")
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Master()
        ...
        'Gio_HL
        AddHandler TxtGio_HL1.Leave, AddressOf V_Gio_HL1
        AddHandler TxtGio_HL2.Leave, AddressOf V_Gio_HL2
    ...
    Private Sub V_AddHandler_Detail()        
        ...
        EditMa_Ct_s.V_ActiLookUpColumn(AddressOf V_Ma_Ct_S, AddressOf L_Ma_Ct_S)
...
#End Region
#Region "Gio_HL1"
    Private Sub V_Gio_HL1(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        TxtGio_HL1.Text = CyberVoucher.V_GetTG(TxtGio_HL1.Text, 0)
    End Sub
#End Region
#Region "Gio_HL2"
    Private Sub V_Gio_HL2(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        TxtGio_HL2.Text = CyberVoucher.V_GetTG(TxtGio_HL2.Text, 0)
    End Sub
#End Region
...
#End Region
#Region "Ma_Ct_S"
    Private Sub V_Ma_Ct_S(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        CyberSupport.V_Lookup("Ma_Ct", "DmCt", "1=1", "1=1", M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_Ct_S(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim iRow As Integer = -1
        iRow = DetailGRV.GetFocusedDataSourceRowIndex
        If iRow < 0 Then Exit Sub
        ...
        If DrReturn Is Nothing Then
            Dv_DetailTmp.Item(iRow)("Ma_Ct_S") = ""
            Dv_DetailTmp.Item(iRow)("Ten_Ct_S") = ""
            Exit Sub
        End If
        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dv_DetailTmp.Item(iRow).Item("Ma_Ct_S") = DrReturn("Ma_Ct").ToString.Trim
        Dv_DetailTmp.Item(iRow).Item("Ten_Ct_S") = DrReturn("Ten_Ct").ToString.Trim
...
#Region "Button"
    ...
    Private Function ChkVsave() As Boolean
        ...
        For iRow = nCount - 1 To 0 Step -1
            If Dt_DetailTmp.Rows(iRow).Item("Ma_Ct_S").ToString.Trim = "" Then
        ...
        For iRow = 0 To Dt_DetailTmp.Rows.Count - 1
            ...
            If Dt_DetailTmp.Columns.Contains("Ma_Hs_I") And Dt_DetailTmp.Rows(iRow).Item("Ma_Hs_I") = "" And TxtMa_Hs_H.Text.Trim <> "" Then Dt_DetailTmp.Rows(iRow).Item("Ma_Hs_I") = TxtMa_Hs_H.Text.Trim            
            'If Dt_DetailTmp.Columns.Contains("Ma_TTCP_I") And Dt_DetailTmp.Rows(iRow).Item("Ma_TTCP_I") = "" And CmbMa_TTCP_H.SelectedValue.ToString.Trim <> "" Then Dt_DetailTmp.Rows(iRow).Item("Ma_TTCP_I") = CmbMa_TTCP_H.SelectedValue.ToString.Trim
    ...
    Private Sub V_New(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        '--> Lấy giờ Server
        Dim DsTG As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetGioHT", "M" & "#" & Date.Now.ToString("yyyyMMdd") + "#" + Date.Now.ToString("yyyyMMdd") & "#" & "" & "#" & "" & "#" & M_Ma_Dvcs & "#" & M_User_Name)
        If DsTG.Tables.Count < 1 Then Exit Sub
        If DsTG.Tables(0).Rows.Count < 1 Then Exit Sub
        TxtGio_HL1.Text = DsTG.Tables(0).Rows(0).Item("Gio_HT")
        TxtGio_HL2.Text = DsTG.Tables(0).Rows(0).Item("Gio_HT")

        TxtNgay_HL1.Value = New Date(1900, 1, 1)
        TxtNgay_HL2.Value = New Date(1900, 1, 1)
        TxtNgay_Ct1.Value = New Date(1900, 1, 1)
        TxtNgay_Ct2.Value = New Date(1900, 1, 1)
