...
Imports HDBAKVV01.vn.ehoadon.ws
Imports System.IO
Imports System.Text
...
Public Class Sys
    ...
    Dim BkavPartnerGUID As String '= "e517efd6-b1fa-4f2c-b2b9-f7af507671a2"
    Dim BkavPartnerToken As String '= "r9DfxTuwEwdbQIqIaOXFPYqJCjuwtehyQrXPgTRhDls=:rDpKBcp+aggwsxxCG4+EOQ=="
    ...
    Public Function Lay_Thong_Tin_HD800(ByVal sGUID As String, ByRef InvoiceNo As String, ByRef InvoiceSeri As String, ByRef msg As String) As String
        ...
        Return ""
    End Function
    Public Function Lay_Thong_Tin_HD8001(ByVal sGUID As String, ByRef InvoiceNo As String, ByRef InvoiceSeri As String, ByRef InvoiceDate As Date, ByRef msg As String) As String
        Dim objInvoice As InvoiceDataWS = Nothing
        msg = DoGetInfo(sGUID, objInvoice)
        If msg.Length > 0 Then Return msg
        InvoiceNo = objInvoice.Invoice.InvoiceNo
        InvoiceSeri = objInvoice.Invoice.InvoiceSerial
        InvoiceDate = objInvoice.Invoice.InvoiceDate
        Return ""
    End Function


    Public Function Lay_Thong_Tin_HD800WEB(ByVal sGUID As String, ByRef InvoiceNo As String, ByRef InvoiceSeri As String, ByRef InvoCode As String, ByRef msg As String) As String
        Dim objInvoice As InvoiceDataWS = Nothing
        msg = DoGetInfo(sGUID, objInvoice)
        If msg.Length > 0 Then Return msg
        InvoiceNo = objInvoice.Invoice.InvoiceNo
        InvoiceSeri = objInvoice.Invoice.InvoiceSerial
        InvoCode = objInvoice.Invoice.InvoiceCode
        Return ""
    End Function
    ...
    Public Function ViewHoaDonPDF(ByVal domain As String, ByVal stt_rec As String)
        ...
        If msg.Length > 0 Then Return msg Else Return ""
    End Function
    Public Function ViewHoaDonPDF1(ByVal domain As String, ByVal stt_rec As String)
        'Datareturn = Nothing
        Dim msg As String = ""
        Dim list As String = Nothing
        msg = GetViewInvoice(stt_rec, list)
        ...
        If msg.Length > 0 Then Return msg Else Return ""
    End Function
    Private Function EmailInvoice(ByVal matracuu As String, ByRef list As String)
        'list = Nothing
