...
#Region "Load Default"
    Private Sub V_Getdefault()
        ...
        TxtMa_ChienDich.Text = CyberSmlib.GetKeyValueRegistry(Me.Sysvar, TxtMa_ChienDich)
        ...
        If TxtMa_ChienDich.Text = "" Then TxtTen_ChienDich.Text = "" Else TxtTen_ChienDich.Text = CyberSmodb.SQLGetvalue(AppConn, "Ten_ChienDich", "DmChienDich", "Ma_ChienDich = N'" + TxtMa_ChienDich.Text.Trim + "'", CyberSmlib)
        If TxtMa_Vv.Text = "" Then TxtTen_Vv.Text = "" Else TxtTen_Vv.Text = CyberSmodb.SQLGetvalue(AppConn, "Ten_Sk", "DmSk", "Ma_Sk = N'" + TxtMa_Vv.Text.Trim + "'", CyberSmlib)
...
#Region "LoadData"
    Private Sub V_LoadData(ByVal Status As String)
        ...
        Dim _Ma_ChienDich As String = TxtMa_ChienDich.Text.Trim
        Dim _Ma_Sk As String = TxtMa_Vv.Text.Trim
...
#Region "Valid --- Ma_LoaiCS"
    Private Sub V_Ma_LoaiCS(ByVal sender As System.Object, ByVal e As System.EventArgs)
        TxtMa_LoaiCS.V_LookUp(M_LAN, Me.Para, Me.Sysvar, AppConn, DsLookup, "CrmMa_Loai", "CrmDmLoai", "1=1", "CrmLoai = 'CD'")
    End Sub
...
#Region "Valid --- Ma_Vv"
    Private Sub V_Ma_Vv(ByVal sender As System.Object, ByVal e As System.EventArgs)
        TxtMa_Vv.V_LookUp(M_LAN, Me.Para, Me.Sysvar, AppConn, DsLookup, "Ma_Vv", "DmVv", "1=1", "1=1")
    End Sub
