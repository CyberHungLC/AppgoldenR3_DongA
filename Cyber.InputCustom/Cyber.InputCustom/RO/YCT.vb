...
#Region "Columns Edit"
    ...
    Dim Editma_Db_I, EditMa_Xe_I, EditMa_KX_I, EditMa_Tuyen_I, EditMa_Ts, EditMa_Cc, EditMa_LoaiDH, EditNh_Vt1, EditNh_Vt2, EditNh_Vt3, EditMa_Kho As New Cyber.Fill.CyberColumnGridView 'Cyber.SmLists.EditLookUp
    Dim EditMa_LDDatHang_I, EditTen_Vt, EditTen_Vt3, EditTen_Nx_I, EditTen_Tk_VT, EditTen_kho_i, EditDvt, EditSo_Luong, EditGia_NT, EditGia, EditTien_NT, EditTien, EditDien_Giaii, EditSo_So, EditSo_Po, EditSo_Ro, EditSo_VT As New Cyber.Fill.CyberColumnGridView 'DevExpress.XtraEditors.Repository.RepositoryItemTextEdit
#End Region
#Region "Khai bao bien Private"
    ...
    Dim DtPost, DtMaGD, DtMaTANG, DtDmSTTHD As New DataTable
    Dim tbDmSttHD As New DataTable
    ...
    Dim M_Ma_TT, M_HT_TT, M_Ma_Thue, M_ma_tang As String
    Dim _Para_So_RO As String = ""
    Dim _Para_So_RO_NO As String = ""
    Dim _ViviBleCV As Boolean = False

#End Region
    Private Sub HPT_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
        V_GetColumn()
        V_AddHandler()
        V_Databing()
        ...
        CmdNew.Select()
        V_LoadNew(sender, e)
        If _ViviBleCV = False Then
            Dim ntab As Integer = TabDetail.TabCount - 1
            For i As Integer = ntab To 0 Step -1
                If TabDetail.TabPages(i).Name.Trim.ToUpper = "TabCv".Trim.ToUpper Then
...
#Region "Load And Set And Default"
    Private Sub V_LoadNew(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim dtMasterRf, dtDetailRf, dtDetailCvRf As DataTable

        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetDefaultYCT", _Para_So_RO.ToString.Trim & "#" & _Para_So_RO_NO.ToString.Trim & "#" & M_Ma_CT & "#" & M_Mode & "#" & M_Ma_Dvcs & "#" & M_User_Name)
        If DsTmp.Tables(1).Rows.Count = 1 Then
            ...
            For irow = nCount - 1 To 0 Step -1
                ...
                End If
            Next
            nCount = Dt_DetailCv.Rows.Count
            For irow = nCount - 1 To 0 Step -1
                If Dt_DetailCv.Rows(irow).Item("Stt_Rec").ToString.Trim = M_Stt_Rec Then
                    Dt_DetailCv.Rows(irow).Delete()
            ...
            For irow = 0 To dtDetailRf.Rows.Count - 1
                ...
                'If Dt_Detail.Rows(irow).Item("GIo_DH") <> "" Then Dt_Detail.Rows(irow).Item("GIo_DH") = CyberVoucher.V_GetTG(Dt_Detail.Rows(irow).Item("GIo_DH"), 0)


            Next
            For irow = 0 To dtDetailCvRf.Rows.Count - 1
                Dt_DetailCv.ImportRow(dtDetailCvRf.Rows(irow))
            Next
    ...
    Private Sub V_Getdefault()
        ...
        _Para_So_RO_NO = ""
        Try
            _Para_So_RO_NO = M_Para(M_VT_PARA + 6).Trim
        Catch ex As Exception
        ...
        'CyberFill.V_FillComBoxValue(Me.CbBMa_tang, tbDmTANG, "Ma_Tang", "Ten_Tang", M_ma_tang)
        'CyberFill.V_FillComBoxDefaul(Me.CbbSo_Seri, tbDmSttHD, "So_seri", "So_seri")
    ...
    Private Sub V_GetColumn()
        ...
        EditMa_LDDatHang_I.GetColumn(DetailGRV, "Ma_LDDatHang_I")
        ...
        EditMa_LoaiDH.GetColumn(DetailGRV, "Ma_LoaiDH")
    ...
    Private Sub V_SetFocus(ByVal _Loai As String)
        ...
        Select Case _Loai
            ...
            Case "S"
                'If DrDmct.Item("M_Ngay_CT").ToString.Trim <> "1" Then TxtNgay_Ct.Focus() Else TxtSo_HD.Focus()
            Case "L"
                CmdPrint.Select()
        End Select
    End Sub
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_System()
        ...
        AddHandler CmdVTTT.Click, AddressOf V_Chon_VT
    ...
    Private Sub V_AddHandler_Master()
        ...
        '--Ma_BP_H
        AddHandler TxtMa_LDDatHang.CyberValiting, AddressOf V_Ma_LDDatHang
        AddHandler TxtMa_LDDatHang.CyberLeave, AddressOf L_Ma_LDDatHang
        ...
        'Ma_LD
        AddHandler TxtMa_LD.CyberValiting, AddressOf V_Ma_LD
        AddHandler TxtMa_LD.CyberLeave, AddressOf L_Ma_LD
    ...
    Private Sub V_AddHandler_Detail()
        ...
        EditMa_LoaiDH.V_ActiLookUpColumn(AddressOf V_Ma_LoaiDH, AddressOf L_Ma_LoaiDH)
        ...
        EditMa_LDDatHang_I.V_ActiLookUpColumn(AddressOf V_Ma_LDDatHang_I, AddressOf L_Ma_LDDatHang_I)
        EditNh_Vt1.V_ActiLookUpColumn(AddressOf V_Nh_Vt1, AddressOf L_Nh_Vt1)
        EditNh_Vt2.V_ActiLookUpColumn(AddressOf V_Nh_Vt2, AddressOf L_Nh_Vt2)
        EditNh_Vt3.V_ActiLookUpColumn(AddressOf V_Nh_Vt3, AddressOf L_Nh_Vt3)
    ...
    Private Sub VisibleColumnMa_GD()
        ...
        If _Ma_Gd = 5 Or _Ma_Gd = 8 Then
            TxtLenh_RO.Enabled = "False"
            LabLenh_RO.Enabled = "False"
            TxtLenh_RO.Visible = "False"
            LabLenh_RO.Visible = "False"
            EditSo_Ro.ColumnReadOnly = "False"
            EditSo_Ro.Visible = "False"
            EditMa_VT.ColumnReadOnly = "False"
            ...
            EditTen_Vt3.ColumnReadOnly = "False"

        End If
        If _Ma_Gd = 3 Then
            TxtLenh_RO.Enabled = "True"
            LabLenh_RO.Enabled = "True"
            TxtLenh_RO.Visible = "True"
            LabLenh_RO.Visible = "True"
            EditSo_Ro.ColumnReadOnly = "True"
            EditSo_Ro.Visible = "True"
            EditMa_VT.ColumnReadOnly = "True"
            EditSo_Luong.ColumnReadOnly = "True"

            TxtMa_Xe.Enabled = "True"
            Label4.Enabled = "True"
            TxtMa_Xe.Visible = "True"
            Label4.Visible = "True"
            EditTen_Vt3.ColumnReadOnly = "True"
        End If
        CyberFill.SetFoCusGRV(DetailGRV, M_Mode)
    End Sub
    ...
    Protected Overrides Sub V_Databing()
        ...
        If Drv Is Nothing Then
            ...
            'CbBMa_tang.SelectedValue = M_ma_tang
        End If
...
#Region "Valid - Master"
#Region "Valid --- Ma_LD"
    Private Sub V_Ma_LD(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        TxtMa_LD.V_LookUp(M_LAN, M_Para, osysvar, AppConn, DsLookup, "Ma_LD", "DmLD", "1=1", "1=1")
    End Sub
    Private Sub L_Ma_LD(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If TxtMa_LD.Text = "" Then
            TxtTen_LD.Text = ""
            Exit Sub
        End If
        DrReturn = TxtMa_LD.GetRowsSelectData(True)
        If Not DrReturn Is Nothing Then
            TxtMa_LD.Text = DrReturn.Item("Ma_LD")
            TxtTen_LD.Text = DrReturn.Item("Ten_LD")
        Else
            TxtMa_LD.Text = ""
            TxtTen_LD.Text = ""
        End If
    ...
    End Sub
#End Region
    Private Sub V_Xac_nhan_I(ByVal sender As System.Object, ByVal e As System.EventArgs)
...
#Region "Valid --- Ma_KH"
    ...
    Private Sub L_Ma_KH(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        ...
        If Not DrReturn Is Nothing Then
            ...
            If DrReturn("Dia_Chi").ToString.Trim <> "" Then TxtDia_Chi.Text = DrReturn("Dia_Chi").ToString.Trim

            'If DrReturn("ten_khVat").ToString.Trim <> "" Then TxtTen_khVat.Text = DrReturn("ten_khVat").ToString.Trim
            'If DrReturn("Dia_ChiVat").ToString.Trim <> "" Then TxtDia_ChiVat.Text = DrReturn("Dia_ChiVat").ToString.Trim
            'If DrReturn("Ma_So_Thue").ToString.Trim <> "" Then TxtMa_So_Thue.Text = DrReturn("Ma_So_Thue").ToString.Trim
            ...
            'TxtTen_khVat.Text = IIf(TxtTen_khVat.Text.Trim = "", DrReturn("Ten_khVAT").ToString.Trim, TxtTen_khVat.Text.Trim)
            'TxtDia_ChiVat.Text = IIf(TxtDia_ChiVat.Text.Trim = "", DrReturn("Dia_ChiVAT").ToString.Trim, TxtDia_ChiVat.Text.Trim)
...
#Region "Valid --- MaU_HD"
    ...
    End Sub
#End Region
#Region "Valid --- Ma_LDDatHang"
    Private Sub V_Ma_LDDatHang(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        TxtMa_LDDatHang.V_LookUp(M_LAN, M_Para, osysvar, AppConn, DsLookup, "Ma_LDDatHang", "DmLDDatHang", "1=1", "1=1")
    End Sub
    Private Sub L_Ma_LDDatHang(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If TxtMa_LDDatHang.Text = "" Then
            TxtTen_LDDatHang.Text = ""
            Exit Sub
        End If
        DrReturn = TxtMa_LDDatHang.GetRowsSelectData(True)
        If Not DrReturn Is Nothing Then
            TxtMa_LDDatHang.Text = DrReturn.Item("Ma_LDDatHang")
            TxtTen_LDDatHang.Text = DrReturn.Item("Ten_LDDatHang")
            If txtDien_giai.Text = "" Then
                txtDien_giai.Text = DrReturn.Item("Ten_LDDatHang")
            End If
        Else
            TxtMa_LDDatHang.Text = ""
            TxtTen_LDDatHang.Text = ""
        End If
    End Sub
#End Region
#Region "Lenh/SO/Po/Ro/Vt/So_Lenh"
    Private Sub L_Lenh_So(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim _Dt As Date = TxtNgay_Ct.Value
        TxtLenh_SO.Text = CyberVoucher.V_GetSo_SO(M_Ma_CT, CbbMa_GD.SelectedValue, CbbMa_Post.SelectedValue, _Dt, TxtLenh_SO.Text, M_Ma_Dvcs)
    End Sub
    ...
    Private Sub L_Lenh_Ro(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        'TxtLenh_RO.Text = CyberVoucher.V_GetSo_RO(M_Ma_CT, "S", M_Mode, _Ngay_CT, TxtLenh_RO.Text, TxtMa_Dvcs.Text)
        TxtLenh_RO.Text = CyberVoucher.V_FormatSo_Ro(AppConn, osysvar, M_Ma_CT, "S", M_Mode, _Ngay_CT, TxtLenh_RO.Text, "", TxtMa_Dvcs.Text, M_User_Name, CyberSmlib)
        V_Lenh_RO()
...
#End Region
    ...
    Private Sub V_Lenh_RO()
        ...
        If M_Mode <> "M" Then Exit Sub
        Dim strFiled = "", strValues As String = ""
        CyberSmodb.GetValueControler(Me, strFiled, strValues, "")
        'If M_Mode <> "M" Then Exit Sub
        Dim DsLenh_RO As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetdetailYCTDefault", "0#1#" & M_Stt_Rec & "#" & M_Ma_CT & "#" & _Ngay_CT.ToString("yyyyMMdd") & "#" & _Ngay_CT.ToString("yyyyMMdd") & "#" & M_Mode & "#" & strFiled & "#" & strValues & "#" & M_Ma_Dvcs & "#" & M_User_Name)
        ...
        ChkSua_Thue.Checked = False
        V_UpdateMaster(DsLenh_RO.Tables(1), DsLenh_RO.Tables(2), DsLenh_RO.Tables(3))
        DsLenh_RO.Dispose()
        'V_Diem_Tich_Luy()
        'V_GetTiencoc()
    ...
    Private Sub V_UpdateMaster(ByVal _Dt_Master As DataTable, ByVal _Dt_DetailCV As DataTable, ByVal _Dt_DetailVT As DataTable)
        If Not _Dt_Master Is Nothing Then
            If _Dt_Master.Rows.Count > 0 Then
                ...
                If _Dt_Master.Columns.Contains("SO_CT") Then txtSo_ct.Text = _Dt_Master.Rows(0).Item("So_CT")
        ...
        For iRow As Integer = 0 To Dv_DetailCvTmp.Count - 1
            CyberSupport.V_UpdateTTLN_TTCP(AppConn, osysvar, M_Ma_CT, M_Mode, TxtMa_Dvcs.Text.Trim, M_User_Name, Dv_DetailCvTmp, iRow, DetailGRVCv, CyberSmlib, CyberSmodb)
        Next
        '----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        UpdateList()
    End Sub

    Private Sub V_Chon_VT()
        'If TxtLenh_RO.Text = "" Then Exit Sub
        'Dim _Ngay_CT As Date = TxtNgay_Ct.Value
        Dim nCount As Integer
        Dim strFiled = "", strValues As String = ""
        CyberSmodb.GetValueControler(Me, strFiled, strValues, "")
        If M_Mode <> "M" And M_Mode <> "S" Then Exit Sub
        Dim MaGD As String = CbbMa_GD.SelectedValue.ToString
        Dim Ds_Vt As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetVTTonTTToYCT", "0#1#" & M_Stt_Rec & "#" & M_Ma_CT & "#" & MaGD & "#" & M_Mode & "#" & strFiled & "#" & strValues & "#" & M_Ma_Dvcs & "#" & M_User_Name)

        nCount = Ds_Vt.Tables.Count

        For i = 0 To nCount - 1
            CyberSmodb.SetNotNullTable(Ds_Vt.Tables(i))
        Next

        If Not CyberSupport.V_MsgChk(Ds_Vt.Tables(0), Me.SysVar, Me.Lan) Then
            Ds_Vt.Dispose()
            Dt_DetailTmp.Rows.Clear()
            Dt_DetailCvTmp.Rows.Clear()
            ChkSua_Thue.Checked = False
        ...
        ChkSua_Thue.Checked = False
        V_UpdateMaster(Ds_Vt.Tables(1), Ds_Vt.Tables(2), Ds_Vt.Tables(3))
        Ds_Vt.Dispose()
        'V_Diem_Tich_Luy()
        'V_GetTiencoc()
...
#Region "Valid - Detail - Core"
    Private Sub UpdateList()
        ...
        '----
        TxtT_Tien_NT.Double = nT_Tien_Hang
    ...
    End Sub
    'Private Sub V_GetTiencoc()
    '    Dim Dt As Date
    '    Dim DsTTBH As DataSet
    '    Dt = TxtNgay_Ct.Value
    '    DsTTBH = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_HDSTiencoc", TxtLenh_RO.Text & "#" & M_Stt_Rec & "#" & Dt.ToString("yyyyMMdd") & "#" & _
    '    M_Ma_Dvcs + "#" + M_User_Name)


    '    TxtTien_coc.Double = DsTTBH.Tables(0).Rows(0).Item("Tien_coc")
    ...
    Private Sub V_Tinh_Toan(ByVal iRow As Integer)
        ...
        If Dv_DetailTmp.Item(iRow).Item("So_Luong") * Dv_DetailTmp.Item(iRow).Item("Gia_NT") <> 0 Then
            ...
            Dv_DetailTmp.Item(iRow).Item("Tien_Hang") = CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("So_Luong") * Dv_DetailTmp.Item(iRow).Item("Gia_NT"), M_R_TIEN_NT)
        ...
        If Dt_DetailTmp.Columns.Contains("Sua_Thue") Then
            If Dv_DetailTmp.Item(iRow).Item("Sua_Thue").ToString.Trim <> "1" Then
                Dv_DetailTmp.Item(iRow).Item("Thue") = Math.Round((Dv_DetailTmp.Item(iRow).Item("Tien_NT")) * Dv_DetailTmp.Item(iRow).Item("Thue_Suat") / 100, 0, MidpointRounding.AwayFromZero)
            Else
                Dv_DetailTmp.Item(iRow).Item("Thue") = Dv_DetailTmp.Item(iRow).Item("Thue")
            End If
        Else
            Dv_DetailTmp.Item(iRow).Item("Thue") = Math.Round((Dv_DetailTmp.Item(iRow).Item("Tien_NT")) * Dv_DetailTmp.Item(iRow).Item("Thue_Suat") / 100, 0, MidpointRounding.AwayFromZero)
        End If
...
#Region "Vat tu kho/Vitri - "
    ...
    Private Sub L_Ma_Vt(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If DrReturn Is Nothing Then
            ...
            Exit Sub
        End If
        Dim _Ten_VT As String = DrReturn("Ten_Vt").ToString.Trim
        Dim _Ten_VT3 As String = DrReturn("Ten_Vt3").ToString.Trim
        If _Ten_VT3 = "" Then
            _Ten_VT3 = _Ten_VT
        End If

        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dv_DetailTmp.Item(iRow).Item("Ma_Vt") = DrReturn("Ma_Vt").ToString.Trim
        Dv_DetailTmp.Item(iRow).Item("Ten_Vt") = DrReturn("Ten_Vt").ToString.Trim
        ...
        Dim _Thue_Suat As Double = DrReturn.Item("Thue_Suat")

        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dv_DetailTmp.Item(iRow).Item("DVT") = _DVT
        Dv_DetailTmp.Item(iRow).Item("Ma_Kho") = _Ma_kho
        If Dv_DetailTmp.Item(iRow).Item("Thue_Suat") = 0 Then Dv_DetailTmp.Item(iRow).Item("Thue_Suat") = _Thue_Suat
        ...
        V_SetSD(iRow)
    End Sub
    Private Sub V_Ma_LDDatHang_I(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        CyberSupport.V_Lookup("Ma_LDDatHang", "DmLDDatHang", "1=1", "1=1", M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_LDDatHang_I(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim iRow As Integer = -1
        iRow = DetailGRV.GetFocusedDataSourceRowIndex
        If iRow < 0 Then Exit Sub
        DrReturn = CyberSupport.L_Lookup(M_Mode, M_Ma_CT, sender, True)
        If DrReturn Is Nothing Then
            Dv_DetailTmp.Item(iRow)("Ma_LDDatHang_I") = ""
            Exit Sub
        End If
        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dv_DetailTmp.Item(iRow).Item("Ma_LDDAtHang_I") = DrReturn("Ma_LDDatHang").ToString.Trim
        If Dv_DetailTmp.Item(iRow).Item("Dien_Giai_I").ToString.Trim = "" Then
            Dv_DetailTmp.Item(iRow).Item("Dien_Giai_I") = DrReturn("Ten_LDDatHang").ToString.Trim
        End If
    ...
    Private Sub V_Nh_Vt1(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        CyberSupport.V_Lookup("Ma_Nh", "DmNhVt", "1=1", "Loai_Nh = 1", M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Nh_Vt1(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        DrReturn = CyberSupport.L_Lookup(M_Mode, M_Ma_CT, sender, True)
        If DrReturn Is Nothing Then
            Dv_DetailTmp.Item(iRow)("Ma_Nh") = ""
            Exit Sub
        End If
        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dv_DetailTmp.Item(iRow).Item("Nh_Vt1") = DrReturn("Ma_Nh").ToString.Trim
        Dv_DetailTmp.Item(iRow).EndEdit()
        DetailGRV.UpdateCurrentRow()
    End Sub

    Private Sub V_Nh_Vt2(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        CyberSupport.V_Lookup("Ma_Nh", "DmNhVt", "1=1", "Loai_Nh = 2", M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Nh_Vt2(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        End If
        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dv_DetailTmp.Item(iRow).Item("Nh_Vt2") = DrReturn("Ma_Nh").ToString.Trim
        Dv_DetailTmp.Item(iRow).EndEdit()
        DetailGRV.UpdateCurrentRow()
    End Sub

    Private Sub V_Nh_Vt3(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        CyberSupport.V_Lookup("Ma_Nh", "DmNhVt", "1=1", "Loai_Nh = 3", M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Nh_Vt3(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        End If
        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dv_DetailTmp.Item(iRow).Item("Nh_Vt3") = DrReturn("Ma_Nh").ToString.Trim
        Dv_DetailTmp.Item(iRow).EndEdit()
        DetailGRV.UpdateCurrentRow()
    End Sub
    ...
    Private Sub L_Ma_Kho(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        DrReturn = CyberSupport.L_Lookup(M_Mode, M_Ma_CT, sender, True)
        If DrReturn Is Nothing Then
            Dv_DetailTmp.Item(iRow)("Ma_Kho") = ""
            Exit Sub
        End If
        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dv_DetailTmp.Item(iRow).Item("Ma_kho") = DrReturn("Ma_kho").ToString.Trim
        Dv_DetailTmp.Item(iRow).EndEdit()
        DetailGRV.UpdateCurrentRow()
    End Sub
...
#Region "So_So/So_PO/So_RO/So_VT"
    Private Sub L_So_So(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If iRow < 0 Then Exit Sub
        Dim _Ngay_Ct As Date = TxtNgay_Ct.Value
        CyberVoucher.V_GetSo_SO(Dv_DetailTmp, iRow, M_Ma_CT, CbbMa_GD.SelectedValue, M_Mode, _Ngay_Ct, M_Ma_Dvcs)
    End Sub
...
#Region "Valid - Detail - Add On"
    ...
    End Sub
#End Region
    Private Sub V_Ma_LoaiDH(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        CyberSupport.V_Lookup("Ma_LoaiDH", "DmLoaiDH", "1=1", "1=1", M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_LoaiDH(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim iRow As Integer = -1
        iRow = DetailGRV.GetFocusedDataSourceRowIndex
        If iRow < 0 Then Exit Sub
        DrReturn = CyberSupport.L_Lookup(M_Mode, M_Ma_CT, sender, True)
        If DrReturn Is Nothing Then
            Dv_DetailTmp.Item(iRow)("Ma_LoaiDH") = ""
            Exit Sub
        End If
        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dv_DetailTmp.Item(iRow).Item("Ma_LoaiDH") = DrReturn("Ma_LoaiDH").ToString.Trim
        Dv_DetailTmp.Item(iRow).EndEdit()
        DetailGRV.UpdateCurrentRow()
    End Sub
#End Region
...
#Region "Mainform"
    ...
    Private Sub V_MainSystemCv()
        ...
        '----2019.09.29
        'Dim mnItemsCtrlF4 As New MenuItem(If(M_LAN = "V", "Thêm dòng nhiều dòng", "New rows"), AddressOf V_AddItem_Ma_CTCV, Keys.Control + Keys.F4)
        '----2019.09.29
        Dim mnItemsF8 As New MenuItem(If(M_LAN = "V", "Xóa dòng", "Delete row"), AddressOf V_ShortDeleteItemCv, Keys.F8)
        'mnItemsMail.MenuItems.Add(mnItemsF4)
        mnItemsMail.MenuItems.Add(mnItemsF8)
        'mnItemsMail.MenuItems.Add(mnItemsCtrlF4)
...
#Region "Button"
    ...
    '    '----------------------------------------------------------------------------------------------------------------------
    '    'TxtTien_HD.Double = TxtT_TT.Double
    '    '----------------------------------------------------------------------------------------------------------------------
    ...
    Private Sub V_SetPricePurChase(ByVal iRow As Integer)
        ...
        If _DtGia.Columns.Contains("Tien_Hang") Then Dv_DetailTmp.Item(iRow).Item("Tien_Hang") = _DtGia.Rows(0).Item("Tien_Hang")
        Dv_DetailTmp.Item(iRow).EndEdit()
        Dv_DetailTmp.Table.AcceptChanges()
        DsgetPrice.Dispose()
        V_Tinh_Toan(iRow)
    ...
    Private Function Add2Database() As Boolean
        Dim Dstmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_SysExecute", "SELECT TOP 0 * FROM dbo.PHYCT WHERE 1=0 #" + M_Ma_Dvcs + "#" + M_User_Name)
        Dim DtPHHPTstru As DataTable = Dstmp.Tables(0).Copy
        Dstmp.Dispose()
        Dim _DtPHHPT As DataTable = DtPHHPTstru.Clone
        Dim _DrPHHPT As DataRow = _DtPHHPT.NewRow

        _DrPHHPT.BeginEdit()
        CyberSmodb.SetValueBlankRow(_DrPHHPT)
        CyberSmodb.AddValueToRow(_DrPHHPT, Me)
        If DtPHHPTstru.Columns.Contains("Stt_Rec") Then _DrPHHPT.Item("Stt_Rec") = M_Stt_Rec
        If DtPHHPTstru.Columns.Contains("Ma_Ct") Then _DrPHHPT.Item("Ma_Ct") = M_Ma_CT
        If DtPHHPTstru.Columns.Contains("Ma_Dvcs") Then _DrPHHPT.Item("Ma_Dvcs") = TxtMa_Dvcs.Text
        _DrPHHPT.EndEdit()
        _DtPHHPT.Rows.Add(_DrPHHPT)
        _DtPHHPT.AcceptChanges()


        '-----------------------------------------------------------------------------------------------------
        Dim _Ngay_Ct As Date = TxtNgay_Ct.Value
        Dim DsTmpSave As DataSet = CyberSmodb.V_ChkAndSaveVoucher(Mode, M_Stt_Rec, M_Ma_CT, _Ngay_Ct, TxtMa_Dvcs.Text, M_User_Name, {"PHYCT", "CTYCT"}, {_DtPHHPT, Dt_DetailTmp, Dt_DetailCvTmp}, AppConn, osysvar, M_LAN, "", CyberSmlib, CyberSupport)
        ...
        If DsTmpSave.Tables(0).Columns.Contains("T_Tien_NT2") Then TxtT_Tien_Nt2.Double = (DsTmpSave.Tables(0).Rows(0).Item("T_Tien_NT2"))
        If DsTmpSave.Tables(0).Columns.Contains("T_Thue_NT") Then TxtT_Thue_Nt.Double = (DsTmpSave.Tables(0).Rows(0).Item("T_Thue_NT"))
        TxtT_TT_NT.Double = TxtT_Tien_Nt2.Double + TxtT_Thue_Nt.Double

        If DsTmpSave.Tables(0).Columns.Contains("T_Tien_Hang") Then TxtT_Tien_NT.Double = (DsTmpSave.Tables(0).Rows(0).Item("T_Tien_Hang"))
        If DsTmpSave.Tables(0).Columns.Contains("T_Thue_Hang") Then TxtT_Thue_hang.Double = (DsTmpSave.Tables(0).Rows(0).Item("T_Thue_Hang"))
        TxtT_Tong_Hang.Double = TxtT_Tien_NT.Double + TxtT_Thue_hang.Double

        If DsTmpSave.Tables(0).Columns.Contains("T_Tien_Cong") Then TxtT_Tien_Cong.Double = (DsTmpSave.Tables(0).Rows(0).Item("T_Tien_Cong"))
        If DsTmpSave.Tables(0).Columns.Contains("T_Thue_Cong") Then TxtT_Thue_Cong.Double = (DsTmpSave.Tables(0).Rows(0).Item("T_Thue_Cong"))
        TxtT_Tong_Cong.Double = TxtT_Tien_Cong.Double + TxtT_Thue_Cong.Double
        ...
        Return True
    End Function
    Private Function Add2DatabaseOld() As Boolean
        Dim drMaster As DataRow
        Dim CrrRow As Integer = -1
        If M_Mode.Trim = "M" Then
            drMaster = Dt_Master.NewRow
        ...
        '-----------------------------------------------------------------------------------------------------
        Return CyberSmodb.V_Add2Database(AppConn, osysvar, {Dt_DetailTmp, CyberSmodb.V_ConvertDrToTb(drMaster), Dt_DetailCvTmp}, {M_Ct, M_Ph, "CTYCTCV"}, M_Mode, CbbMa_Post.SelectedValue.ToString.Trim, M_Ma_CT, M_Stt_Rec, M_LAN, TxtMa_Dvcs.Text, M_User_Name, CyberSmlib, CyberSupport)
        ...
        'CyberSmodb.V_CyberSaveToSQL(AppConn, osysvar, M_User_Name, Dt_DetailCvTmp, "CTHPTCVCV", M_Mode, "Stt_Rec =N'" + M_Stt_Rec + "'")
        '-----------------------------------------------------------------------------------------------------
        '---Save: Post
    ...
    Private Sub V_New(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Stt_RecOld = M_Stt_Rec
        'Dim M_ma_tangOld As String = CbBMa_tang.SelectedValue.ToString.Trim
...
#Region "Add Or Detete Item"
    ...
    Private Sub CarrOn(ByVal DvNew As DataRow)
        ...
        DvNew.Item("Tag") = True
        'DvNew.Item("GIo_DH") = Hour(Now()).ToString + ":" + Minute(Now()).ToString
        'DvNew.Item("GIo_DH") = CyberVoucher.V_GetTG(DvNew.Item("GIo_DH"), 0)
    End Sub
#End Region
#Region "Sms - Import"
    ...
    Private Sub SetTxt()
        ...
        'If M_Mode = "S" Then
        '    TxtTien_HD.Enabled = False
        'Else
        '    TxtTien_HD.Enabled = True
        'End If
    End Sub
#End Region
