...
#Region "Columns Edit"
    ...
    Dim EditDien_Giaii, EditSo_So, EditSo_Po, EditSo_Ro, EditSo_VT, EditMa_KTV1, EditMa_KTV2, EditMa_KTV3, EditMa_KTV4, EditMa_KTV5, EditMa_KTV6, EditMa_KTV7, EditMa_KTV8 As New Cyber.Fill.CyberColumnGridView 'DevExpress.XtraEditors.Repository.RepositoryItemTextEdit
#End Region
...
#Region "Load And Set And Default"
    ...
    Private Sub V_GetColumn()
        ...
        EditMa_KTV1.GetColumn(DetailGRV, "Ma_KTV1")
        EditMa_KTV2.GetColumn(DetailGRV, "Ma_KTV2")
        EditMa_KTV3.GetColumn(DetailGRV, "Ma_KTV3")
        EditMa_KTV4.GetColumn(DetailGRV, "Ma_KTV4")
        EditMa_KTV5.GetColumn(DetailGRV, "Ma_KTV5")
        EditMa_KTV6.GetColumn(DetailGRV, "Ma_KTV6")
        EditMa_KTV7.GetColumn(DetailGRV, "Ma_KTV7")
        EditMa_KTV8.GetColumn(DetailGRV, "Ma_KTV8")
    End Sub
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Detail()
        ...
        EditMa_KTV1.V_ActiLookUpColumn(AddressOf V_Ma_KTV1, AddressOf L_Ma_KTV1)
        EditMa_KTV2.V_ActiLookUpColumn(AddressOf V_Ma_KTV2, AddressOf L_Ma_KTV2)
        EditMa_KTV3.V_ActiLookUpColumn(AddressOf V_Ma_KTV3, AddressOf L_Ma_KTV3)
        EditMa_KTV4.V_ActiLookUpColumn(AddressOf V_Ma_KTV4, AddressOf L_Ma_KTV4)
        EditMa_KTV5.V_ActiLookUpColumn(AddressOf V_Ma_KTV5, AddressOf L_Ma_KTV5)
        EditMa_KTV6.V_ActiLookUpColumn(AddressOf V_Ma_KTV6, AddressOf L_Ma_KTV6)
        EditMa_KTV7.V_ActiLookUpColumn(AddressOf V_Ma_KTV7, AddressOf L_Ma_KTV7)
        EditMa_KTV8.V_ActiLookUpColumn(AddressOf V_Ma_KTV8, AddressOf L_Ma_KTV8)
...
#Region "Lenh/SO/Po/Ro/Vt"
    ...
    Private Sub V_GetDetailRO(ByVal _Ro As String, ByVal _Ro_Hang As String)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If _Ro.Trim + _Ro_Hang.Trim = "" Then Exit Sub

        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_RoGetPHS", "1#" & _Ro.Trim & "#" & _Ro_Hang.Trim & "##19000101#19000101#" & M_Stt_Rec & "#" & M_Ma_GD & "#" & M_Ma_Dvcs & "#" & M_User_Name)
        ...
        End If
        '-----
        V_UpdateMaster(DsTmp.Tables(2), DsTmp.Tables(1))
        DsTmp.Dispose()
        UpdateList()
    End Sub
...
#End Region
    ...
    Private Sub L_Ma_KTV1(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If DrReturn Is Nothing Then
            Dv_DetailTmp.Item(iRow).Item("Ma_KTV1") = ""
            Dv_DetailTmp.Item(iRow).Item("Ten_KTV1") = ""
            Exit Sub
        End If
        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dv_DetailTmp.Item(iRow).Item("Ma_KTV1") = DrReturn.Item("Ma_HS").ToString.Trim
        Dv_DetailTmp.Item(iRow).Item("Ten_KTV1") = DrReturn.Item("Ten_HS").ToString.Trim
        Dv_DetailTmp.Item(iRow).EndEdit()
    End Sub
    ...
    Private Sub L_Ma_KTV2(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        DrReturn = CyberSupport.L_Lookup(M_Mode, M_Ma_CT, sender, True)
        If DrReturn Is Nothing Then
            Dv_DetailTmp.Item(iRow).Item("Ma_KTV2") = ""
            Dv_DetailTmp.Item(iRow).Item("Ten_KTV2") = ""
            Exit Sub
        End If
        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dv_DetailTmp.Item(iRow).Item("Ma_KTV2") = DrReturn.Item("Ma_HS").ToString.Trim
        Dv_DetailTmp.Item(iRow).Item("Ten_KTV2") = DrReturn.Item("Ten_HS").ToString.Trim
        Dv_DetailTmp.Item(iRow).EndEdit()
    End Sub


    Private Sub V_Ma_KTV3(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If M_Mode <> "S" And M_Mode <> "M" Then Exit Sub
        CyberSupport.V_Lookup("Ma_HS", "DmHS", "1=1", "1=1", M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_KTV3(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If M_Mode <> "S" And M_Mode <> "M" Then Exit Sub
        Dim iRow As Integer = -1
        iRow = DetailGRV.GetFocusedDataSourceRowIndex
        If iRow < 0 Then Exit Sub
        DrReturn = CyberSupport.L_Lookup(M_Mode, M_Ma_CT, sender, True)
        If DrReturn Is Nothing Then
            Dv_DetailTmp.Item(iRow).Item("Ma_KTV3") = ""
            Dv_DetailTmp.Item(iRow).Item("Ten_KTV3") = ""
            Exit Sub
        End If
        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dv_DetailTmp.Item(iRow).Item("Ma_KTV3") = DrReturn.Item("Ma_HS").ToString.Trim
        Dv_DetailTmp.Item(iRow).Item("Ten_KTV3") = DrReturn.Item("Ten_HS").ToString.Trim
        Dv_DetailTmp.Item(iRow).EndEdit()
    End Sub


    Private Sub V_Ma_KTV4(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If M_Mode <> "S" And M_Mode <> "M" Then Exit Sub
        CyberSupport.V_Lookup("Ma_HS", "DmHS", "1=1", "1=1", M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_KTV4(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If M_Mode <> "S" And M_Mode <> "M" Then Exit Sub
        Dim iRow As Integer = -1
        iRow = DetailGRV.GetFocusedDataSourceRowIndex
        If iRow < 0 Then Exit Sub
        DrReturn = CyberSupport.L_Lookup(M_Mode, M_Ma_CT, sender, True)
        If DrReturn Is Nothing Then
            Dv_DetailTmp.Item(iRow).Item("Ma_KTV4") = ""
            Dv_DetailTmp.Item(iRow).Item("Ten_KTV4") = ""
            Exit Sub
        End If
        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dv_DetailTmp.Item(iRow).Item("Ma_KTV4") = DrReturn.Item("Ma_HS").ToString.Trim
        Dv_DetailTmp.Item(iRow).Item("Ten_KTV4") = DrReturn.Item("Ten_HS").ToString.Trim
        Dv_DetailTmp.Item(iRow).EndEdit()
    End Sub


    Private Sub V_Ma_KTV5(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If M_Mode <> "S" And M_Mode <> "M" Then Exit Sub
        CyberSupport.V_Lookup("Ma_HS", "DmHS", "1=1", "1=1", M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_KTV5(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If M_Mode <> "S" And M_Mode <> "M" Then Exit Sub
        Dim iRow As Integer = -1
        iRow = DetailGRV.GetFocusedDataSourceRowIndex
        If iRow < 0 Then Exit Sub
        DrReturn = CyberSupport.L_Lookup(M_Mode, M_Ma_CT, sender, True)
        If DrReturn Is Nothing Then
            Dv_DetailTmp.Item(iRow).Item("Ma_KTV5") = ""
            Dv_DetailTmp.Item(iRow).Item("Ten_KTV5") = ""
            Exit Sub
        End If
        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dv_DetailTmp.Item(iRow).Item("Ma_KTV5") = DrReturn.Item("Ma_HS").ToString.Trim
        Dv_DetailTmp.Item(iRow).Item("Ten_KTV5") = DrReturn.Item("Ten_HS").ToString.Trim
        Dv_DetailTmp.Item(iRow).EndEdit()
    End Sub


    Private Sub V_Ma_KTV6(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If M_Mode <> "S" And M_Mode <> "M" Then Exit Sub
        CyberSupport.V_Lookup("Ma_HS", "DmHS", "1=1", "1=1", M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_KTV6(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If M_Mode <> "S" And M_Mode <> "M" Then Exit Sub
        Dim iRow As Integer = -1
        iRow = DetailGRV.GetFocusedDataSourceRowIndex
        If iRow < 0 Then Exit Sub
        DrReturn = CyberSupport.L_Lookup(M_Mode, M_Ma_CT, sender, True)
        If DrReturn Is Nothing Then
            Dv_DetailTmp.Item(iRow).Item("Ma_KTV6") = ""
            Dv_DetailTmp.Item(iRow).Item("Ten_KTV6") = ""
            Exit Sub
        End If
        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dv_DetailTmp.Item(iRow).Item("Ma_KTV6") = DrReturn.Item("Ma_HS").ToString.Trim
        Dv_DetailTmp.Item(iRow).Item("Ten_KTV6") = DrReturn.Item("Ten_HS").ToString.Trim
        Dv_DetailTmp.Item(iRow).EndEdit()
    End Sub

    Private Sub V_Ma_KTV7(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If M_Mode <> "S" And M_Mode <> "M" Then Exit Sub
        CyberSupport.V_Lookup("Ma_HS", "DmHS", "1=1", "1=1", M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_KTV7(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If M_Mode <> "S" And M_Mode <> "M" Then Exit Sub
        Dim iRow As Integer = -1
        iRow = DetailGRV.GetFocusedDataSourceRowIndex
        If iRow < 0 Then Exit Sub
        DrReturn = CyberSupport.L_Lookup(M_Mode, M_Ma_CT, sender, True)
        If DrReturn Is Nothing Then
            Dv_DetailTmp.Item(iRow).Item("Ma_KTV7") = ""
            Dv_DetailTmp.Item(iRow).Item("Ten_KTV7") = ""
            Exit Sub
        End If
        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dv_DetailTmp.Item(iRow).Item("Ma_KTV7") = DrReturn.Item("Ma_HS").ToString.Trim
        Dv_DetailTmp.Item(iRow).Item("Ten_KTV7") = DrReturn.Item("Ten_HS").ToString.Trim
        Dv_DetailTmp.Item(iRow).EndEdit()
    End Sub
    Private Sub V_Ma_KTV8(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If M_Mode <> "S" And M_Mode <> "M" Then Exit Sub
        CyberSupport.V_Lookup("Ma_HS", "DmHS", "1=1", "1=1", M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_Ma_KTV8(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If M_Mode <> "S" And M_Mode <> "M" Then Exit Sub
        Dim iRow As Integer = -1
        iRow = DetailGRV.GetFocusedDataSourceRowIndex
        If iRow < 0 Then Exit Sub
        DrReturn = CyberSupport.L_Lookup(M_Mode, M_Ma_CT, sender, True)
        If DrReturn Is Nothing Then
            Dv_DetailTmp.Item(iRow).Item("Ma_KTV8") = ""
            Dv_DetailTmp.Item(iRow).Item("Ten_KTV8") = ""
            Exit Sub
        End If
        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dv_DetailTmp.Item(iRow).Item("Ma_KTV8") = DrReturn.Item("Ma_HS").ToString.Trim
        Dv_DetailTmp.Item(iRow).Item("Ten_KTV8") = DrReturn.Item("Ten_HS").ToString.Trim
        Dv_DetailTmp.Item(iRow).EndEdit()
    End Sub
...
#Region "Button"
    ...
    Private Function ChkVsave() As Boolean
        ...
        For iRow = nCount - 1 To 0 Step -1
            If Dt_DetailTmp.Rows(iRow).Item("So_RO").ToString.Trim = "" Or Dt_DetailTmp.Rows(iRow).Item("MA_KTV1").ToString.Trim = "" Then
...
#End Region
    ...
    Private Sub V_Loc_RO(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        V_UpdateMaster(frm.Dt_Return, frm.Vt_Return)

    End Sub
    Sub V_UpdateMaster(ByVal DtTmpMaster As DataTable, ByVal DtTmpDetail As DataTable)
