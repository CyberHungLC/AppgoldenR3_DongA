...
#Region "Columns Edit"
    ...
    Dim EditTen_Tk_No, EditTen_Tk_Co, EditTen_KH_N, EditTen_KH_C, EditMa_TT As New Cyber.Fill.CyberColumnGridView
#End Region
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Master()
        ...
        AddHandler CmdLoc_HDI.Click, AddressOf V_Loc_HDI
        'Ma_LD
...
#End Region
#Region "Lọc PDX"
    Private Sub V_Loc_HDI(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim Frm As HDI_Loc
        Frm = New HDI_Loc
        ...
        Dim _Dt_Return1 As DataTable = Frm.Return_Tb1
        Dim _Dt_Return2 As DataTable = Frm.Return_Tb2
        L_UpdateHDI(_Dt_Return1, _Dt_Return2)
    End Sub
    Private Sub L_UpdateHDI(ByVal _Tb_Master As DataTable, ByVal _Dt_Detail As DataTable)
        If _Tb_Master.Rows.Count > 0 Then
