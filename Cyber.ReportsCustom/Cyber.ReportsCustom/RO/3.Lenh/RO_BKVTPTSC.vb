Public Class RO_BKVTPTSC
    ...
    Private Sub RO_BKVTPTSC_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
#Region "Button"
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        M_strParameterStore = M_strParameterStore & "#" & TxtSo_Ro_Hang.Text.Trim
        ...
        M_strParameterStore = M_strParameterStore & "#" & IIf(ChkIs_NgayNT.Checked, "1", "0")
        M_strParameterStore = M_strParameterStore & "#" & IIf(ChkIs_VTPT.Checked, "1", "0")
        M_strParameterStore = M_strParameterStore & "#" & IIf(ChkIs_Cv.Checked, "1", "0")
