...
#Region "Columns Edit"
    ...
    Dim Editma_Db_I, EditMa_Xe_I, EditMa_KX_I, EditMa_Tuyen_I, EditMa_Ts, EditMa_Cc, EditMa_TT As New Cyber.Fill.CyberColumnGridView 'Cyber.SmLists.EditLookUp
...
#Region "Load And Set And Default"
    ...
    Private Sub V_Getdefault()
        ...
        _Para_So_QTU = ""
        Try
            _Para_So_QTU = M_Para(M_VT_PARA + 4).Trim
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Master()
        ...
        AddHandler CmdLoc_POD.Click, AddressOf V_Loc_PDX
        'So_DN_TT
        AddHandler TxtSo_DN_TT.Leave, AddressOf L_So_DN_TT
        'So_DN_TT
        AddHandler txtSo_QTU.Leave, AddressOf L_So_QTU
    End Sub
...
#Region "Valid - Detail - Add On"
    ...
    '    'MessageBox.Show(Dv_DetailTmp.Item(iRow).Item("Ma_TD3_I") & " - " & MaHDTmp & " - " & TenHDTmp)
    ...
    '    Dv_DetailTmp.Item(iRow).Item("Ten_HD_I") = DrReturn("Ten_TD3").ToString.Trim
    '    Dv_DetailTmp.Item(iRow).EndEdit()
    'End Sub
    ...
    Private Sub L_Ma_TD3_i(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim _Ma_TD3 As String = DrReturn.Item("Ma_TD3")
        Dim _Ten_TD3 As String = DrReturn.Item("Ten_TD3")
        Dim _Ma_HD As String = DrReturn.Item("Ma_HD")
...
#End Region
#Region "Lọc PDX"
    Private Sub V_Loc_PDX(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim Frm As PDX_Loc
        Frm = New PDX_Loc
    ...
    Private Sub L_Lenh_PO_Update(ByVal _Ma_KH As String, ByVal _Ten_KH As String, ByVal _Dia_Chi As String, ByVal _Tb_Master As DataTable, ByVal _Dt_Detail As DataTable)
        If _Tb_Master.Rows.Count > 0 Then
            ...
            If TxtTk.Text.Trim = "" And _Tb_Master.Columns.Contains("TK_Co") Then TxtTk.Text = _Tb_Master.Rows(0).Item("Tk_Co")
    ...
    End Sub
#End Region
    Private Sub L_So_DN_TT()
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If TxtSo_DN_TT.Text = "" Then Exit Sub
        Dim _StrParameter As String = M_Ma_CT + "#" + "" + "#" + TxtSo_DN_TT.Text.Trim + "#" + M_Ma_Dvcs + "#" + M_User_Name

        Dim DsReturn As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_PC1_BN1_GetDNTT", _StrParameter)
        If DsReturn.Tables.Count < 1 Then Exit Sub

        If Not CyberSupport.V_MsgChk(DsReturn.Tables(0), Me.SysVar, Me.Lan) Then
            TxtNgay_Ct.Focus()
            TxtSo_DN_TT.Text = ""
            DsReturn.Dispose()
            ...
            Exit Sub
        End If
        V_UpdateToMaster(DsReturn.Tables(1), DsReturn.Tables(2))
    End Sub
    Private Sub V_UpdateToMaster(ByVal _Dt_Master As DataTable, ByVal _Dt_Detail As DataTable)
        If Not _Dt_Master Is Nothing Then
            If _Dt_Master.Rows.Count > 0 Then
                If _Dt_Master.Columns.Contains("Tk") Then TxtTk.Text = _Dt_Master.Rows(0).Item("Tk")
                If _Dt_Master.Columns.Contains("Ten_Tk") Then Txtten_Tk.Text = _Dt_Master.Rows(0).Item("Ten_Tk")
                ...
                If _Dt_Master.Columns.Contains("Ong_Ba") Then txtOng_ba.Text = _Dt_Master.Rows(0).Item("Ong_Ba")
                If _Dt_Master.Columns.Contains("Dien_Giai") Then txtDien_giai.Text = _Dt_Master.Rows(0).Item("Dien_Giai")
                If _Dt_Master.Columns.Contains("Stt_Rec_DN") Then txtStt_Rec_DN.Text = _Dt_Master.Rows(0).Item("Stt_Rec_DN")
            End If
        End If
        Dt_DetailTmp.Rows.Clear()
    ...
    Private Sub L_So_QTU()
        ...
        Dim DsReturn As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_PC1_BN1_GetQTU", _StrParameter)
        If DsReturn.Tables.Count < 1 Then Exit Sub
