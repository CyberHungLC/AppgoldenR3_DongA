...
#Region "AddProperty"
    ...
    Public Property _ID_KH() As String
        ...
        End Set
    End Property
    Public Property _Ma_Xe() As String
        Get
            _Ma_Xe = M_Ma_Xe
        End Get
        Set(ByVal Value As String)
...
#End Region
    ...
    Private Sub V_loadData()
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_CRQLDV_VIEW_" + _Loai.Trim, _Ma_Xe + "#" + M_Ma_Dvcs + "#" + M_User_Name)
