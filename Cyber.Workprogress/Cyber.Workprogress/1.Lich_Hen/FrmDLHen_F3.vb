...
#Region "Load..."
    Private Sub V_Load(ByVal _Load As String)
        ...
        If M_Kieu_Xem = "HEN" And M_Ma_Xe <> "" Then TxtMa_Get.Text = M_Stt_Rec
        ...
        If TxtNgay_Dk.Value = "01/01/1900" Then TxtNgay_Dk.Value = Dt_DmDlhen.Rows(0).Item("Ngay_Dk").ToString.ToString("dd/MM/yyyy")
        '-----------------------------------------------------
        iTb = iTb + 1
    ...
    Private Sub V_AddHander()
        ...
        AddHandler TxtMa_Sale.CyberValiting, AddressOf V_Ma_Sale
        AddHandler TxtMa_Sale.CyberLeave, AddressOf L_Ma_Sale
        ...
        AddHandler CmbSms.Click, AddressOf V_GuiSms
    End Sub
    ...
    End Sub
    Private Sub V_GuiSms(ByVal sender As System.Object, ByVal e As System.EventArgs)

        If M_Stt_Rec.Trim = "" Then
            MsgBox("Khôn tồn tại lịch hẹn", MsgBoxStyle.Critical + MsgBoxStyle.OkOnly, Sysvar("M_CYBER_VER"))
            Return
        End If

        Dim _Xml As String = ""
        Dim Dstmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_DLH_GuiSms", M_Kieu_Xem + "#" + M_Loai_SC + "#" + M_Stt_Rec.Trim & "#" & _Xml & "#" & M_Ma_Dvcs & "#" & M_User_Name)
...
#Region "Xe/To"
    ...
    Private Sub V_Ma_Xe(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        TxtMa_Xe.Text = CyberVoucher.V_FormatBien_So(TxtMa_Xe.Text, True)
        If TxtMa_Xe.Text.Trim = "" Then Exit Sub
        If M_Mode = "M" Then V_LoadMa_Xe(TxtMa_Xe.Text.Trim)
...
#Region "K/xGoi sua chua"
    ...
    Private Sub V_Nh_Kx2(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        sender.V_LookUp(M_LAN, Me.Para, Me.Sysvar, AppConn, DsLookup, "Ma_Nh", "DmNhKx", "1=1", "Loai_Nh = '2'")
    End Sub
    ...
    Private Sub L_Ma_sc(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        ...
        End If
    End Sub
    Private Sub V_Ma_Sale(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        sender.V_LookUp(M_LAN, Me.Para, Me.Sysvar, AppConn, DsLookup, "Ma_Hs", "DmHs", "1=1", "1=1")
    End Sub
    Private Sub L_Ma_Sale(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim DrReturn = sender.GetRowsSelectData(True)
        If Not DrReturn Is Nothing Then
            TxtMa_Sale.Text = DrReturn.Item("Ma_Hs")
            TxtTen_Sale.Text = DrReturn.Item("Ten_Hs")
        Else
            TxtMa_Sale.Text = ""
            TxtTen_Sale.Text = ""
        End If
...
#End Region
    Private Sub V_Goi_Dien1(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If TxtDT_LX.Text = "" Then Exit Sub
        Dim strAddParar As String = "CP_CMSCuocGoi#" + TXTDT_LX.Text.Trim + "#" + TxtTen_Lx.Text.Trim + "#" + M_Ma_Dvcs.Trim + "#" + M_User_Name.Trim + "#" + M_Stt_Rec.Trim
