...
#Region "Vali --- Ma_ChienDich"
    ...
    Private Sub L_Ma_ChienDich(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If txtMa_ChienDich.Text = "" Then
            ...
            Exit Sub
        End If
        DrReturn = txtMa_ChienDich.GetRowsSelectData(False)
        If Not DrReturn Is Nothing Then
...
#Region "Button"
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        M_strParameterStore = M_strParameterStore & "#" & IIf(ChkIs_HDS.Checked, "1", "0")
        '-----------------------------------------------------------------------------
        Me.is_continue = True
