Public Class FrmLocBaoGia
#Region "Get or Set Property----------------------"
    Public Property Is_ALL_Thue As Integer
        Get
            Return M_Is_ALL_Thue
        End Get
    ...
    End Property
    Dim Is_Bg As String = ""
    Public Property _Is_BG() As String
        Get
            _Is_BG = Is_Bg
        End Get
        Set(ByVal Value As String)
...
#Region "Bien----------------------"
    ...
    Dim M_Is_ALL_Thue As Integer = 0
...
#Region "Load - "
    ...
    Private Sub V_Load()
        ...
        ChkIs_BG.Checked = IIf(Is_Bg = "1", True, False)
    ...
    Private Sub V_LoadDatabase(ByVal Status As String)
        ...
        'Dim _is_BG = IIf(ChkIs_BG.Checked = True, "1", "0")
        Dim _Loai_Phieu As String = ""
        'If _is_BG = "1" Then
        '    _Loai_Phieu = "1"
        '    TxtSo_BG.Focus()
        'Else
        _Loai_Phieu = "2"
        'End If
        Dim DsLenh_RO As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_CopyBGTOHDK", Status + "#" + _Loai_Phieu + "#" & M_Stt_rec & "#" & M_Ma_Ct & "#" & _Ngay_Ct1.ToString("yyyyMMdd") & "#" & _Ngay_Ct2.ToString("yyyyMMdd") & "#" & M_Mode & "#" & _Is_BG & "#" & strFiled & "#" & strValues & "#" & M_Ma_Dvcs & "#" & M_User_Name)
    ...
    Private Sub V_LoadHeaderGridview()
        Dim DsHeader As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetDetailHeadCopyBG", M_Ma_Ct.Trim + "#" + M_User_Name)
        '========== Fill datatable
    ...
    Private Sub V_LoadTotal()
        ...
        For Each dr As DataRow In dtMasterRo.Select("Tag ='1'")
            For Each drcv As DataRow In dtDetailCvRo.Select("Tag= '1' And Rec_Ro='" & dr("Rec_RO").ToString.Trim & "'")
                T_CV_NTn = T_CV_NTn + drcv("Tien_CV")
            ...
            For Each drVt As DataRow In dtDetailVtRo.Select("Tag='1' And Rec_Ro='" & dr("Rec_Ro").ToString.Trim & "'")
                T_Tien_Nt2n = T_Tien_Nt2n + drVt("Tien2")
...
#End Region
    ...
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If ChkIs_BG.Checked = True And dtMasterRo.Select("Tag = 1").Count > 1 Then
            MsgBox("Bạn chỉ được phép chọn 1 báo giá")
            Exit Sub
        End If
        ...
        CyberSmodb.SetNotNullTable(_Master_Return)
        Me.Master_Return = _Master_Return
        CyberSmodb.SetNotNullTable(_VT_Return)
        Me.Vt_Return = _VT_Return
        CyberSmodb.SetNotNullTable(_CV_Return)
