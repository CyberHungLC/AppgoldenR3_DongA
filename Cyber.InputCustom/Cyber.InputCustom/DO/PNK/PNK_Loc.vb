...
Public Class PNK_Loc
    ...
    Sub V_Loaddatatabase(ByVal _Type As String)
        ...
        Dim _DsTmp As DataSet = CyberInput.V_GetPNKFromPOD(AppConn, CyberSmlib, _Type, _Dt1.ToString("yyyyMMdd"), _Dt2.ToString("yyyyMMdd"), TxtLenh_PO.Text, TxtMa_Kh.Text, M_Stt_rec, TxtMa_VT.Text.Trim, M_Ma_Dvcs, M_User_Name)
...
#Region "Grid..."
    ...
    Private Sub V_ChkDetail()
        ...
        For i = 0 To DtTable2.Rows.Count - 1
            DtTable2.Rows(i).BeginEdit()
            DtTable2.Rows(i).Item("Tag") = ChkDetail.Checked
            DtTable2.Rows(i).EndEdit()
            DtTable2.AcceptChanges()
        Next
    End Sub
