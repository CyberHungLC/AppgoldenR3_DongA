...
#Region "Valid"
    ...
    Private Sub GetDetail()
        ...
        If DsTmpDetal.Tables(0).Columns.Contains("Ma_ChienDich") Then TxtMa_ChienDich.Text = DsTmpDetal.Tables(0).Rows(0).Item("Ma_ChienDich")
        If DsTmpDetal.Tables(0).Columns.Contains("Ten_ChienDich") Then txtTen_ChienDich.Text = DsTmpDetal.Tables(0).Rows(0).Item("Ten_ChienDich")
