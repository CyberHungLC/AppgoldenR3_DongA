Public Class GLPNL
    ...
    Dim DtThang1, DtThang2, DtThang3, DtThang4, DtNam, DtNam2, DtDmMauBc As DataTable
    Dim CyberMe As New Cyber.ReportsCustom.Sys
    Dim _DsTmp As DataSet
    Private Sub GLKHKD_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_AddMenuShorcut()
        V_Load()
        V_Addhander()
    End Sub
#Region "Load"
    Private Sub V_Load()
        DtDmMauBc = CyberSmodb.OpenTableKey(AppConn, _DsTmp, "DmMauBC", "FILE_MauBC", "Acti=N'1' AND Ma_mauBc =N'GLPNL'", CyberSmLib)
        ...
        DtThang3 = DtThang1.Copy
        DtThang4 = DtThang1.Copy
        DtNam2 = CreateTableYear()
        ...
        CyberFill.V_FillComBoxDefaul(CbbM_Thang3, DtThang3, "Thang", IIf(Me.LAN = "V", "Ten_Thang", "Ten_Thang2"), "Default")
        CyberFill.V_FillComBoxDefaul(CbbM_Thang4, DtThang4, "Thang", IIf(Me.LAN = "V", "Ten_Thang", "Ten_Thang2"), "Default")
...
#Region "Button"
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        M_strParameterStore = M_strParameterStore & "#" & CbbM_Thang3.SelectedValue.ToString.Trim & "#" & CbbM_Thang4.SelectedValue.ToString.Trim & "#" & CbbM_Nam2.SelectedValue.ToString.Trim
        M_strParameterStore = M_strParameterStore & "#" & TxtDvt.Double
