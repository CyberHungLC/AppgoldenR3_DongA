...
#End Region
    ...
    Private Sub V_Load()
        ...
        txtTen_Kh.Text = Dv_Master.Item(0).Item("Ten_Kh")
        txtDia_Chi.Text = Dv_Master.Item(0).Item("Dia_Chi")
        TxtTen_HS_Old.Text = Dv_Master.Item(0).Item("Ten_Hs_Old")
        TxtTen_HS_New.Text = Dv_Master.Item(0).Item("Ten_Hs_New")
        ...
        If Dv_Master.Item(0).Item("Ma_GD") = "50" Then
            Lbl_TVBH_Old.Visible = False
            Lbl_TVBH_New.Visible = False
            TxtTen_HS_Old.Visible = False
            TxtTen_HS_New.Visible = False
        End If
    End Sub
