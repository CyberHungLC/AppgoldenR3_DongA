...
#Region "Columns Edit"
    ...
    Dim EditSo_Luong, EditGia3, EditGia2, EditTien2, EditCk_i, EditPt_Ck_i, EditMa_Thue, EditThue_Suat, EditThue, EditTien_BH, EditThue_BH As New Cyber.Fill.CyberColumnGridView 'DevExpress.XtraEditors.Repository.RepositoryItemTextEdit
    Dim EditTien_HHTV, EditTien_HHPPK, EditPT_HH_TV, EditPT_HH_PPK, EditTIEN_HH_HT, EditPT_HH_HT, EditPT_HH_NGANHANG, EditTIEN_HH_NGANHANG, EditPT_HH_KHAC, EditTIEN_HH_KHAC, EditPT_HH, EditTIEN_HH, EditNgay_bd, EditSua_Thue As New Cyber.Fill.CyberColumnGridView
...
#Region "Load And Set And Default"
    ...
    Private Sub V_Load()
        ...
        TxtT_HH_PPK.InputMask = IIf(DrDmct.Item("M_IP_MK_TIEN").ToString.Trim <> "", DrDmct.Item("M_IP_MK_TIEN").ToString.Trim, TxtT_HH_PPK.InputMask)
    ...
    Private Sub V_GetColumn()
        ...
        EditSua_Thue.GetColumn(Me.DetailGRV, "Sua_Thue")
        ...
        EditTien_HHPPK.GetColumn(Me.DetailGRV, "Tien_HHPPK")
        EditPT_HH_TV.GetColumn(Me.DetailGRV, "PT_HH_TV")
        EditPT_HH_PPK.GetColumn(Me.DetailGRV, "PT_HH_PPK")

        EditPT_HH_HT.GetColumn(Me.DetailGRV, "PT_HH_HT")
        EditTIEN_HH_HT.GetColumn(Me.DetailGRV, "TIEN_HH_HT")
        EditPT_HH_NGANHANG.GetColumn(Me.DetailGRV, "PT_HH_NGANHANG")
        EditTIEN_HH_NGANHANG.GetColumn(Me.DetailGRV, "TIEN_HH_NGANHANG")
        EditPT_HH_KHAC.GetColumn(Me.DetailGRV, "PT_HH_KHAC")
        EditTIEN_HH_KHAC.GetColumn(Me.DetailGRV, "TIEN_HH_KHAC")
        EditPT_HH.GetColumn(Me.DetailGRV, "PT_HH")
        EditTIEN_HH.GetColumn(Me.DetailGRV, "TIEN_HH")
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Master()
        ...
        AddHandler ChkLien_ket.CheckedChanged, AddressOf V_Tinh_Toan
        ...
        AddHandler CmdHach_Toan.Click, AddressOf GetHachToan
        AddHandler CmdHuy_Lenh.Click, AddressOf V_Huy_Lenh
        AddHandler CmdCapNhat_HD.Click, AddressOf V_CapNhatHD
        '----------------------------------------------------------------------------------------------------------
    End Sub
    Private Sub V_AddHandler_Detail()
        ...
        If Not EditGia3.Column Is Nothing Then AddHandler EditGia3.EditColumn.Leave, AddressOf V_Tinh_Toan
        ...
        If Not EditSua_Thue.Column Is Nothing Then AddHandler EditSua_Thue.EditColumn.Leave, AddressOf V_Tinh_Toan
        If Not EditTien_HHTV.Column Is Nothing Then AddHandler EditTien_HHTV.EditColumn.Leave, AddressOf V_Tinh_Toan
        If Not EditTien_HHPPK.Column Is Nothing Then AddHandler EditTien_HHPPK.EditColumn.Leave, AddressOf V_Tinh_Toan
        If Not EditPT_HH_TV.Column Is Nothing Then AddHandler EditPT_HH_TV.EditColumn.Leave, AddressOf V_Tinh_Toan
        If Not EditPT_HH_PPK.Column Is Nothing Then AddHandler EditPT_HH_PPK.EditColumn.Leave, AddressOf V_Tinh_Toan
        If Not EditPT_HH_TV.Column Is Nothing Then AddHandler EditPT_HH_TV.EditColumn.Leave, AddressOf V_Tinh_Toan
        If Not EditPT_HH_PPK.Column Is Nothing Then AddHandler EditPT_HH_PPK.EditColumn.Leave, AddressOf V_Tinh_Toan


        If Not EditPT_HH_HT.Column Is Nothing Then AddHandler EditPT_HH_HT.EditColumn.Leave, AddressOf V_Tinh_Toan
        If Not EditTIEN_HH_HT.Column Is Nothing Then AddHandler EditTIEN_HH_HT.EditColumn.Leave, AddressOf V_Tinh_Toan
        If Not EditPT_HH_NGANHANG.Column Is Nothing Then AddHandler EditPT_HH_NGANHANG.EditColumn.Leave, AddressOf V_Tinh_Toan
        If Not EditTIEN_HH_NGANHANG.Column Is Nothing Then AddHandler EditTIEN_HH_NGANHANG.EditColumn.Leave, AddressOf V_Tinh_Toan
        If Not EditPT_HH_KHAC.Column Is Nothing Then AddHandler EditPT_HH_KHAC.EditColumn.Leave, AddressOf V_Tinh_Toan
        If Not EditTIEN_HH_KHAC.Column Is Nothing Then AddHandler EditTIEN_HH_KHAC.EditColumn.Leave, AddressOf V_Tinh_Toan
        If Not EditPT_HH.Column Is Nothing Then AddHandler EditPT_HH.EditColumn.Leave, AddressOf V_Tinh_Toan
        If Not EditTIEN_HH.Column Is Nothing Then AddHandler EditTIEN_HH.EditColumn.Leave, AddressOf V_Tinh_Toan
        If Not EditMa_TT Is Nothing Then AddHandler EditMa_TT.EditColumn.Leave, AddressOf V_Tinh_Toan
        '-------------------------------------
...
#Region "Valid --- Ma_KH"
    ...
    Private Sub L_Ma_KH(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        ...
        If Not DrReturn Is Nothing Then
            ...
            ''CmbMa_TP.SelectedValue = IIf(CmbMa_TP.SelectedValue.Trim = "", DrReturn.Item("Ma_TP").ToString.Trim, CmbMa_TP.SelectedValue)
            ''CmbMa_Quan.SelectedValue = IIf(CmbMa_Quan.SelectedValue.Trim = "", DrReturn.Item("Ma_Quan").ToString.Trim, CmbMa_Quan.SelectedValue)
            ''CmbMa_Xa.SelectedValue = IIf(CmbMa_Xa.SelectedValue.Trim = "", DrReturn.Item("Ma_Xa").ToString.Trim, CmbMa_Xa.SelectedValue)
...
#Region "Valid --- Ma_Td3_H"
    ...
    Private Sub L_HDIGetThongTinHDX()
        ...
        If Dstmp.Tables(1).Columns.Contains("Dt_Lx") Then TxtDt_LX.Text = Dstmp.Tables(1).Rows(0).Item("Dt_Lx").ToString.Trim
        If Dstmp.Tables(1).Columns.Contains("Dien_Thoai") Then txtDien_Thoai.Text = Dstmp.Tables(1).Rows(0).Item("Dien_Thoai").ToString.Trim
        ...
        'If Dstmp.Tables(1).Columns.Contains("nam_sx") Then CmbNam_Sx.SelectedValue = Dstmp.Tables(1).Rows(0).Item("nam_sx").ToString.Trim
        If Dstmp.Tables(1).Columns.Contains("Ten_mau") Then TxtTen_Mau.Text = Dstmp.Tables(1).Rows(0).Item("Ten_mau").ToString.Trim
        If Dstmp.Tables(1).Columns.Contains("Ma_TVBH") Then TxtMa_TVBH.Text = Dstmp.Tables(1).Rows(0).Item("Ma_TVBH").ToString.Trim
        If Dstmp.Tables(1).Columns.Contains("Ten_TVBH") Then TxtTen_TVBH.Text = Dstmp.Tables(1).Rows(0).Item("Ten_TVBH").ToString.Trim
        If Dstmp.Tables(1).Columns.Contains("Gia_Xe") Then TxtGT_Xe.Text = Dstmp.Tables(1).Rows(0).Item("Gia_Xe").ToString.Trim
        If Dstmp.Tables(1).Columns.Contains("Ma_TP") Then CmbMa_TP.SelectedValue = Dstmp.Tables(1).Rows(0).Item("Ma_TP").ToString.Trim
        If Dstmp.Tables(1).Columns.Contains("Ma_Quan") Then CmbMa_Quan.SelectedValue = Dstmp.Tables(1).Rows(0).Item("Ma_Quan").ToString.Trim
        If Dstmp.Tables(1).Columns.Contains("Ma_Xa") Then CmbMa_Xa.SelectedValue = Dstmp.Tables(1).Rows(0).Item("Ma_Xa").ToString.Trim
...
#Region "Valid - Detail - Core"
    Private Sub UpdateList()
        ...
        Dim nT_HH_HT As Decimal = 0
        Dim nT_HH_NganHang As Decimal = 0
        Dim nT_HH_PPK As Decimal = 0
        Dim nT_HH_PKT As Decimal = 0
        ...
        For iRow As Integer = 0 To Dv_DetailTmp.Count - 1
            ...
            nT_HH = nT_HH + Dv_DetailTmp.Item(iRow).Item("Tien_HH")
            nT_HH_TV = nT_HH_TV + Dv_DetailTmp.Item(iRow).Item("Tien_HHTV")
            nT_HH_HT = nT_HH_HT + Dv_DetailTmp.Item(iRow).Item("Tien_HH_HT")
            nT_HH_NganHang = nT_HH_NganHang + Dv_DetailTmp.Item(iRow).Item("Tien_HH_NganHang")
            nT_HH_PPK = nT_HH_PPK + Dv_DetailTmp.Item(iRow).Item("Tien_HHPPK")
            nT_HH_PKT = nT_HH_PKT + Dv_DetailTmp.Item(iRow).Item("Tien_HHPKT")
            nT_HH_Khac = nT_HH_Khac + Dv_DetailTmp.Item(iRow).Item("TIEN_HH_KHAC")
            ...
            If Dt_DetailTmp.Rows(iRow).Item("Ma_TT").ToString.Trim.ToUpper = "I" Then
                nT_I = nT_I + Dt_DetailTmp.Rows(iRow).Item("Tien2") + Dt_DetailTmp.Rows(iRow).Item("Thue") '- Dt_DetailTmp.Rows(iRow).Item("CK_I")
            End If

            If Dt_DetailTmp.Rows(iRow).Item("Ma_TT").ToString.Trim.ToUpper = "W" Then
                nT_W = nT_W + Dt_DetailTmp.Rows(iRow).Item("Tien2") + Dt_DetailTmp.Rows(iRow).Item("Thue") ' - Dt_DetailTmp.Rows(iRow).Item("CK_I") 
            End If
            ...
            If Not (Dt_DetailTmp.Rows(iRow).Item("Ma_TT").ToString.Trim.ToUpper = "W" Or Dt_DetailTmp.Rows(iRow).Item("Ma_TT").ToString.Trim.ToUpper = "I" Or Dt_DetailTmp.Rows(iRow).Item("Ma_TT").ToString.Trim.ToUpper = "C") Then
                nT_N = nT_N + Dt_DetailTmp.Rows(iRow).Item("Tien2") + Dt_DetailTmp.Rows(iRow).Item("Thue") '- Dt_DetailTmp.Rows(iRow).Item("CK_I")
            End If
        Next
        '------------------------------------------------------------------------------------
        ...
        TxtT_HH_PPK.Double = nT_HH_PPK
        TxtT_HH_HT.Double = nT_HH_HT
        TxtT_HH_NganHang.Double = nT_HH_NganHang
        TxtT_HH_CTY.Double = nT_HH_CTY
        TxtT_HH_PKT.Double = nT_HH_PKT
        TxtT_HH.Double = nT_HH
        TxtT_HH_Khac.Double = nT_HH_Khac
    ...
    Private Sub V_Ngay_bd(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim _Ngay_Kt As Date = DateAdd(DateInterval.Month, _Thang, _Ngay_bd)
    ...
    Private Sub V_Tinh_Toan(ByVal iRow As Integer)
        ...
        '-------------------------------------------------------------------------------------------------
        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dim _Tien_HH As Double = 0
        Dim _Tong_PT_HH As Double = 0
        _Tong_PT_HH = Dv_DetailTmp.Item(iRow).Item("PT_HH")



        If _Tong_PT_HH <> 0 Then

            Dv_DetailTmp.Item(iRow).Item("Tien_HH") = CyberSupport.V_Round(_Tong_PT_HH * (Dv_DetailTmp.Item(iRow).Item("Tien2")) / 100, M_R_TIEN_NT)


            Dv_DetailTmp.Item(iRow).Item("Tien_HHTV") = CyberSupport.V_Round((Dv_DetailTmp.Item(iRow).Item("PT_HH_TV")) * CyberSupport.V_Round(_Tong_PT_HH * Dv_DetailTmp.Item(iRow).Item("Tien2") / 100, M_R_TIEN_NT) / 100, M_R_TIEN_NT)

            Dv_DetailTmp.Item(iRow).Item("TIEN_HH_HT") = CyberSupport.V_Round((Dv_DetailTmp.Item(iRow).Item("PT_HH_HT")) * CyberSupport.V_Round(_Tong_PT_HH * Dv_DetailTmp.Item(iRow).Item("Tien2") / 100, M_R_TIEN_NT) / 100, M_R_TIEN_NT)
            Dv_DetailTmp.Item(iRow).Item("TIEN_HH_NGANHANG") = CyberSupport.V_Round((Dv_DetailTmp.Item(iRow).Item("PT_HH_NGANHANG")) * CyberSupport.V_Round(_Tong_PT_HH * Dv_DetailTmp.Item(iRow).Item("Tien2") / 100, M_R_TIEN_NT) / 100, M_R_TIEN_NT)
            Dv_DetailTmp.Item(iRow).Item("TIEN_HHPPK") = CyberSupport.V_Round((Dv_DetailTmp.Item(iRow).Item("PT_HH_PPK")) * CyberSupport.V_Round(_Tong_PT_HH * Dv_DetailTmp.Item(iRow).Item("Tien2") / 100, M_R_TIEN_NT) / 100, M_R_TIEN_NT)
            If Dv_DetailTmp.Item(iRow).Item("Ma_TT") <> "N" Then
                Dv_DetailTmp.Item(iRow).Item("Tien_HHCTY") = CyberSupport.V_Round((Dv_DetailTmp.Item(iRow).Item("PT_HH_CTY")) * CyberSupport.V_Round(_Tong_PT_HH * Dv_DetailTmp.Item(iRow).Item("Tien2") / 100, M_R_TIEN_NT) / 100, M_R_TIEN_NT)

            End If
            If Dv_DetailTmp.Item(iRow).Item("Ma_TT") = "N" Then


                Dv_DetailTmp.Item(iRow).Item("Tien_HHCTY") = CyberSupport.V_Round(_Tong_PT_HH * (Dv_DetailTmp.Item(iRow).Item("Tien2")) / 100, M_R_TIEN_NT)


            End If
            Dv_DetailTmp.Item(iRow).Item("TIEN_HHPKt") = CyberSupport.V_Round((Dv_DetailTmp.Item(iRow).Item("PT_HH_PKT")) * CyberSupport.V_Round(_Tong_PT_HH * Dv_DetailTmp.Item(iRow).Item("Tien2") / 100, M_R_TIEN_NT) / 100, M_R_TIEN_NT)
            'Dv_DetailTmp.Item(iRow).Item("TIEN_HH_KHAC") = CyberSupport.V_Round((Dv_DetailTmp.Item(iRow).Item("PT_HH_KHAC")) * CyberSupport.V_Round(_Tong_PT_HH * Dv_DetailTmp.Item(iRow).Item("Tien2") / 100, M_R_TIEN_NT) / 100, M_R_TIEN_NT)
            Dv_DetailTmp.Item(iRow).Item("TIEN_HH_KHAC") = Dv_DetailTmp.Item(iRow).Item("Tien_HH") - Dv_DetailTmp.Item(iRow).Item("Tien_HHTV") - Dv_DetailTmp.Item(iRow).Item("TIEN_HH_HT") - Dv_DetailTmp.Item(iRow).Item("TIEN_HH_NGANHANG") - Dv_DetailTmp.Item(iRow).Item("TIEN_HHPPK") - Dv_DetailTmp.Item(iRow).Item("Tien_HHCTY") - Dv_DetailTmp.Item(iRow).Item("TIEN_HHPKt")
        Else
            Dv_DetailTmp.Item(iRow).Item("Tien_HH") = 0
            Dv_DetailTmp.Item(iRow).Item("Tien_HHTV") = 0
            Dv_DetailTmp.Item(iRow).Item("TIEN_HH_HT") = 0
            Dv_DetailTmp.Item(iRow).Item("TIEN_HH_NGANHANG") = 0
            Dv_DetailTmp.Item(iRow).Item("TIEN_HHCTY") = 0
            Dv_DetailTmp.Item(iRow).Item("TIEN_HH_KHAC") = 0
            Dv_DetailTmp.Item(iRow).Item("TIEN_HHPPK") = 0
            Dv_DetailTmp.Item(iRow).Item("TIEN_HHPKT") = 0
    ...
    '    If Dt_DetailTmp.Columns.Contains("Sua_Thue") Then
    '        If Dv_DetailTmp.Item(iRow).Item("Sua_Thue").ToString.Trim <> "1" Then
    '            Dv_DetailTmp.Item(iRow).Item("Thue") = Math.Round((Dv_DetailTmp.Item(iRow).Item("Tien2") - Dv_DetailTmp.Item(iRow).Item("CK_I")) * Dv_DetailTmp.Item(iRow).Item("Thue_Suat") / 100, 0, MidpointRounding.AwayFromZero)
    '        End If
    '    Else
    '        Dv_DetailTmp.Item(iRow).Item("Thue") = Math.Round((Dv_DetailTmp.Item(iRow).Item("Tien2") - Dv_DetailTmp.Item(iRow).Item("CK_I")) * Dv_DetailTmp.Item(iRow).Item("Thue_Suat") / 100, 0, MidpointRounding.AwayFromZero)
    '    End If

    '    If Dt_DetailTmp.Columns.Contains("Tien0") Then Dv_DetailTmp.Item(iRow).Item("Tien0") = Dv_DetailTmp.Item(iRow).Item("Tien2") - Dv_DetailTmp.Item(iRow).Item("CK_I")
    '    Dv_DetailTmp.Item(iRow).EndEdit()
...
#Region "L_Ma_TT"
    ...
    Private Sub L_Ma_TT(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        'End If
        '-------------------------------------------------------------------
        GetPT_HH(M_Stt_Rec, Dv_DetailTmp.Item(iRow).Item("Ma_LHBH"), Dv_DetailTmp.Item(iRow).Item("Ma_BH"), Dv_DetailTmp.Item(iRow).Item("Ma_TT"), TxtMa_HD_H.Text, Dv_DetailTmp.Item(iRow).Item("pt_hh"), Dv_DetailTmp.Item(iRow).Item("pt_hh_tv"), Dv_DetailTmp.Item(iRow).Item("pt_hh_HT"), Dv_DetailTmp.Item(iRow).Item("pt_hh_PPK"), Dv_DetailTmp.Item(iRow).Item("pt_hh_NganHang"), Dv_DetailTmp.Item(iRow).Item("pt_hh_KHac"), Dv_DetailTmp.Item(iRow).Item("pt_hh_cty"), Dv_DetailTmp.Item(iRow).Item("pt_hh_pkt"), iRow)
        Tinh_Gia2(iRow)
        V_Tinh_Toan(iRow)
        UpdateList()
...
#Region "LHBH "
    ...
    Private Sub GetPTBH()
        ...
        For i = 0 To nCount - 1
            'If Dt_DetailTmp.Rows(i).Item("Ma_TT").ToString.Trim.ToUpper = "C" Then
            GetPT_HH(M_Stt_Rec, Dv_DetailTmp.Item(i).Item("Ma_LHBH"), Dv_DetailTmp.Item(i).Item("Ma_BH"), Dv_DetailTmp.Item(i).Item("Ma_TT"), TxtMa_HD_H.Text, Dv_DetailTmp.Item(i).Item("pt_hh"), Dv_DetailTmp.Item(i).Item("pt_hh_tv"), Dv_DetailTmp.Item(i).Item("pt_hh_HT"), Dv_DetailTmp.Item(i).Item("pt_hh_PPK"), Dv_DetailTmp.Item(i).Item("pt_hh_NganHang"), Dv_DetailTmp.Item(i).Item("pt_hh_KHac"), Dv_DetailTmp.Item(i).Item("pt_hh_cty"), Dv_DetailTmp.Item(i).Item("pt_hh_pkt"), i)
...
#Region "Ma_BH "
    ...
    Private Sub L_Ma_BH(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dv_DetailTmp.Item(iRow).Item("Ma_TT") = IIf(Dv_DetailTmp.Item(iRow).Item("Ma_TT") = "", "C", Dv_DetailTmp.Item(iRow).Item("Ma_TT"))
        'Dv_DetailTmp.Item(iRow).Item("Ma_TTHD") = IIf(Dv_DetailTmp.Item(iRow).Item("Ma_TTHD") = "", "C", Dv_DetailTmp.Item(iRow).Item("Ma_TTHD"))
        ...
        V_Tinh_Toan(iRow)
    End Sub
    Private Sub GetPT_HH(ByVal stt_rec As String, ByVal Ma_LHBH As String, ByVal Ma_BH As String, ByVal Ma_TT As String, ByVal Ma_HD As String, ByVal PT_HH As Decimal, ByVal PT_HH_TV As Decimal, ByVal PT_HH_HT As Decimal, ByVal PT_HH_PPK As Decimal, ByVal PT_HH_NganHang As Decimal, ByVal PT_HH_KHac As Decimal, ByVal PT_HH_Cty As Decimal, ByVal PT_HH_PKT As Decimal, ByVal iRow As Decimal)
        Dim DsTienPTHH As DataSet
        Dim Dt As Date
        Dt = TxtNgay_Ct.Value
        Dim iTai_tung As Integer = 0
        Dim Tra_Thang As Integer = 0
        Dim Tra_Gop As Integer = 0
        ...
        If ChkTai_tung.Checked Then
            iTai_tung = 1
        End If
        If ChkTra_Thang.Checked Then
            Tra_Thang = 1
        End If
        If ChkTra_Gop.Checked Then
            Tra_Gop = 1
        End If
        ...
        If ChkLien_ket.Checked Then
            iLien_ket = 1
        End If
        DsTienPTHH = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_ICGetPTHHBH", stt_rec.Trim + "#" + _
        iLien_ket.ToString.Trim + "#" + iTai_tung.ToString.Trim + "#" + Ma_LHBH + "#" + Ma_BH + "#" + Ma_TT + "#" + TxtMa_HD_H.Text + "#" + TxtGT_Xe.Double.ToString.Trim.Replace(" ", "").Replace(",", ".") + "#" + _
          PT_HH.ToString.Trim.Replace(" ", "").Replace(",", ".") + "#" + _
         PT_HH_TV.ToString.Trim.Replace(" ", "").Replace(",", ".") + "#" + _
        PT_HH_HT.ToString.Trim.Replace(" ", "").Replace(",", ".") + "#" + _
        PT_HH_PPK.ToString.Trim.Replace(" ", "").Replace(",", ".") + "#" + _
        PT_HH_NganHang.ToString.Trim.Replace(" ", "").Replace(",", ".") + "#" + _
        PT_HH_KHac.ToString.Trim.Replace(" ", "").Replace(",", ".") + "#" + _
        PT_HH_Cty.ToString.Trim.Replace(" ", "").Replace(",", ".") + "#" + _
        PT_HH_PKT.ToString.Trim.Replace(" ", "").Replace(",", ".") + "#" + _
        Tra_Thang.ToString.Trim + "#" + Tra_Gop.ToString.Trim + "#" + _
        Dt.ToString("yyyyMMdd") + "#" + M_Mode + "#" + M_Ma_Dvcs + "#" + M_User_Name)

        Dv_DetailTmp.Item(iRow).BeginEdit()
        If Dv_DetailTmp.Item(iRow).Item("IS_SuaHH") = 0 Then Dv_DetailTmp.Item(iRow).Item("Pt_Hh_Tv") = DsTienPTHH.Tables(0).Rows(0).Item("pt_hh_tv")
        If Dv_DetailTmp.Item(iRow).Item("IS_SuaHH") = 0 Then Dv_DetailTmp.Item(iRow).Item("Pt_Hh_PPK") = DsTienPTHH.Tables(0).Rows(0).Item("pt_hh_PPK")
        If Dv_DetailTmp.Item(iRow).Item("IS_SuaHH") = 0 Then Dv_DetailTmp.Item(iRow).Item("Pt_Hh") = DsTienPTHH.Tables(0).Rows(0).Item("pt_hh")
        If Dv_DetailTmp.Item(iRow).Item("IS_SuaHH") = 0 Then Dv_DetailTmp.Item(iRow).Item("Pt_Hh_HT") = DsTienPTHH.Tables(0).Rows(0).Item("Pt_Hh_HT")
        If Dv_DetailTmp.Item(iRow).Item("IS_SuaHH") = 0 Then Dv_DetailTmp.Item(iRow).Item("PT_HH_NganHang") = DsTienPTHH.Tables(0).Rows(0).Item("PT_HH_NganHang")
        If Dv_DetailTmp.Item(iRow).Item("IS_SuaHH") = 0 Then Dv_DetailTmp.Item(iRow).Item("PT_HH_KHac") = DsTienPTHH.Tables(0).Rows(0).Item("PT_HH_KHac")
        If Dv_DetailTmp.Item(iRow).Item("IS_SuaHH") = 0 Then Dv_DetailTmp.Item(iRow).Item("PT_HH_CTY") = DsTienPTHH.Tables(0).Rows(0).Item("PT_HH_CTY")
        If Dv_DetailTmp.Item(iRow).Item("IS_SuaHH") = 0 Then Dv_DetailTmp.Item(iRow).Item("PT_HH_PKT") = DsTienPTHH.Tables(0).Rows(0).Item("PT_HH_PKT")

        If Dv_DetailTmp.Item(iRow).Item("Pt_Hh_Tv") = 0 And Dv_DetailTmp.Item(iRow).Item("IS_SuaHH") = 1 Then Dv_DetailTmp.Item(iRow).Item("Pt_Hh_Tv") = DsTienPTHH.Tables(0).Rows(0).Item("pt_hh_tv")
        If Dv_DetailTmp.Item(iRow).Item("Pt_Hh_PPK") = 0 And Dv_DetailTmp.Item(iRow).Item("IS_SuaHH") = 1 Then Dv_DetailTmp.Item(iRow).Item("Pt_Hh_PPK") = DsTienPTHH.Tables(0).Rows(0).Item("pt_hh_PPK")
        If Dv_DetailTmp.Item(iRow).Item("Pt_Hh") = 0 And Dv_DetailTmp.Item(iRow).Item("IS_SuaHH") = 1 Then Dv_DetailTmp.Item(iRow).Item("Pt_Hh") = DsTienPTHH.Tables(0).Rows(0).Item("pt_hh")
        If Dv_DetailTmp.Item(iRow).Item("Pt_Hh_HT") = 0 And Dv_DetailTmp.Item(iRow).Item("IS_SuaHH") = 1 Then Dv_DetailTmp.Item(iRow).Item("Pt_Hh_HT") = DsTienPTHH.Tables(0).Rows(0).Item("Pt_Hh_HT")
        If Dv_DetailTmp.Item(iRow).Item("PT_HH_NganHang") = 0 And Dv_DetailTmp.Item(iRow).Item("IS_SuaHH") = 1 Then Dv_DetailTmp.Item(iRow).Item("PT_HH_NganHang") = DsTienPTHH.Tables(0).Rows(0).Item("PT_HH_NganHang")
        If Dv_DetailTmp.Item(iRow).Item("PT_HH_KHac") = 0 And Dv_DetailTmp.Item(iRow).Item("IS_SuaHH") = 1 Then Dv_DetailTmp.Item(iRow).Item("PT_HH_KHac") = DsTienPTHH.Tables(0).Rows(0).Item("PT_HH_KHac")
        If Dv_DetailTmp.Item(iRow).Item("PT_HH_CTy") = 0 And Dv_DetailTmp.Item(iRow).Item("IS_SuaHH") = 1 Then Dv_DetailTmp.Item(iRow).Item("PT_HH_CTy") = DsTienPTHH.Tables(0).Rows(0).Item("PT_HH_CTy")
        If Dv_DetailTmp.Item(iRow).Item("PT_HH_PKT") = 0 And Dv_DetailTmp.Item(iRow).Item("IS_SuaHH") = 1 Then Dv_DetailTmp.Item(iRow).Item("PT_HH_PKT") = DsTienPTHH.Tables(0).Rows(0).Item("PT_HH_PKT")
...
#Region "Button"
    Private Sub V_Save(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        _StrXML = CyberSmodb.V_ConvertDataToXML({"CTHDI"}, {Dt_DetailTmp})
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_CheckSoKhung", _StrXML & "#" & M_Stt_Rec & "#" & _Ngay_Ct.ToString("yyyyMMdd") & "#" & TxtSo_khung.Text & "#" & TxtMa_Xe.Text & "#" & M_Mode & "#" & M_Ma_Dvcs & "#" & M_User_Name)

        If DsTmp.Tables(0).Rows(0).Item("Msg").ToString.Trim = "Y" Then
            If MsgBox("Số khung " + DsTmp.Tables(0).Rows(0).Item("So_Khung") + "-" + DsTmp.Tables(0).Rows(0).Item("Ten_LoaiBH") + " đã được lập trong năm?", MsgBoxStyle.YesNo, osysvar("M_CYBER_VER")) <> MsgBoxResult.Yes Then Return
        End If
    ...
    Private Sub V_New(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        '----------------------------------------------------------------------------
        TxtNgay_HT.Value = New Date(1900, 1, 1)
    End Sub
...
#Region "Option: LSSC/hen/"
    ...
    End Sub
#End Region
    Private Sub GetHachToan()
        If TxtSo_RO.Text = "" Then Exit Sub
        M_Ma_Post = CbbMa_Post.SelectedValue

        Dim _Ngay_CT, _Ngay_LCT, _Ngay_HT As Date
        _Ngay_CT = TxtNgay_Ct.Value
        _Ngay_LCT = TxtNgay_LCt.Value
        _Ngay_HT = TxtNgay_HT.Value
        Dim _Ma_TT As String = ""
        Dim _Ma_Xe As String = TxtMa_Xe.Text.Trim


        'TxtLenh_Ro.Text = CyberVoucher.V_GetSo_SO(M_Ma_CT, "S", M_Mode, Dt, TxtLenh_Ro.Text, M_Ma_Dvcs)
        Dim DsSo_Lenh As DataSet
        DsSo_Lenh = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_HDI_GetHachToan", _Ngay_HT.ToString("yyyyMMdd") + "#" + _
            _Ma_TT + "#" + TxtSo_RO.Text.Trim + "#" + TxtMa_Xe.Text + "#" + _Ngay_CT.ToString("yyyyMMdd") + "#" + _Ngay_LCT.ToString("yyyyMMdd") + "#" + _
            txtSo_ct.Text.Trim + "#" + TxtMa_Kh.Text + "#" + TxtTen_kh.Text + "#" + "" + "#" + _
            TxtDia_Chi.Text + "#" + "" + "#" + _
            M_Mode.Trim + "#" + M_Stt_Rec + "#" + M_Ma_CT.Trim + "#" + CbbMa_GD.SelectedValue.ToString.Trim + "#" + M_Ma_Dvcs + "#" + M_User_Name.Trim)


        'CyberSupport.V_MsgChk(DsSo_Lenh.Tables(0), SysVar, M_LAN)
        If DsSo_Lenh.Tables.Count > 0 Then
            MsgBox("Đã hạch toán thành công")
            Exit Sub
        End If
...
#End Region
    Private Sub V_Huy_Lenh(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If M_Stt_Rec.Trim = "" Then Exit Sub
        ...
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetHuyHDI", M_Stt_RecOld & "#" & M_Stt_Rec & "#" & M_Ma_CT & "#" & TxtMa_Dvcs.Text & "#" & M_User_Name)
        ...
        TxtSo_Ro_Huy.Text = DsTmp.Tables(1).Rows(0).Item("So_Ro_Huy")
        TxtStt_Rec_Huy.Text = DsTmp.Tables(1).Rows(0).Item("Stt_Rec_Huy")
        UpdateList()
    End Sub

    Private Sub V_CapNhatHD(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If M_Stt_Rec = "" Then Exit Sub
        If (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim Frm As FrmCapNhatHD
        Frm = New FrmCapNhatHD
        Frm.Sysvar = Me.osysvar
        Frm.Para = Me.M_Para
        Frm.AppConn = Me.AppConn
        Frm.Stt_Rec = M_Stt_Rec
        Frm.Ma_Ct = M_Ma_CT
        Frm.So_Ct = txtSo_ct.Text
        Frm.Ma_Post = CbbMa_Post.SelectedValue
        Frm.Ngay_Ct = TxtNgay_Ct.Value
        Frm.ShowDialog()
        If Not Frm.Save_OK Then Exit Sub
        txtSo_HDDT.Text = Frm.So_HDDT
        txtNgay_HDDT.Value = Frm.Ngay_HDDT
        txtSo_Seri.Text = Frm.So_Seri
    End Sub
End Class