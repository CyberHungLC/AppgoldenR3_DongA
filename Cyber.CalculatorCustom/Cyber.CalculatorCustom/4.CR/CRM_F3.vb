...
#Region "Declare "
    ...
    Dim _Dt_Tl_Nhanh As DataTable
    Dim _Dv_Tl_Nhanh As DataView
    Dim _Dt_Ly_do, _Dt_TDH As DataTable
...
#End Region
    ...
    Private Sub V_Load()
        ...
        _Dt_Ly_do = Dstmp.Tables(iTb).Copy()
        iTb = iTb + 1

        _Dt_TDH = Dstmp.Tables(iTb).Copy()
        iTb = iTb + 1

        _Dt_Tl_Nhanh = Dstmp.Tables(iTb).Copy()
        iTb = iTb + 1
        ...
        CyberFill.V_FillComBoxDefaul(CbbTL_Nhanh, _Dt_Tl_Nhanh, "Ma_Tl_Nhanh", "Ten_Tl_Nhanh", "Ngam_Dinh")
    ...
    Private Sub V_Addhander()
        ...
        AddHandler CbbTL_Nhanh.SelectedValueChanged, AddressOf V_TL_Nhanh
        AddHandler CmbTao_Bien.Click, AddressOf V_Ma_Xe_Click
        AddHandler CmdGoi_Dien1.Click, AddressOf V_Goi_Dien1
        AddHandler CmbXem_Ghi_Am.Click, AddressOf V_Xem_Ghi_Am
        AddHandler CmdLS_Ghi_Am.Click, AddressOf V_LichSuGhiAm
        AddHandler CmdCap_Nhat_TTKH.Click, AddressOf V_Cap_Nhat_TTKH
    End Sub
    Private Sub V_TL_Nhanh(ByVal Sender As System.Object, ByVal e As System.EventArgs)
        Dim _TL As String = CyberSmodb.GetvalueFromCombox(CbbTL_Nhanh)
        MsgBox(_TL)
...
#End Region
    Private Sub V_Ma_Xe_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        txtMa_XeNew.Text = CyberVoucher.V_FormatBien_So(txtMa_XeNew.Text, True)
        If txtMa_XeNew.Text.Trim = "" Then Exit Sub
        Dim Dr = CyberSmlistSys.V_CheckAndAddRowList(M_LAN, Me.Para, Me.Sysvar, AppConn, "DMXE", "Ma_Xe= N'" & txtMa_XeNew.Text.Trim.Replace("'", "").Replace("#", "") & "'", "Ma_Xe#So_Khung#", txtMa_XeNew.Text.Trim + "#" + TxtSo_Khung.Text.Trim, True)

    End Sub
    Private Sub V_Goi_Dien1(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If txtDien_Thoai.Text = "" Then Exit Sub

        Dim strAddParar As String = "CP_CMSCuocGoi#" + txtDien_Thoai.Text.Trim + "#" + TxtOng_Ba.Text.Trim + "#" + M_Ma_Dvcs.Trim + "#" + M_User_Name.Trim + "#" + M_Ma_Get.Trim
    ...
    Private Sub V_Xem_Ghi_Am(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        dsgetCuocgoi = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_CMSGhiAmCuocGoi", Ma_Get.Trim + "#" + Dt.ToString("yyyyMMdd").Trim + "#" + M_Ma_Dvcs.Trim + "#" + M_User_Name.Trim)
        ...
        'MsgBox(_Ten_KH + _Stt_Rec + _Dien_thoai + _Url_Call + _Domain + _Access_key + _Ipphone + M_User_Name + M_Ma_Dvcs)

        '_sysCMS.V_GetUrlMedia(_access_key, _UrlMedia)
        ' Gọi trên web
    End Sub

    Private Sub V_LichSuGhiAm(ByVal sender As System.Object, ByVal e As System.EventArgs)

        '---------------------------------------------
        Dim FrmLS_Calculator As New FrmLichSuGoi
        '---------------------------------------------
        FrmLS_Calculator.Loai = M_Loai
        FrmLS_Calculator.Ma_Loai = M_Ma_Loai
        FrmLS_Calculator.Ma_Ngay = M_Ma_Ngay
        FrmLS_Calculator.Ma_Get = Ma_Get
        FrmLS_Calculator.Ma_Get1 = Ma_Get1

        '---------------------------------------------
        FrmLS_Calculator.Lan = Me.Lan
        FrmLS_Calculator.Para = Me.Para
        FrmLS_Calculator.Sysvar = Me.Sysvar
        FrmLS_Calculator.AppConn = Me.AppConn
        FrmLS_Calculator.CyberSmlib = Me.CyberSmlib
        FrmLS_Calculator.CyberSupport = Me.CyberSupport
        FrmLS_Calculator.CyberFill = Me.CyberFill
        FrmLS_Calculator.CyberSmlistSys = Me.CyberSmlistSys
        FrmLS_Calculator.CyberSmodb = Me.CyberSmodb
        FrmLS_Calculator.CyberExport = Me.CyberExport
        FrmLS_Calculator.CyberVoucher = Me.CyberVoucher
        FrmLS_Calculator.CyberLoading = Me.CyberLoading

        FrmLS_Calculator.ShowInTaskbar = False
        FrmLS_Calculator.ShowDialog()
        If Not FrmLS_Calculator.Save_OK Then Exit Sub


    End Sub

    Private Sub V_Cap_Nhat_TTKH(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Dim Frm As New Crm_CapNhat
        Frm.Ma_Xe = TxtMa_Xe.Text.Trim
        Frm.Loai = M_Loai
        Frm.Ma_Loai = M_Ma_Loai
        Frm.Ma_Get1 = M_Ma_Get1
        Frm.Ma_Get = M_Ma_Get
        Frm.Lan = Me.Lan
        Frm.Para = Me.Para
