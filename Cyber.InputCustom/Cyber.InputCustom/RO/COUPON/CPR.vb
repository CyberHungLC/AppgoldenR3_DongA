...
#Region "Columns Edit"
    ...
    Dim Editma_Db_I, EditMa_Xe_I, EditMa_Kx_I, EditMa_Tuyen_I, EditMa_Ts, EditMa_Cc, EditMa_Coupon As New Cyber.Fill.CyberColumnGridView
    Dim EditSo_Luong, EditGia_Tri, EditDien_Giaii, EditSo_So, EditSo_Po, EditSo_Ro, EditSo_VT As New Cyber.Fill.CyberColumnGridView
    Dim EditSo_Seri As New Cyber.Fill.CyberColumnGridView
#End Region
...
#End Region
    Private Sub CPR_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
...
#Region "Load And Set And Default"
    Private Sub V_Load()
        ...
        TxtT_Gia_Tri.InputMask = IIf(DrDmct.Item("M_IP_MK_TIEN").ToString.Trim <> "", DrDmct.Item("M_IP_MK_TIEN").ToString.Trim, TxtT_Gia_Tri.InputMask)
    End Sub
    ...
    Private Sub V_GetColumn()       
        ...
        EditGia_Tri.GetColumn(DetailGRV, "Gia_Tri")
        ...
        EditMa_Coupon.GetColumn(DetailGRV, "Ma_Coupon")
    End Sub
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Detail()
        ...
        If Not EditGia_Tri.Column Is Nothing Then AddHandler EditGia_Tri.EditColumn.Leave, AddressOf L_Tinh_Toan

        'Ma_CPont
        EditMa_Coupon.V_ActiLookUpColumn(AddressOf V_Ma_Coupon, AddressOf L_Ma_Coupon)
        If Not EditSo_Seri.Column Is Nothing Then AddHandler EditSo_Seri.EditColumn.Leave, AddressOf L_So_Seri

        'Mã kiểu xe
        If Not EditMa_Kx_I.Column Is Nothing Then AddHandler EditMa_Kx_I.EditColumn.Leave, AddressOf L_Ma_Kx_i
    ...
    Private Sub VisibleColumnMa_GD()       
        Select Case CmbMa_GD.SelectedValue.ToString.Trim.ToUpper
            Case "2" 'Xuất cho xe mới               
                TxtMa_Xe.ReadOnly = True
                TxtSo_Khung.ReadOnly = True
            Case "3" 'Xuất cho xe dịch vụ                
                TxtMa_Xe.ReadOnly = False
                TxtSo_Khung.ReadOnly = False
        End Select
    End Sub
...
#Region "Valid --- Ma_TD3_H"
    ...
    Private Sub CP_GetHDCFromMa_HD()
        ...
        If Dt.Columns.Contains("So_Khung") Then TxtSo_Khung.Text = Dt.Rows(0).Item("So_Khung")
        If Dt.Columns.Contains("So_May") Then TxtSo_May.Text = Dt.Rows(0).Item("So_May")

        If Dt.Columns.Contains("Ma_Kx") Then TxtMa_Kx.Text = Dt.Rows(0).Item("Ma_Kx")
        If Dt.Columns.Contains("Ten_Kx") Then TxtTen_Kx.Text = Dt.Rows(0).Item("Ten_Kx")

        If Dt.Columns.Contains("Ma_Mau") Then TxtMa_Mau.Text = Dt.Rows(0).Item("Ma_Mau")
        If Dt.Columns.Contains("Ten_Mau") Then TxtTen_Mau.Text = Dt.Rows(0).Item("Ten_Mau")
        dsTMp.Dispose()
    End Sub
#End Region
...
#Region "Valid --- Ma_Kx"
    ...
    Private Sub L_Ma_Kx(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        ...
        If Not DrReturn Is Nothing Then
            TxtMa_Kx.Text = DrReturn.Item("Ma_Kh")
            TxtTen_Kx.Text = DrReturn.Item("Ten_Kh")
        Else
            TxtMa_Kx.Text = ""
            TxtTen_Kx.Text = ""
        End If
...
#Region "Valid Ma_Xe - So_Khung"    
    Private Sub V_GetTtXe(ByVal _row As Integer)
        If Not (M_Mode.Trim = "M" Or M_Mode.Trim = "S") Then Exit Sub
        If _row < 0 Then Exit Sub
        Dim _strF As String = ""
        Dim _strV As String = ""
        Dim _Ngay_Ct As Date = TxtNgay_Ct.Value
        CyberSmodb.GetValueData(Dv_DetailTmp.Item(_row), _strF, _strV, "Ten_Kx,Ten_Mau")
        Dim Dstmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetTtXe", M_Stt_Rec + "#" + M_Ma_CT + "#" + M_Mode + "#" + _Ngay_Ct.ToString("yyyyMMdd") + "#" + _strF + "#" + _strV + "#" + TxtMa_Dvcs.Text + "#" + M_User_Name)
        ...
        If Dstmp.Tables(1).Columns.Contains("So_May") Then Dv_DetailTmp.Item(_row).Item("So_May") = Dstmp.Tables(1).Rows(0).Item("So_May")
        If Dstmp.Tables(1).Columns.Contains("Ma_Kx") Then Dv_DetailTmp.Item(_row).Item("Ma_Kx") = Dstmp.Tables(1).Rows(0).Item("Ma_Kx")
        If Dstmp.Tables(1).Columns.Contains("Ten_Kx") Then Dv_DetailTmp.Item(_row).Item("Ten_Kx") = Dstmp.Tables(1).Rows(0).Item("Ten_Kx")
        If Dstmp.Tables(1).Columns.Contains("Ma_Mau") Then Dv_DetailTmp.Item(_row).Item("Ma_Mau") = Dstmp.Tables(1).Rows(0).Item("Ma_Mau")
        If Dstmp.Tables(1).Columns.Contains("Ten_Mau") Then Dv_DetailTmp.Item(_row).Item("Ten_Mau") = Dstmp.Tables(1).Rows(0).Item("Ten_Mau")
    End Sub
#End Region
#Region "Valid --- Ma_CPont"
    Private Sub V_Ma_Coupon(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        sender.V_LookUp(M_LAN, M_Para, osysvar, AppConn, DsLookup, "Ma_Coupon", "DmCoupon", "1=1", "1=1")
    End Sub
    Private Sub L_Ma_Coupon(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        ...
        If DrReturn Is Nothing Then
            Dv_DetailTmp.Item(iRow).Item("Ma_Coupon") = ""
            Dv_DetailTmp.Item(iRow).Item("Ten_Coupon") = ""
            Exit Sub
        End If
        iRow = DetailGRV.GetFocusedDataSourceRowIndex
        If iRow < 0 Then Exit Sub
        Dim _Ma_Coupon As String = DrReturn.Item("Ma_Coupon")
        Dim _Ten_Coupon As String = DrReturn.Item("Ten_Coupon")
        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dv_DetailTmp.Item(iRow).Item("Ma_Coupon") = _Ma_Coupon
        Dv_DetailTmp.Item(iRow).Item("Ten_Coupon") = IIf(Dv_DetailTmp.Item(iRow).Item("Ten_Coupon").ToString.Trim = "", _Ten_Coupon, Dv_DetailTmp.Item(iRow).Item("Ten_Coupon").ToString.Trim)
    ...
    Private Sub L_So_Seri(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        V_GetTtCoupon(iRow)
    End Sub
    Private Sub V_GetTtCoupon(ByVal irow As Integer)
        If Not (M_Mode.Trim = "M" Or M_Mode.Trim = "S") Then Exit Sub
        If irow < 0 Then Exit Sub

        Dim _Ma_Coupon As String = Dv_DetailTmp.Item(irow).Item("Ma_Coupon")
        Dim _So_Seri As Double = Dv_DetailTmp.Item(irow).Item("So_Seri")
        If _Ma_Coupon = "" Or _So_Seri = 0 Then Exit Sub

        Dim _Ma_GD As String = CmbMa_GD.SelectedValue.ToString.Trim
        Dim _Ngay_Ct As Date = TxtNgay_Ct.Value

        Dim Dstmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetTTCouponNCP", _Ma_Coupon & "#" & _So_Seri & "#" & M_Mode & "#" & _Ma_GD & "#" & _Ngay_Ct.ToString("yyyyMMdd") & "#" & TxtMa_Dvcs.Text & "#" & M_User_Name)

        Dim _ncout As Integer = Dstmp.Tables.Count
        ...
        If Not CyberSupport.V_MsgChk(Dstmp.Tables(0), osysvar, M_LAN) Then
            Dstmp.Dispose()
            Dv_DetailTmp.Item(irow).Item("So_Seri") = 0
            Return
        End If
...
#Region "Valid - Detail - Add On"
    ...
    Private Sub L_Ma_TD3_i(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If DrReturn Is Nothing Then
            ...
            Dv_DetailTmp.Item(iRow)("Ma_HD_I") = ""
            Dv_DetailTmp.Item(iRow)("Ten_HD_I") = ""
            Exit Sub
        End If

        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dv_DetailTmp.Item(iRow).Item("Ma_TD3_I") = DrReturn("Ma_TD3").ToString.Trim
        Dv_DetailTmp.Item(iRow).Item("Ma_HD_I") = DrReturn("Ma_HD").ToString.Trim

        If Dv_DetailTmp.Table.Columns.Contains("Ten_HD_I") Then
            If DrReturn.Table.Columns.Contains("Ten_HD") Then
                Dv_DetailTmp.Item(iRow).Item("Ten_HD_I") = DrReturn("Ten_HD").ToString.Trim
            Else
                Dv_DetailTmp.Item(iRow).Item("Ten_HD_I") = CyberSmodb.SQLGetvalue(AppConn, "Ten_HD", "DmHD", "(Ma_HD = N'" + DrReturn("Ma_HD").ToString.Trim + "')", CyberSmlib)
            End If
        End If
        Dv_DetailTmp.Item(iRow).EndEdit()
        If Dv_DetailTmp.Item(iRow)("Ma_TD3_I") <> "" Then V_GetTTXe_HD(iRow)
        DetailGRV.UpdateCurrentRow()
    End Sub
    Private Sub V_GetTTXe_HD(ByVal irow As Integer)
        Dim _Ma_TD3 As String = Dv_DetailTmp.Item(irow).Item("Ma_TD3_I")
        Dim _DsTTHD As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_HDMFromHDX_New", "0#" + M_Mode.Trim + "#" + _Ma_TD3.Trim + "#" + TxtMa_Dvcs.Text.Trim.Trim + "#" + M_Ma_Dvcs.Trim)

        If _DsTTHD.Tables.Count = 0 Then
            _DsTTHD.Dispose()
            Exit Sub
        End If

        For i As Integer = 0 To _DsTTHD.Tables.Count - 1
            CyberSmodb.SetNotNullTable(_DsTTHD.Tables(i))
        Next

        If Not CyberSupport.V_MsgChk(_DsTTHD.Tables(0), osysvar, M_LAN) Then
            _DsTTHD.Dispose()
            Exit Sub
        End If

        If _DsTTHD.Tables.Count = 1 Then
            _DsTTHD.Dispose()
            Exit Sub
        End If

        If _DsTTHD.Tables(1).Rows.Count = 0 Then
            _DsTTHD.Dispose()
            Exit Sub
        End If

        If _DsTTHD.Tables(1).Columns.Contains("So_Khung") Then Dv_DetailTmp.Item(irow).Item("So_Khung") = _DsTTHD.Tables(1).Rows(0).Item("So_Khung").ToString.Trim
        If _DsTTHD.Tables(1).Columns.Contains("So_May") Then Dv_DetailTmp.Item(irow).Item("So_May") = _DsTTHD.Tables(1).Rows(0).Item("So_May").ToString.Trim
        If _DsTTHD.Tables(1).Columns.Contains("Ma_Kx") Then Dv_DetailTmp.Item(irow).Item("Ma_Kx") = _DsTTHD.Tables(1).Rows(0).Item("Ma_Kx").ToString.Trim
        If _DsTTHD.Tables(1).Columns.Contains("Ten_Kx") Then Dv_DetailTmp.Item(irow).Item("Ten_Kx") = _DsTTHD.Tables(1).Rows(0).Item("Ten_Kx").ToString.Trim
        If _DsTTHD.Tables(1).Columns.Contains("Ma_Mau") Then Dv_DetailTmp.Item(irow).Item("Ma_Mau") = _DsTTHD.Tables(1).Rows(0).Item("Ma_Mau").ToString.Trim
        If _DsTTHD.Tables(1).Columns.Contains("Ten_Mau") Then Dv_DetailTmp.Item(irow).Item("Ten_Mau") = _DsTTHD.Tables(1).Rows(0).Item("Ten_Mau").ToString.Trim

        If _DsTTHD.Tables(1).Columns.Contains("Ma_Kh") Then Dv_DetailTmp.Item(irow).Item("Ma_Kh_i") = _DsTTHD.Tables(1).Rows(0).Item("Ma_Kh")
        If _DsTTHD.Tables(1).Columns.Contains("Ten_Kh") Then Dv_DetailTmp.Item(irow).Item("Ten_Kh_i") = _DsTTHD.Tables(1).Rows(0).Item("Ten_Kh")
    End Sub
...
#Region "Button"
    ...
    Private Function ChkVsave() As Boolean
        ...
        For iRow = nCount - 1 To 0 Step -1
            If Dt_DetailTmp.Rows(iRow).Item("Ma_Coupon").ToString.Trim = "" Then
        ...
        For iRow = 0 To Dt_DetailTmp.Rows.Count - 1
            ...
            Dt_DetailTmp.Rows(iRow).Item("So_khung") = TxtSo_Khung.Text.Trim
...
#Region "Sms - Import"
    ...
    Private Sub SetTxt()
        ...
        TxtMa_Mau.ReadOnly = True
        TxtTen_Mau.ReadOnly = True

        TxtT_So_Luong.ReadOnly = True
        TxtT_Gia_Tri.ReadOnly = True
    End Sub
#End Region
