...
Public Class Filter_HD3
    ...
    Private Sub Filter_HD3_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
        V_AddMenuShorcut()
        V_Addhander()
    End Sub
...
#End Region
    Private Sub L_Lenh_Ro(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim _Ma_TTCP As String = TxtMa_TTCP.Text
        If TxtSo_Ro.Text = "" Then Exit Sub
        If _Ma_TTCP = "" Then Exit Sub
        TxtSo_Ro.Text = CyberVoucher.V_FormatSo_Ro(AppConn, osysvar, Me.Ma_CT, "S", "S", _Ngay_CT, TxtSo_Ro.Text, _Ma_TTCP, M_Ma_Dvcs, M_User_Name, CyberSmlib)
    End Sub
End Class
