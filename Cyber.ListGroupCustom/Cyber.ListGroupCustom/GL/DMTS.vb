...
Public Class DMTS
    ...
    Dim EditHTMa_NV, EditHTMa_Tang, EditHTMa_bpts, EditHTGt_da_kh, EditHTGt_kh_ky, EditHTNguyen_gia, EditHTTk_co, EditHTTk_no, _
        ...
        EditHTMa_TD1, EditHTMa_TD2, EditHTMa_TD3, EditHTMa_TD4, EditHTMa_TD5, EditHTTK_phi, EditHTMa_Bp1, EditHTMa_phi1, EditHTTK_phi1, EditHTMa_Bp2, EditHTTK_phi2, EditHTMa_phi2, EditHTMa_Bp3, EditHTMa_phi3, EditHTTK_phi3 As New Cyber.Fill.CyberColumnGridView
...
#Region "Load"
    ...
    Private Sub V_AddHandlerDetail()
        ...
        EditHTMa_Bp1.V_ActiLookUpColumn(AddressOf V_HTMa_Bp1, AddressOf L_HTMa_Bp1)
        EditHTMa_phi1.V_ActiLookUpColumn(AddressOf V_HTMa_phi1, AddressOf L_HTMa_phi1)
        EditHTMa_Bp2.V_ActiLookUpColumn(AddressOf V_HTMa_Bp2, AddressOf L_HTMa_Bp2)
        EditHTMa_phi2.V_ActiLookUpColumn(AddressOf V_HTMa_phi2, AddressOf L_HTMa_phi1)
        EditHTMa_Bp3.V_ActiLookUpColumn(AddressOf V_HTMa_Bp3, AddressOf L_HTMa_Bp3)
        EditHTMa_phi3.V_ActiLookUpColumn(AddressOf V_HTMa_phi3, AddressOf L_HTMa_phi3)
        ...
        EditHTMa_Bp1.V_ActiLookUpColumn(AddressOf V_HTMa_Bp1, AddressOf L_HTMa_Bp1)
        EditHTMa_phi1.V_ActiLookUpColumn(AddressOf V_HTMa_phi1, AddressOf L_HTMa_phi1)
        EditHTTK_phi1.V_ActiLookUpColumn(AddressOf V_HTTK_phi1, AddressOf L_HTTK_phi1)

        EditHTMa_Bp2.V_ActiLookUpColumn(AddressOf V_HTMa_Bp2, AddressOf L_HTMa_Bp2)
        EditHTMa_phi2.V_ActiLookUpColumn(AddressOf V_HTMa_phi2, AddressOf L_HTMa_phi2)
        EditHTTK_phi2.V_ActiLookUpColumn(AddressOf V_HTTK_phi2, AddressOf L_HTTK_phi2)

        EditHTMa_Bp3.V_ActiLookUpColumn(AddressOf V_HTMa_Bp3, AddressOf L_HTMa_Bp3)
        EditHTMa_phi3.V_ActiLookUpColumn(AddressOf V_HTMa_phi3, AddressOf L_HTMa_phi3)
        EditHTTK_phi3.V_ActiLookUpColumn(AddressOf V_HTTK_phi3, AddressOf L_HTTK_phi3)

        EditHTMa_Bp.V_ActiLookUpColumn(AddressOf V_HTMa_Bp, AddressOf L_HTMa_Bp)
        EditHTMa_phi.V_ActiLookUpColumn(AddressOf V_HTMa_phi, AddressOf L_HTMa_phi)
        EditHTTK_phi.V_ActiLookUpColumn(AddressOf V_HTTK_phi, AddressOf L_HTTK_phi)
    ...
    Sub V_GetColumns()
        ...
        EditHTMa_Bp1.GetColumn(DetailGRVHach_toan, "Ma_Bp1")
        EditHTMa_phi1.GetColumn(DetailGRVHach_toan, "Ma_phi1")
        EditHTMa_Bp2.GetColumn(DetailGRVHach_toan, "Ma_Bp2")
        EditHTMa_phi2.GetColumn(DetailGRVHach_toan, "Ma_phi2")
        EditHTMa_Bp3.GetColumn(DetailGRVHach_toan, "Ma_Bp3")
        EditHTMa_phi3.GetColumn(DetailGRVHach_toan, "Ma_phi3")
        EditHTTK_phi.GetColumn(DetailGRVHach_toan, "TK_Phi")
        EditHTTK_phi1.GetColumn(DetailGRVHach_toan, "TK_Phi1")
        EditHTTK_phi2.GetColumn(DetailGRVHach_toan, "TK_Phi2")
        EditHTTK_phi3.GetColumn(DetailGRVHach_toan, "TK_Phi3")
...
#Region "Nguồn vốn"
    ...
    Private Sub V_Tinh_Toan(ByVal iRow As Integer)
        ...
        If tbCtdmts.Rows(iRow).Item("Thang_KH") <> 0 Then
...
#Region " NV --- TTLN/TTCP/..."
    ...
    Private Sub L_NVMa_Db(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        DetailGRVHach_toan.UpdateCurrentRow()
    End Sub
    Private Sub V_HTTK_phi(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If Not (Mode = "M" Or Mode = "S") Then Exit Sub
        sender.V_LookUp(M_LAN, M_Para, oSysvar, Appconn, DsLookup, "tk", "Dmtk", "1=1", "1=1")
    End Sub
    Private Sub L_HTTK_phi(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (Mode = "M" Or Mode = "S") Then Exit Sub
        Dim drvCurren As DataRowView
        drvCurren = DetailGRVHach_toan.GetFocusedRow
        If drvCurren Is Nothing Then Exit Sub
        ...
        If DrReturn Is Nothing Then
            ...
            Exit Sub
        End If
        drvCurren("TK_Phi") = DrReturn("TK")
        DetailGRVHach_toan.UpdateCurrentRow()
    End Sub
#End Region
    Private Sub V_HTMa_Bp1(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If Not (Mode = "M" Or Mode = "S") Then Exit Sub
        sender.V_LookUp(M_LAN, M_Para, oSysvar, Appconn, DsLookup, "Ma_Bp", "DmBp", "1=1", "1=1")
    End Sub
    Private Sub L_HTMa_Bp1(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (Mode = "M" Or Mode = "S") Then Exit Sub
        Dim drvCurren As DataRowView
        drvCurren = DetailGRVHach_toan.GetFocusedRow
        If drvCurren Is Nothing Then Exit Sub
        ...
        If DrReturn Is Nothing Then
            ...
            Exit Sub
        End If
        drvCurren("Ma_Bp1") = DrReturn("Ma_Bp")
        DetailGRVHach_toan.UpdateCurrentRow()
    End Sub
    Private Sub V_HTMa_phi1(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If Not (Mode = "M" Or Mode = "S") Then Exit Sub
        sender.V_LookUp(M_LAN, M_Para, oSysvar, Appconn, DsLookup, "Ma_Phi", "DmPhi", "1=1", "1=1")
    End Sub
    Private Sub L_HTMa_phi1(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (Mode = "M" Or Mode = "S") Then Exit Sub
        Dim drvCurren As DataRowView
        drvCurren = DetailGRVHach_toan.GetFocusedRow
        If drvCurren Is Nothing Then Exit Sub
        ...
        If DrReturn Is Nothing Then
            ...
            Exit Sub
        End If
        drvCurren("Ma_Phi1") = DrReturn("Ma_Phi")
        DetailGRVHach_toan.UpdateCurrentRow()
    End Sub
    Private Sub V_HTTK_phi1(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If Not (Mode = "M" Or Mode = "S") Then Exit Sub
        sender.V_LookUp(M_LAN, M_Para, oSysvar, Appconn, DsLookup, "tk", "Dmtk", "1=1", "1=1")
    End Sub
    Private Sub L_HTTK_phi1(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (Mode = "M" Or Mode = "S") Then Exit Sub
        Dim drvCurren As DataRowView
        drvCurren = DetailGRVHach_toan.GetFocusedRow
        If drvCurren Is Nothing Then Exit Sub
        ...
        If DrReturn Is Nothing Then
            ...
            Exit Sub
        End If
        drvCurren("TK_Phi1") = DrReturn("TK")
        DetailGRVHach_toan.UpdateCurrentRow()
    End Sub

    Private Sub V_HTMa_Bp2(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If Not (Mode = "M" Or Mode = "S") Then Exit Sub
        sender.V_LookUp(M_LAN, M_Para, oSysvar, Appconn, DsLookup, "Ma_Bp", "DmBp", "1=1", "1=1")
    End Sub
    Private Sub L_HTMa_Bp2(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (Mode = "M" Or Mode = "S") Then Exit Sub
        Dim drvCurren As DataRowView
        drvCurren = DetailGRVHach_toan.GetFocusedRow
        If drvCurren Is Nothing Then Exit Sub
        ...
        If DrReturn Is Nothing Then
            ...
            Exit Sub
        End If
        drvCurren("Ma_Bp2") = DrReturn("Ma_Bp")
        DetailGRVHach_toan.UpdateCurrentRow()
    End Sub
    Private Sub V_HTMa_phi2(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If Not (Mode = "M" Or Mode = "S") Then Exit Sub
        sender.V_LookUp(M_LAN, M_Para, oSysvar, Appconn, DsLookup, "Ma_Phi", "DmPhi", "1=1", "1=1")
    End Sub
    Private Sub L_HTMa_phi2(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (Mode = "M" Or Mode = "S") Then Exit Sub
        Dim drvCurren As DataRowView
        drvCurren = DetailGRVHach_toan.GetFocusedRow
        If drvCurren Is Nothing Then Exit Sub
        ...
        If DrReturn Is Nothing Then
            ...
            Exit Sub
        End If
        drvCurren("Ma_Phi2") = DrReturn("Ma_Phi")
        DetailGRVHach_toan.UpdateCurrentRow()
    End Sub
    Private Sub V_HTTK_phi2(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If Not (Mode = "M" Or Mode = "S") Then Exit Sub
        sender.V_LookUp(M_LAN, M_Para, oSysvar, Appconn, DsLookup, "tk", "Dmtk", "1=1", "1=1")
    End Sub
    Private Sub L_HTTK_phi2(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (Mode = "M" Or Mode = "S") Then Exit Sub
        Dim drvCurren As DataRowView
        drvCurren = DetailGRVHach_toan.GetFocusedRow
        If drvCurren Is Nothing Then Exit Sub
        ...
        If DrReturn Is Nothing Then
            ...
            Exit Sub
        End If
        drvCurren("TK_Phi2") = DrReturn("TK")
        DetailGRVHach_toan.UpdateCurrentRow()
    End Sub

    Private Sub V_HTMa_Bp3(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If Not (Mode = "M" Or Mode = "S") Then Exit Sub
        sender.V_LookUp(M_LAN, M_Para, oSysvar, Appconn, DsLookup, "Ma_Bp", "DmBp", "1=1", "1=1")
    End Sub
    Private Sub L_HTMa_Bp3(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (Mode = "M" Or Mode = "S") Then Exit Sub
        Dim drvCurren As DataRowView
        drvCurren = DetailGRVHach_toan.GetFocusedRow
        If drvCurren Is Nothing Then Exit Sub
        ...
        If DrReturn Is Nothing Then
            ...
            Exit Sub
        End If
        drvCurren("Ma_Bp3") = DrReturn("Ma_Bp")
        DetailGRVHach_toan.UpdateCurrentRow()
    End Sub
    Private Sub V_HTMa_phi3(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If Not (Mode = "M" Or Mode = "S") Then Exit Sub
        sender.V_LookUp(M_LAN, M_Para, oSysvar, Appconn, DsLookup, "Ma_Phi", "DmPhi", "1=1", "1=1")
    End Sub
    Private Sub L_HTMa_phi3(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (Mode = "M" Or Mode = "S") Then Exit Sub
        Dim drvCurren As DataRowView
        drvCurren = DetailGRVHach_toan.GetFocusedRow
        If drvCurren Is Nothing Then Exit Sub
        ...
        If DrReturn Is Nothing Then
            ...
            Exit Sub
        End If
        drvCurren("Ma_Phi3") = DrReturn("Ma_Phi")
        DetailGRVHach_toan.UpdateCurrentRow()
    End Sub
    Private Sub V_HTTK_phi3(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If Not (Mode = "M" Or Mode = "S") Then Exit Sub
        sender.V_LookUp(M_LAN, M_Para, oSysvar, Appconn, DsLookup, "tk", "Dmtk", "1=1", "1=1")
    End Sub
    Private Sub L_HTTK_phi3(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (Mode = "M" Or Mode = "S") Then Exit Sub
        Dim drvCurren As DataRowView
        drvCurren = DetailGRVHach_toan.GetFocusedRow
        If drvCurren Is Nothing Then Exit Sub
