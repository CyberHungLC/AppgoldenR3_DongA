...
#Region "Load"
    ...
    Private Sub V_Addhander()
        ...
        '-- Check loại xe
        AddHandler ChkXe_Kd.Click, AddressOf V_Chk_XeKd
        AddHandler ChkXe_Dv.Click, AddressOf V_Chk_XeDv
    End Sub
    Private Sub V_Chk_XeKd(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If ChkXe_Kd.Checked Then
            ChkXe_Dv.Checked = False
        Else
            If ChkXe_Dv.Checked Then
                ChkXe_Kd.Checked = False
            End If
        End If
    End Sub

    Private Sub V_Chk_XeDv(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If ChkXe_Dv.Checked Then
            ChkXe_Kd.Checked = False
        Else
            If Not ChkXe_Dv.Checked Then
                ChkXe_Kd.Checked = False
            End If
        End If
    End Sub
...
#Region "Button"
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        M_strParameterStore = M_strParameterStore & "#" & IIf(ChkXe_Kd.Checked, "1", "0")
        M_strParameterStore = M_strParameterStore & "#" & IIf(ChkXe_Dv.Checked, "1", "0")
