...
#End Region
    Private Sub V_Load()
        ...
        If TxtM_Tk.Text.Trim = "" Then TxtTen_Tk.Text = "" Else TxtTen_Tk.Text = CyberSmodb.SQLGetvalue(AppConn, "Ten_Tk", "DmTk", "Tk = '" + TxtM_Tk.Text + "'")
        ...
        Dim _Dt_Loai_lenh As DataTable = DsTmp.Tables(0).Copy
...
#Region "Valid --- Tk"
    Private Sub V_Tk(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        TxtM_Tk.V_LookUp(Me.LAN, Me.Para, Me.sysvar, AppConn, DsLookup, "Tk", "DmTK", "1=1", "1=1")
    End Sub
...
#Region "Button"
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim _Loai_Lenh As String = Me.CbbLoai_lenh.SelectedValue.ToString.Trim
        ...
        M_strParameterStore = M_strParameterStore & "#" & _Loai_Lenh
