...
Public Class FrmLocPDX_To_PN3
    ...
    Sub V_Loaddatatabase(ByVal Status As String)
        ...
        Dim _DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetPDXToPN3", Status & "#" & M_Ma_GD & "#" & TxtMa_TD2.Text & "#" &
                                                                    _Dt1.ToString("yyyyMMdd") & "#" + _Dt2.ToString("yyyyMMdd") & "#" &
...
#Region "Click ..."
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Countxe > 1 Then
            MsgBox("Bạn không được nhập trên 1 xe")
            Exit Sub
        End If
        Me.Close()
    End Sub
