...
Public Class CRM_SMS_05
    ...
    Dim _KeyMa_KN As String = "0"
    Dim _Ngay_Gui As DateTime = DateTime.Now
    ...
    Private Sub V_AddHander()
        ...
        'Ma_KN
        AddHandler TxtMa_KN.CyberValiting, AddressOf V_Ma_KN
        AddHandler TxtMa_KN.CyberLeave, AddressOf L_Ma_KN
...
#Region "Danh sách nút chức năng"
    Private Sub MasterGRV_PopupMenuShowing(ByVal sender As System.Object, ByVal e As DevExpress.XtraGrid.Views.Grid.PopupMenuShowingEventArgs)
        ...
        PopupMenuMasterGrid.ItemLinks.Add(New Cyber.SmLib.CyberMenuPopup(sender, rowHandle, IIf(Lan = "V", "Xem lịch sử", "History"), AddressOf V_History, Shortcut.F8, , True, False))
...
#Region "Load Default"
    Private Sub V_Getdefault()
        ...
        TxtMa_KN.Text = CyberSmlib.GetKeyValueRegistry(Me.Sysvar, TxtMa_KN)
        TxtMa_GT.Text = CyberSmlib.GetKeyValueRegistry(Me.Sysvar, TxtMa_GT)

        If TxtMa_KN.Text = "" Then TxtTen_KN.Text = "" Else TxtTen_KN.Text = CyberSmodb.SQLGetvalue(AppConn, "Ten_KN", "DmNgayKN", "Ma_KN = N'" + TxtMa_KN.Text.Trim + "'", CyberSmlib)
...
#Region "LoadData"
    Private Sub V_LoadData(ByVal Status As String)
        ...
        Dim _Dt3 As Date = "01/01/1900"
        Dim _Dt4 As Date = "01/01/1900"
        Dim _Ma_KN As String = TxtMa_KN.Text.Trim
...
#End Region
#Region "Valid --- Ma_KN"
    Private Sub V_Ma_KN(ByVal sender As System.Object, ByVal e As System.EventArgs)
        TxtMa_KN.V_LookUp(M_LAN, Me.Para, Me.Sysvar, AppConn, DsLookup, "Ma_KN", "DmNgayKN", "1=1", "1=1")
    End Sub
    Private Sub L_Ma_KN(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If TxtMa_KN.Text = "" Then
            TxtTen_KN.Text = ""
            _KeyMa_KN = "0"
            Exit Sub
        End If
        DrReturn = TxtMa_KN.GetRowsSelectData(True)
        If Not DrReturn Is Nothing Then
            TxtMa_KN.Text = DrReturn.Item("Ma_KN")
            TxtTen_KN.Text = DrReturn.Item("Ten_KN")
            _KeyMa_KN = "1"
        Else
            TxtMa_KN.Text = ""
            TxtTen_KN.Text = ""
...
#Region "Valid Ma_SMS"
    Private Sub V_Ma_SMS(ByVal sender As System.Object, ByVal e As System.EventArgs)
        TxtMa_SMS.V_LookUp(M_LAN, Me.Para, Me.Sysvar, AppConn, DsLookup, "Ma_SMS", "DmSMSTemplate", "1=1", IIf(_KeyMa_KN = "0", "1=1", "(Ma_KN = '" & TxtMa_KN.Text.Trim & "')"))
    End Sub
