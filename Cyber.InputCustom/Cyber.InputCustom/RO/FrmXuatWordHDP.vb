...
Public Class FrmXuatWordHDP
    ...
    Private Sub V_Load()
        ...
        M_DrDmCt = Me.DrDmct
        Dim ds As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_SysGetPrintWord", Ma_CT & "#" & M_Ma_Dvcs & "#" & M_User_name)
        DtMaIn = ds.Tables(0)
    ...
    Private Sub V_Print(ByVal _Status)
        ...
        Dim _DsLoc As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_Print" + Ma_CT + "_Word", CbbMa_In.SelectedValue.ToString.Trim & "#" & Stt_Rec & "#" & M_User_name.ToString.Trim)
