...
#Region "Columns Edit"
    ...
    Dim Editma_Db_I, EditMa_Xe_I, EditMa_KX_I, EditMa_Tuyen_I, EditMa_Ts, EditNh_CC1, EditTk_TT_I, EditTk_Cp_I As New Cyber.Fill.CyberColumnGridView 'Cyber.SmLists.EditLookUp
...
#Region "Load And Set And Default"
    ...
    Private Sub V_GetColumn()
        ...
        EditTk_TT_I.GetColumn(DetailGRV, "Tk_TT_I")
        EditTk_Cp_I.GetColumn(DetailGRV, "Tk_Cp_I")
    End Sub
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Detail()
        ...
        EditTk_TT_I.V_ActiLookUpColumn(AddressOf V_Tk_TT_I, AddressOf L_TK_TT_I)
        EditTk_Cp_I.V_ActiLookUpColumn(AddressOf V_TK_Cp_I, AddressOf L_Tk_Cp_I)
...
#Region "So_Ct_DXM"
    ...
    Private Sub L_So_CT_DXM(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim _DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetDetailPNIFromDXM", "1#" & "19000101" & "#" & "19000101" & "#" & TxtSo_Ct_DXM.Text & "#" & TxtMa_Kh.Text & "#" & M_Stt_Rec & "#" & M_Ma_CT & "#" & M_Ma_Dvcs & "#" & M_User_Name)
...
#Region "Vat tu kho/Vitri - "
    ...
    Private Sub L_Ma_Cc(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim _Tk_Kho As String = DrReturn.Item("Tk_CC")
        Dim _Tk_Cp As String = DrReturn.Item("Tk_Cp")
        Dim _Tk_TT As String = DrReturn.Item("Tk_TT")
        Dim _So_Ky_Pb As String = DrReturn.Item("So_Ky_Pb")
        ...
        Dv_DetailTmp.Item(iRow).Item("Tk_Cp_I") = _Tk_Cp
        Dv_DetailTmp.Item(iRow).Item("Tk_TT_I") = _Tk_TT
        Dv_DetailTmp.Item(iRow).Item("So_Ky_Pb_I") = _So_Ky_Pb
        Dv_DetailTmp.Item(iRow).EndEdit()
        Dv_DetailTmp.Table.AcceptChanges()
        V_SetSD(iRow)
        UpdateList()
...
#End Region
    ...
    Private Sub V_Tk_TT_I(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        CyberSupport.V_Lookup("Tk", "DmTk", "1=1", "1=1", M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_TK_TT_I(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim iRow As Integer = -1
        iRow = DetailGRV.GetFocusedDataSourceRowIndex
        If iRow < 0 Then Exit Sub
        DrReturn = CyberSupport.L_Lookup(M_Mode, M_Ma_CT, sender, True)
        If DrReturn Is Nothing Then
            Dv_DetailTmp.Item(iRow)("TK_TT_I") = ""
            Exit Sub
        End If
        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dv_DetailTmp.Item(iRow).Item("Tk_TT_I") = DrReturn("Tk").ToString.Trim
        Dv_DetailTmp.Item(iRow).EndEdit()
        DetailGRV.UpdateCurrentRow()
    End Sub
    Private Sub V_Tk_Cp_I(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        CyberSupport.V_Lookup("Tk", "DmTk", "1=1", "1=1", M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
    Private Sub L_TK_Cp_I(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim iRow As Integer = -1
        iRow = DetailGRV.GetFocusedDataSourceRowIndex
        If iRow < 0 Then Exit Sub
        DrReturn = CyberSupport.L_Lookup(M_Mode, M_Ma_CT, sender, True)
        If DrReturn Is Nothing Then
            Dv_DetailTmp.Item(iRow)("TK_Cp_I") = ""
            Exit Sub
        End If
        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dv_DetailTmp.Item(iRow).Item("Tk_Cp_I") = DrReturn("Tk").ToString.Trim
        Dv_DetailTmp.Item(iRow).EndEdit()
        DetailGRV.UpdateCurrentRow()
    End Sub
