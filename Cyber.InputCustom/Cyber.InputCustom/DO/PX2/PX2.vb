...
#Region "Load And Set And Default"
    ...
    Private Sub V_GetColumn()
        ...
        EditSo_Ro2.GetColumn(DetailGRV, "SO_RO2")
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Master()
        ...
        AddHandler CmdLoc_PO.Click, AddressOf V_Loc_PO
    ...
    Private Sub V_AddHandler_Detail()
        ...
        If Not EditSo_Ro2.Column Is Nothing Then AddHandler EditSo_Ro2.EditColumn.Leave, AddressOf L_So_Ro2
    ...
    Private Sub V_Loc_PO(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (M_Mode.Trim = "M" Or M_Mode.Trim = "S") Then Exit Sub
        Dim frm As New FrmLocPX2
...
#Region "Lenh/SO/Po/Ro/Vt"
    ...
    Private Sub V_GetDetailPo(ByVal _Po As String)
        If Not (M_Mode = "M") Then Exit Sub
        If _Po.Trim = "" Then Exit Sub

        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_RoGetPOD", "1#" & txtLenh_Ro.Text.Trim & "#" & _Po.Trim & "##19000101#19000101#" & M_Stt_Rec & "#" & M_Ma_Dvcs & "#" & M_User_Name)
    ...
    Sub V_UpdateMaster(ByVal DtTmpMaster As DataTable, ByVal DtTmpDetail As DataTable)
        If DtTmpMaster.Rows.Count > 0 Then
            ...
            If DtTmpMaster.Columns.Contains("So_Po") Then TxtLenh_PO.Text = DtTmpMaster.Rows(0).Item("So_Po").ToString
...
#Region "So_So/So_PO/So_RO/So_VT"
    ...
    End Sub
    Private Sub L_So_Ro2(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim iRow As Integer = -1
        iRow = DetailGRV.GetFocusedDataSourceRowIndex
        If iRow < 0 Then Exit Sub
        Dim _Ngay_Ct As Date = TxtNgay_Ct.Value
        Dim __So_ro2 As String = ""
        ''CyberVoucher.V_FormatSo_Ro(Dv_DetailTmp, iRow, AppConn, osysvar, M_Ma_CT, "S", M_Mode, _Ngay_Ct, CbbMa_TTCP_H, TxtMa_Dvcs.Text, M_User_Name, CyberSmlib)
        __So_ro2 = Dv_DetailTmp.Item(iRow).Item("SO_Ro2")
        __So_ro2 = CyberVoucher.V_FormatSo_Ro(AppConn, osysvar, M_Ma_CT, "S", M_Mode, _Ngay_Ct, __So_ro2, CbbMa_TTCP_H, TxtMa_Dvcs.Text, M_User_Name, CyberSmlib)

        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dv_DetailTmp.Item(iRow).Item("SO_Ro2") = __So_ro2
        Dv_DetailTmp.Item(iRow).EndEdit()
        Dv_DetailTmp.Table.AcceptChanges()
    End Sub
