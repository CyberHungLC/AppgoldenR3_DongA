...
#Region "Load"
    Protected Overrides Sub V_Load()
        ...
        If Me.Mode = "M" Then TxtNgay_BaoHanh.Value = New Date(1900, 1, 1)
    End Sub
    Private Sub V_AddhanderMaster()
        ...
        AddHandler chkIs_PDI.CheckedChanged, AddressOf V_XePDI
        'So_Khung
        RemoveHandler TxtSo_Khung1.CyberValiting, AddressOf V_So_Khung1
        RemoveHandler TxtSo_Khung1.CyberLeave, AddressOf L_So_Khung1
        AddHandler TxtSo_Khung1.CyberValiting, AddressOf V_So_Khung1
        AddHandler TxtSo_Khung1.CyberLeave, AddressOf L_So_Khung1
    ...
    End Sub
    Private Sub V_XePDI()
        If chkIs_PDI.Checked Then

            Txtso_khung.Visible = False
            TxtSo_Khung1.Visible = True
        Else
            Txtso_khung.Visible = True
            TxtSo_Khung1.Visible = False
        End If
...
#Region "Vali --- So_Khung"
    Private Sub V_So_Khung1(ByVal sender As System.Object, ByVal e As System.EventArgs)
        TxtSo_Khung1.V_LookUp(M_LAN, M_Para, oSysvar, Appconn, DsLookup, "Ma_TD1", "DmTD1", "1=1", "1=1")
    End Sub
    Private Sub L_So_Khung1(ByVal sender As System.Object, ByVal e As System.EventArgs)
        DrReturn = TxtSo_Khung1.GetRowsSelectData(True)
        If Not DrReturn Is Nothing Then
            Txtso_khung.Text = DrReturn.Item("Ma_TD1")
            TxtSo_Khung1.Text = DrReturn.Item("Ma_TD1")
        Else
            Txtso_khung.Text = ""
            TxtSo_Khung1.Text = ""
        End If
...
#End Region
    Private Sub V_Fill_TT(ByVal Dr As DataRow, ByVal Is_Xe As String)
        ...
        If V_IsFieldExist("Ma_Mau", Dr) Then If Not Dr.Item("Ma_Mau").ToString.Trim = "" Then TxtMa_Mau.Text = Dr.Item("Ma_Mau").ToString.Trim
        If V_IsFieldExist("Ma_Kx", Dr) Then If Not Dr.Item("Ma_Kx").ToString.Trim = "" Then TxtMa_Kx.Text = Dr.Item("Ma_Kx").ToString.Trim
        If V_IsFieldExist("Nh_KX2", Dr) Then If Not Dr.Item("Nh_KX2").ToString.Trim = "" Then TxtNh_KX2.Text = Dr.Item("Nh_KX2").ToString.Trim
...
#Region "Valid --- Ma_Kx"
    Private Sub V_Ma_Kx(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        ...
        'sender.V_LookUp(M_LAN, M_Para, osysvar, AppConn, DsLookup, "Ma_kX", "DmKX", "1=1", "IS_KD <> '1'")
