...
#Region "Columns Edit"
    ...
    Dim EditTen_Tk_No, EditTen_Tk_Co, EditTen_KH_N, EditTen_KH_C, EditTk_VT, EditTen_Tk_VT As New Cyber.Fill.CyberColumnGridView
...
#Region "Mau_bc , Ma_kh"
    ...
    Private Sub L_tk_VT(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If DrReturn Is Nothing Then
            Dt_DetailTmp.Rows(iRow).BeginEdit()
            Dt_DetailTmp.Rows(iRow).Item("tk_VT") = ""
            Dt_DetailTmp.Rows(iRow).EndEdit()
            Exit Sub
        Else
            Dt_DetailTmp.Rows(iRow).BeginEdit()
            Dt_DetailTmp.Rows(iRow).Item("tk_VT") = DrReturn("tk").ToString.Trim
        End If
        Dt_DetailTmp.AcceptChanges()
        DetailGRV.UpdateCurrentRow()
    End Sub
