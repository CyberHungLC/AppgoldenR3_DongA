...
#Region "Load And Set And Default"
    ...
    Private Sub V_Getdefault()
        ...
        Dim Dstmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_SysExecute", "SELECT * FROM dbo.DmLyDoXeRa WITH (NOLOCK) WHERE Ma_Loai='RT'") '+ M_Ma_Dvcs + "#" + M_User_Name)
        Dim dtLyDo As New DataTable
        dtLyDo = Dstmp.Tables(0).Copy
        'CyberFill.V_FillComBoxValue(CmbMa_Ld, dtLyDo, "Ma_LD", "Ten_LD", "")
        ...
        CyberFill.V_FillComBoxDefaul(CmbMa_Ld, dtLyDo, "Ma_LD", "Ten_LD", "Ngam_Dinh")
        'If Not ChkXe_Tot.Checked And Not ChkXe_Xuoc.Checked Then
        '    ChkXe_Tot.CheckState = 1
        'End If
        V_LoadDefault()
    End Sub
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Master()
        ...
        AddHandler CmbMa_Ld.SelectedValueChanged, AddressOf V_Ly_Do
...
#Region "Valid - Master"
    ...
    Private Sub V_SetCustomize()
        Select Case M_Ma_CT.ToUpper.Trim
            ...
            Case "TD5" '*---- Xe ra tam thoi khoi kinh doanh
                ...
                CmbMa_Ld.Enabled = True
                labLy_Do.Visible = True
                CmbMa_Ld.Visible = True
        End Select
    End Sub
    ...
    End Sub
    Private Sub V_Ly_Do(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If CmbMa_Ld.SelectedValue.ToString.Trim = "06" Then
            LbLNguoiLai.Enabled = True
            LblCMND.Enabled = True
            LblDienTHoai.Enabled = True
            LblDia_Chi.Enabled = True
            TxtCMND.Enabled = True
            TxtNguoi_Lai.Enabled = True
            TxtDien_Thoai.Enabled = True
        ...
        Else
            ...
            TxtDien_Thoai.Text = ""
            TxtDia_Chi.Text = ""
            LbLNguoiLai.Enabled = False
            LblCMND.Enabled = False
            LblDienTHoai.Enabled = False
            LblDia_Chi.Enabled = False
            TxtCMND.Enabled = False
            TxtNguoi_Lai.Enabled = False
            TxtDien_Thoai.Enabled = False
            TxtDia_Chi.Enabled = False
        End If
        If TxtDien_Giai.Text = "" Then
            TxtDien_Giai.Text = CmbMa_Ld.Text
        End If
    End Sub
    ...
    Private Sub V_Is_LyDoKhac(ByVal sender As Object, ByVal e As EventArgs)
        If CmbMa_Ld.SelectedValue = "Khác" Then
            TxtLy_Do.Enabled = True
            TxtLy_Do.Visible = True
        Else
            TxtLy_Do.Text = CmbMa_Ld.SelectedValue
        End If
...
#Region "Valid --- Ma_HD"
    ...
    Private Sub GetMaTd3FromMaHd()
        ...
        '------- Lấy thông tin người lái, điện thoại, cmnd
        If TxtMa_HD_H.Text <> "" Then
            Dim dsTTtmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetValue", "PHHDX#Ong_Ba,Dt_LX,So_CMT#(Ma_HD_H='" & TxtMa_HD_H.Text & "')")
            If dsTTtmp.Tables.Count = 0 Then
                Exit Sub
            End If
            If dsTTtmp.Tables(0).Rows.Count <= 0 Then
                Exit Sub
            End If
            TxtNguoi_Lai.Text = dsTTtmp.Tables(0).Rows.Item(0)("Ong_Ba")
            TxtCMND.Text = dsTTtmp.Tables(0).Rows.Item(0)("So_CMT")
            TxtDien_Thoai.Text = dsTTtmp.Tables(0).Rows.Item(0)("Dt_Lx")
        End If
    End Sub
...
#Region "Valid --- Ma_Hs_H"
    ...
    End Sub
#End Region
    '#Region "Valid --- Ma_Ly_Do"
    '    Private Sub V_Ma_Ly_Do(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
    '        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
    '        TxtMa_Ld.V_LookUp(M_LAN, M_Para, osysvar, AppConn, DsLookup, "Ma_Ld", "DmLyDoXeRa", "(Ma_Loai='RT')", "1=1")
    '    End Sub
    '    Private Sub L_Ma_Ly_Do(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
    '        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
...
#Region "Button"
    Private Sub V_Save(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        'MsgBox(CmbLoai_Ly_Do.SelectedValue.ToString)
        'Exit Sub
        '---Save Post
    ...
    Private Sub ChkXe_Tot_CheckedChanged(sender As Object, e As EventArgs) Handles ChkXe_Tot.CheckedChanged
        If ChkXe_Tot.Checked Then
            ChkXe_Xuoc.Checked = False
        Else
            ChkXe_Xuoc.Checked = True
        End If
    End Sub
    Private Sub ChkXe_Xuoc_CheckedChanged(sender As Object, e As EventArgs) Handles ChkXe_Xuoc.CheckedChanged
        If ChkXe_Xuoc.Checked Then
            ChkXe_Tot.Checked = False
        Else
            ChkXe_Tot.Checked = True
        End If
    End Sub
