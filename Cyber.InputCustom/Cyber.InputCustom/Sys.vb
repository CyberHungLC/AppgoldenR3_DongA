...
Public Class Sys
    ...
    Public Function GetFormPrintVoucher(ByVal M_ma_CT) As Cyber.From.FrmPrintVoucher
        ...
        If _Return Is Nothing Then
            ...
            If M_ma_CT.ToString.ToUpper = "HDR" Then _Return = New FrmPrintVoucherHDR

        End If
        If M_ma_CT.ToString.ToUpper = "HDK" Then _Return = New FrmPrintVoucherHDK

        'If _Return Is Nothing Then
        '    If M_ma_CT.ToString.ToUpper = "HDR" Then _Return = New Cyber.Input.FrmPrintVoucherHDK
        'End If
    ...
    Public Function GetFormFilterVoucher(ByVal M_ma_CT) As Cyber.From.FrmFilterVoucher
        ...
        If M_ma_CT.ToString.ToUpper = "HDK" Then _Return = New FILTER_HDK
        If M_ma_CT.ToString.ToUpper = "RVR" Then _Return = New Filter_RVR
        If M_ma_CT.ToString.ToUpper = "POD" Then _Return = New Filter_POD
        If M_ma_CT.ToString.ToUpper = "PNK" Then _Return = New FILTER_PNK
        If M_ma_CT.ToString.ToUpper = "PXE" Then _Return = New FILTER_PXE
        If M_ma_CT.ToString.ToUpper = "HD3" Then _Return = New Filter_HD3
        If M_ma_CT.ToString.ToUpper = "HDS" Then _Return = New FILTER_HDS
        If M_ma_CT.ToString.ToUpper = "PXK" Then _Return = New FILTER_PXK
        If M_ma_CT.ToString.ToUpper = "HDP" Or M_ma_CT.ToString.ToUpper = "HDQ" Or M_ma_CT.ToString.ToUpper = "HDR" Then _Return = New FILTER_HDP
    ...
    '=============================================================RO/
    '=============================================================QV
    Public Sub V_Tinh_Sl_Ve(ByVal _App As SqlConnection, ByVal _Dv_Detail As DataView, ByVal _iRow As Integer, ByVal _Dt As Date, ByVal _Ma_Ct As String, _
