...
#Region "Load"
    Private Sub V_Load()
        ...
        _DsGroup = Nothing
        _DsGroup = CyberSmLib.SQLExcuteStoreProcedure(AppConn, "CP_SysGetTHPO", "" + "#" + "" + "#" + "" + "#" + "" + "#" + Me.Ma_Dvcs + "#" + Me.User_Name)
...
#Region "Button"
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If CyberMe.V_GetValueCombox(CbbGroupByTH).ToString.Trim <> "Ma_VT" And ChkDetail_OK.Checked = False Then
            MsgBox("Bạn phải chọn chi tiết", MsgBoxStyle.Critical + MsgBoxStyle.OkOnly, Me.sysvar("M_CYBER_VER"))
            CbbGroupByCT.Focus()
            Exit Sub
        End If
        '-----------------------------------------------------------------------------
        ...
        Dim M_strParameterStore As String = "POD"
        ...
        M_strParameterStore = M_strParameterStore & "#" & txtSo_Po.Text.Trim
        '-----------------------------------------------------------------------------
        Me.is_continue = True
