Public Class SOBK1
    ...
    Dim _DtPost1, _DtPost2 As DataTable
...
#Region "Load"
    Private Sub V_Load()
        ...
        '--------------------------------------------
        Dim _DsPost As DataSet = CyberSmLib.SQLExcuteStoreProcedure(AppConn, "CP_GetDsPostHDA", Ma_Dvcs + "#" + User_Name)
        _DtPost1 = _DsPost.Tables(0).Copy
        _DtPost2 = _DsPost.Tables(1).Copy
        CyberFill.V_FillComBoxDefaul(Me.CbbMa_Post1, _DtPost1, "Ma_Post", "Ten_Post", "Ngam_Dinh")
        CyberFill.V_FillComBoxDefaul(Me.CbbMa_Post2, _DtPost2, "Ma_Post", "Ten_Post", "Ngam_Dinh")
        _DsPost.Dispose()
        '--------------------------------------------------------------------
