...
Public Class DMChienDich
    ...
    Dim EditMa_HS As New Cyber.Fill.CyberColumnGridView
    ...
    Private Sub DMChienDich_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Mode = "S" Then
            TxtMa_ChienDich.ReadOnly = True
            TxtMa_ChienDich.Enabled = False
...
#End Region
    Private Sub V_Load_CtDmChienDich(ByVal M_Mode As String, ByVal sMa_ChienDich As String, ByVal sMa_Dvcs As String)
        ...
        '-- đoạn này là để có dòng tìm kiếm ở trên
        'For Each clm As DevExpress.XtraGrid.Columns.GridColumn In DetailSKGRV.Columns
        ...
        'Next
        For i As Integer = 0 To DetailSKGRV.Columns.Count - 1
            DetailSKGRV.Columns(i).OptionsFilter.AllowAutoFilter = True
            DetailSKGRV.Columns(i).OptionsFilter.AllowFilter = True
            DetailSKGRV.OptionsView.ShowAutoFilterRow = True
            DetailSKGRV.Columns(i).OptionsFilter.AutoFilterCondition = DevExpress.XtraGrid.Columns.AutoFilterCondition.Contains
        Next

    End Sub
    Private Sub V_GetColumns()
        EditMa_HS.GetColumn(DetailSKGRV, "Ma_HS")
...
#Region "Ma_HS"
    ...
    Private Sub L_Ma_HS(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        drvCurren("Ten_Hs") = DrReturn("Ten_Hs")
    ...
    Protected Overrides Sub V_Save(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        For i = nCount To 0 Step -1
            ...
            If tbSK.Rows(i).Item("Ma_Xe").ToString.Trim = "" Then
                ...
                MsgBox("Biển số xe không được trống")
                Exit Sub
        ...
        _StrXML = CyberSmodb.V_ConvertDataToXML({"DmChienDichSK", "DmChienDichVT", "DmChienDichCV"}, {tbSK, tbVT, tbCV})
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(Appconn, "CP_DmChienDichCheck", _StrXML & "#" & TxtMa_ChienDich.Text.Trim & "#" & Mode & "#" & M_Ma_Dvcs & "#" & M_User_Name)
