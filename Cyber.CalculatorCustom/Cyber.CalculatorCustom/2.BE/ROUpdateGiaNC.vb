Public Class RoUpdateGiaNC
    ...
    Private Sub ROUpdateGiaNC_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub V_Load()
        ...
        DsData = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_RoGetListDmGiaNC", M_Ma_Dvcs & "#" & M_User_Name)
    ...
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        For i As Integer = 0 To tbMaster.Rows.Count - 1
            ...
            If tbMaster.Columns.Contains("Gia2") And tbMaster.Columns.Contains("Gia_NT2") Then tbMaster.Rows(i).Item("Gia_NT2") = tbMaster.Rows(i).Item("Gia_NT2")
        ...
        Next
        '----------------------------------------------------------------------------       
        Dim dsChekUpdate As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "Cp_RoChkUpdateGiaNC", dt.ToString("yyyyMMdd") & "#" & M_Ma_Dvcs & "#" & M_User_Name)
        ...
        tbMaster.AcceptChanges()
        '---------------------------------------------------------------------------------------------------------       
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_SysExecute", "SELECT TOP 0 * FROM dbo.DmGiaNC WITH (NOLOCK) WHERE 1=0#" + M_Ma_Dvcs + "#" + M_User_Name)
        ...
        CyberSmodb.V_CyberBulkSaveToSQL(AppConn, Me.Sysvar, M_User_Name, DtDmGia2, "DmGiaNC", "S", smKey)

        CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_UpdateDmPKAndDmGiaNC", "2#S##" & M_Ma_Dvcs & "#" & M_User_Name & "#" & dt.ToString("yyyyMMdd"))
    ...
    Private Sub V_SelectFile(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        For Each dr As DataRow In tbImport.Select("Ma_Pk<>''")
