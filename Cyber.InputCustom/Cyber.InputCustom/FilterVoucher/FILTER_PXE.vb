...
Public Class FILTER_PXE
    ...
    Private Sub V_Addhander()
        ...
        '--Ma_KHoN
        RemoveHandler TxtMa_KhoN.CyberValiting, AddressOf V_Ma_KhoN
        RemoveHandler TxtMa_KhoN.CyberLeave, AddressOf L_Ma_KhoN
...
#Region "Vali --- Ma_KhoN"
    Private Sub V_Ma_KhoN(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        TxtMa_KhoN.V_LookUp(M_Lan, M_Para, osysvar, AppConn, M_DsLookup, "Ma_Kho", "DmKho", "1=1", "1=1")
    End Sub
...
#Region "Vali --- NH_VT4"
    Private Sub V_NH_VT4(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        TxtNh_VT4.V_LookUp(M_Lan, M_Para, osysvar, Appconn, M_DsLookup, "Ma_NH", "DmNhVT", "1=1", "Loai_Nh='4'")
    End Sub
...
#Region "Vali --- NH_VT5"
    Private Sub V_NH_VT5(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        TxtNh_VT5.V_LookUp(M_Lan, M_Para, osysvar, Appconn, M_DsLookup, "Ma_NH", "DmNhVT", "1=1", "Loai_Nh='5'")
    End Sub
...
#End Region
    Private Sub L_Lenh_Ro(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        TxtSo_Ro.Text = CyberVoucher.V_FormatSo_Ro(AppConn, osysvar, Me.Ma_CT, _Ma_GD, "M", _Dt, TxtSo_Ro.Text, "", M_Ma_Dvcs, M_User_Name, CyberSmlib)
    End Sub
End Class
