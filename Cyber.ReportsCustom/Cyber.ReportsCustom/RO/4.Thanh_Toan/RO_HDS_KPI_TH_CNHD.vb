Public Class RO_HDS_KPI_TH_CNHD
    ...
    Private Sub RO_HDS_KPI_TH_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        TxtNgay_TT1.Visible = False
        TxtNgay_TT2.Visible = False
        lblNgay_TT1.Visible = False
        lblNgay_TT2.Visible = False
        V_Load()
        V_Addhander()
    End Sub
#Region "Load"
    Private Sub V_Load()
        ...
        CyberFill.V_FillComBoxDefaul(Me.CbbMa_TT, _DtMa_TT, "Nhom", "Ten_nhom")
        ...
        CyberFill.V_FillComBoxDefaul(Me.CbbMa_GD, _DtLoai_Phieu, "Nhom", "Ten_nhom")
        ...
        TxtNgay_TT1.Value = Now.Date
        TxtNgay_TT2.Value = Now.Date
        ...
        Catch ex As Exception
        End Try
        If TxtTk.Text.Trim = "" Then TxtTk.Text = "131102"
    ...
    Private Sub V_Addhander()
        ...
        AddHandler ChkIsNgay_TT.CheckedChanged, AddressOf V_ChkNgayTT
...
#Region "Button"
    ...
    Private Sub V_Exit(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Me.Close()
    End Sub
    Private Sub V_ChkNgayTT()
        If ChkIsNgay_TT.Checked Then
            TxtNgay_TT1.Visible = True
            TxtNgay_TT2.Visible = True
            lblNgay_TT1.Visible = True
            lblNgay_TT2.Visible = True
        Else
            TxtNgay_TT1.Visible = False
            TxtNgay_TT2.Visible = False
            lblNgay_TT1.Visible = False
